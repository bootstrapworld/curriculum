...
const pageTimeout     = 45 * sec;
const pagesPerChunk   = 10;
const chunkTimeout    = pageTimeout * pagesPerChunk * 2 // worst-case + 100% more room for retries;
const retryLimit      = 3;
const retryDelay      = 10;
const protocolTimeout = 2 * 60 * sec; // 5m!
...
async function launchCluster(numWorkers=numCores, debug=!!process.env.DEBUG_MEMORY) {
