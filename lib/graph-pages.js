...
function populateLesson() {
  ...
  function populateMaterials() {
    ...
    if([...optContainer.querySelectorAll('li')].length == 0) {
      optContainer.remove();
    }
...
function populateNarrativePage() {
  ...
  anchor.innerHTML += `
    ...
    <button id="copyBtn" onclick="customizePathway()" title="Customize this pathway" URL" aria-label="Copy URL">
