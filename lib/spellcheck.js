...
const added_words  = require('../shared/langs/en-us/hunspell/added-words.json');

const ignored_words  = require('../shared/langs/en-us/hunspell/ignored-words.json');
...
process.stdin.on('data', (chunk) => {
  ...
  // remove any style, script, @math{...}, @show{...}, or @link{...} content
