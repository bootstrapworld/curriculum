...
practices_list = {
  ...
  read_alignment_file('SJ', 'Social Justice', 'practices/practices-sj-dictionary.json',          'https://www.learningforjustice.org/sites/default/files/2017-06/TT_Social_Justice_Standards_0.pdf' ),
  ...
  read_alignment_file('CC', 'Math', 'practices/practices-cc-dictionary.json',  'http://corestandards.org/Math/'),
