...
async function saveSelectorResultsAsImages(selector = '.sect1 table') {
    ...
    await page.addStyleTag({content: '@media print { body.LessonPlan { width: 8.5in !important; } }'})
    ...
    // insert a full-second delay, to prevent weird screen grabs
    // that Emmanuel *thinks* are coming from the browser not moving
    // fast enough (see https://github.com/bootstrapworld/curriculum/issues/1921)
