...
function populateLessonFromGraph() {
  ...
  function computeTransitiveData(lesson, pathway, lessons) {
    var normalizedLessons = lessons? lessons.map(normalize) : false;
    var priorLessons = computePriors(lesson, normalizedLessons);
  ...
  function buildLessonSidebar(lesson, suffix, pathway, lessons, priorData) {
    ...
    var lessonList = lessons || priorData.titles.reverse();
  ...
  */
  ...
  if(document.body.classList.contains("LessonPlan")){
    ...
    try { 
      addPrereqs(lesson, suffix, lessons? lessons.map(normalize) : false);  
    ...
    try { 
      buildLessonSidebar(normalize(lesson), suffix, pathway, lessons? lessons.map(normalize) : false, priorData); 
  ...
  function addPrereqs(lesson, suffix, lessons) {
