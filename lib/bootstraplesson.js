...
function drawBlankLines() {
  console.log('drawing blank lines');
  ...
  nodes.forEach( n => {
    // Get the computed style object for the element
      ...
      console.log('node is', n, 'lineHeight is', lineHeight);
      ...
      let yOffset = Math.round(lineHeight), y=lineHeight;
      while (yOffset < nodeHeight) {
        const line = `<line x1="0" y1="${yOffset}" x2="1000" y2="${yOffset}" style="stroke:black;stroke-width:1"/>`
        dataUrl += line;
