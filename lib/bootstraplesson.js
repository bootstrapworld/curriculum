...
function populateLessonFromGraph() {
  ...
  */
  ...
  if(document.body.classList.contains("LessonPlan")){
    // If pathway is defined, do other stuff
    if(pathway){
      addPathwayTitle(pathway);
      pathwayWorkbookLink(pathway);
    } 
    addPageNums(priorData);
    addPrereqs(priorData, suffix, pathway);
    ...
    document.body.style.minHeight       = 'calc(11in * 1.25)';
  }
}

function addPrereqs(priorData, suffix, pathway) {
