...
function drawBlankLines() {
  ...
  nodes.forEach( n => {
      ...
      const pitch = (rig.children[1].getBoundingClientRect().top - p1Top) / zoom;
      // the visible underline is the fitb's ::after, sitting ~1px below its box
      const firstLineY =
        (f1.getBoundingClientRect().bottom - p1Top) / zoom + 1;
      ...
      for (let i = 0; i < nLines; i++) {
        ...
        const y = (firstLineY + i * pitch).toFixed(1);
