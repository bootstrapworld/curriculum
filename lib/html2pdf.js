...
const pageOpts = { scale: 1.00 }; // match the old wkhtmltopdf scale
const landscapePageCSS = "@page { size: 8.5in 11in landscape; margin: 0.75in; }";
const portraitPageCSS  = "@page { size: 8.5in 11in portrait;  margin: 0.75in; }";
