...
/*
    // Add a BASE tag to the PDF, to that PDF links point to the website and not localhost
    // pass the semester+year vars as a string, to be spliced into the URL
    await page.evaluate((str) => {
      document.head.innerHTML += '<base href="https://bootstrapworld.org/materials/'+str+'/en-us/lessons/BLANK/">';
    }, semester+year);
*/
