...
const latoPath = "lib/printCache/lato.medium.ttf";
...
async function makeBook(pageList, outputPath, readFn, writeFn) {
  ...
  await generateLuluCover(pageList, workbook.getPageCount(), outputPath, readFn, writeFn);
...
module.exports.makeBooksFromConfigFile = function (path) {
...
module.exports.makeBooksFromConfigFile();