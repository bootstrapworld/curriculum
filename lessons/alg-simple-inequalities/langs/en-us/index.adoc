...
* Sam the Butterfly Starter File (@link{https://code.pyret.org/editor#share=1YSPPa4BLhOG7_qhWdqQ-cG1u3yUUi-zZ, Pyret})
}
...
* Left-and-Right (@workbook-link{pages/left-and-right.adoc, original}, @link{solution-pages/left-and-right.adoc, solution})
