...
- @exercise-link{pages/keeping-ninjacat-in-the-game.adoc, Keeping Ninjacat in the Game}

- @exercise-link{pages/boolean-coe-to-code1.adoc, Converting Circles of Evaluation with Booleans to Code} 

- @exercise-link{pages/boolean-coe-to-code2.adoc, Converting Circles of Evaluation with Booleans to Code (2)} 