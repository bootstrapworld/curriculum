...
9) What does the @ifproglang{wescheme}{function} @ifproglang{pyret}{operator} `<` do?
...
11) Write the contract(s) for any new function(s) that produce Booleans you've seen above in your Contracts page.
...
15) How many Booleans are there in the entire universe? @fitb{4ex}{}
