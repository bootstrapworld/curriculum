...
* Alternate method of importing images using direct links:
ifeval::["{proglang}" == "wescheme"]
@worksheet-link{./resources/LinkingImagesGuide.pdf, Linking Images Guide}
endif::[]
ifeval::["{proglang}" == "pyret"]
@worksheet-link{./resources/LinkingImagesGuide-Pyret.pdf, Linking Images Guide}
endif::[] 
...
ifeval::["{proglang}" == "wescheme"]
@link{https://www.wescheme.org/openEditor?publicId=ysj93ZPFsu&, Game Template file }
endif::[]
ifeval::["{proglang}" == "pyret"]
@link{https://code.pyret.org/editor#share=1xL3ZnWb43d5ih_fRib3dz3h8z9d__2om&v=f1d3c87, Game Template file }.
endif::[]
