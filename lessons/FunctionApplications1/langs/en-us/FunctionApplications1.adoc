...
* On a PC or Mac, @worksheet-link{FunctionApplications1/SavingImagesGuide.pdf, follow this quick guide.} 
...
With their partner, students search the Internet for images to use in their game.  
