...
[.lesson-instruction]
- What do you think the resulting scatter plot will look like? You may want to refer back to @printable-exercise{age-dot.adoc}.
** _Students should make predictions based on their work on @printable-exercise{age-dot.adoc} The scatter plot that will be generated is below._

@center{@image{images/age-dot.png, 450}}

[.lesson-instruction]
- Complete questions 8, 9, and 10 on @printable-exercise{image-scatter-explore.adoc}.
- Then, finish the worksheet; the bottom portion invites you to consider what new insights you can glean from your custom displays.
- How did having the dots labeled with the _species_ (problem 8) change your understanding of the data?
