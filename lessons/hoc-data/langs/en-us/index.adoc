...
@description{A self-guided activity for exploring a real dataset, and using it to make sense of a real-world problem.}
...
- *Part 2* Introducing the Data Set: Animal-Vehicle Collisions in Vermont - Notice and Wonder
...
- *Part 10* Beyond the Data Set - Making Connections - What else might we want to know?
