...
[.lesson-instruction]
--
Boolean-producing expressions are yes-or-no questions and will always evaluate to either `true` (“yes”) or `false` (“no”).  Brainstorm why booleans might be useful in a programming environment.
--
=== Investigate
[.lesson-instruction]
--
