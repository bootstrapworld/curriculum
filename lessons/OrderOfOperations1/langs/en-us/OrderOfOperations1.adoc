...
* Frayer Model - Order of Operations (@worksheet-link{pages/OrderOfOperations1-FrayerModelTemplate.pdf, PDF}, @link{https://docs.google.com/document/d/1HeXGZXkSnvGeSbtktU5qXYKwnuYlgkiM3elbVEYxiCk/edit?usp=sharing, Google Doc}) 

* Circles of Evaluation Mixed Review (@worksheet-link{pages/OrderOfOperations1-Practice.pdf, PDF}, @link{https://docs.google.com/document/d/1AezrjhLGDYLfiuLfjYRH_AK0vytDJQvAK4Tq5v77ztE/edit?usp=sharing, Google Doc})

ifeval::["{proglang}" == "wescheme"]
* Circles of Evaluation with Square Roots (@worksheet-link{pages/OrderOfOperations1-Practice2.pdf, PDF}, @link{https://docs.google.com/document/d/1vsobkbbXTOjl4FFLdbHYRGn7l8ZbWBRptSqWYzxllxQ/edit?usp=sharing, Google Doc})
endif::[]

ifeval::["{proglang}" == "pyret"]
* Circles of Evaluation with Square Roots (@worksheet-link{pages/OrderOfOperations1-Practice2.pdf, PDF}, @link{https://docs.google.com/document/d/10fX_6qL5q94kk6KylH7-2JY89LNF7b5qiohmDz_NFQY/edit?usp=sharing, Google Doc})
endif::[]
...
(@link{pages/complete-coe-from-arith1.adoc, original} ,
@link{solution-pages/complete-coe-from-arith1.adoc, answers})

* Completing Circles of Evaluation from Math Expressions (2)
(@link{pages/complete-coe-from-arith2.adoc, original} ,
@link{solution-pages/complete-coe-from-arith2.adoc, answers})

* Creating Circles of Evaluation from Math Expressions (1)
(@link{pages/arith-to-coe1.adoc, original} ,
@link{solution-pages/arith-to-coe1.adoc, answers})

* Creating Circles of Evaluation from Math Expressions (2)
(@link{pages/arith-to-coe2.adoc, original} ,
@link{solution-pages/arith-to-coe2.adoc, answers})

* Creating Circles of Evaluation from Math Expressions (3)
(@link{pages/arith-to-coe3.adoc, original} ,
@link{solution-pages/arith-to-coe3.adoc, answers})

* Converting Circles of Evaluation to Math Expressions (1)
(@link{pages/coe-to-arith1.adoc, original} ,
@link{solution-pages/coe-to-arith1.adoc, answers})

* Converting Circles of Evaluation to Math Expressions (2)
(@link{pages/coe-to-arith2.adoc, original} ,
@link{solution-pages/coe-to-arith2.adoc, answers})

* Matching Circles of Evaluation and Math Expressions
(@link{pages/match-arith-coe1.adoc, original} ,
@link{solution-pages/match-arith-coe1.adoc, answers})

* Evaluating Circles of Evaluation (1)
(@link{pages/coe-to-math-answer1.adoc, original} ,
@link{solution-pages/coe-to-math-answer1.adoc, answers})

* Evaluating Circles of Evaluation (2)
(@link{pages/coe-to-math-answer2.adoc, original} ,
@link{solution-pages/coe-to-math-answer2.adoc, answers})

* Completing Code from Circles of Evaluation
(@link{pages/complete-code-from-coe1.adoc, original} ,
@link{solution-pages/complete-code-from-coe1.adoc, answers})

* Converting Circles of Evaluation to Code (1)
(@link{pages/coe-to-code1.adoc, original} ,
@link{solution-pages/coe-to-code1.adoc, answers})

* Converting Circles of Evaluation to Code (2)
(@link{pages/coe-to-code2.adoc, original} ,
@link{solution-pages/coe-to-code2.adoc, answers})

* Matching Circles of Evaluation and Code
(@link{pages/coe-code-matching1.adoc, original} ,
@link{solution-pages/coe-code-matching1.adoc, answers})
...
ifeval::["{proglang}" == "wescheme"]
@worksheet-link{pages/OrderOfOperations1-Practice.pdf, Mixed Review worksheet }
and / or the 
@worksheet-link{pages/OrderOfOperations1-Practice2.pdf, Square Roots worksheet }
endif::[]
ifeval::["{proglang}" == "pyret"]
@worksheet-link{pages/OrderOfOperations1-Practice.pdf, Mixed Review worksheet }
and / or the 
...
Using @worksheet-link{pages/OrderOfOperations1-FrayerModelTemplate.pdf, this Frayer Model}, create the code that represents this circle, translate this into code, evaluate the expression using the order of operations, and then compare and contrast the three methods.
