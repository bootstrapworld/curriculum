...
- Additional workook pages for translating Circles of Evaluation to code include @printable-exercise{pages/complete-code-from-coe.adoc}, @printable-exercise{pages/match-coe-to-code.adoc}, and @printable-exercise{translate-arithmetic-to-circles-and-code.adoc}
