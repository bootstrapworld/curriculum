...
[.lesson-instruction]
Have students turn to @printable-exercise{pages/complete-coe-from-arith2.adoc} and @printable-exercise{pages/match-arith-coe.adoc} in the workbook to practice connecting expressions to circles of evaluation.

Optional: 
If you are digging into Order or Operations and are looking for more practice with Circles of Evaluation before digging into code, you could also have students complete: @opt-printable-exercise{pages/arith-to-coe.adoc}, @opt-printable-exercise{pages/arith-to-coe2.adoc}, @opt-printable-exercise{pages/arith-to-coe3.adoc}, @opt-printable-exercise{pages/coe-to-arith.adoc}, @opt-printable-exercise{pages/coe-to-arith2.adoc}.
...
- For a scaffolded start with translating circles to code, have students complete: @printable-exercise{pages/complete-code-from-coe.adoc} and @printable-exercise{pages/match-coe-code.adoc}.

[.lesson-instruction]
- Turn to @printable-exercise{pages/arith-to-coe-to-code-intro-w-parentheses.adoc} page in the student workbook. Be sure to __draw all of the Circles first__ and check your work before converting to code.
- Then complete the @printable-exercise{pages/translate-coe-to-code.adoc}.
- If time allows, take turns entering the code into the editor with your partner.

Optional: We have many other pages of 3-column practice converting expressions to circles of evaluation to code in the Addtional Exercise! This is a great way to get older students to practice order of operations while feeling like they are learning to code.

The Circles of Evaluation are also a great way to visualize _other_ functions you already know, such as square and square root!
