...
@ifproglang{wescheme}{
*  @activity-link{https://quizizz.com/admin/quiz/5d9919a36c6f17001a9dc796, "Coordinates, Circles of Evaluation, and Code - Quizizz"}
}

@ifproglang{pyret}{
*  @activity-link{https://quizizz.com/admin/quiz/5d6973a4536e0b001a736010, Order of Operations Review #1 - Quizizz}
}
@ifproglang{pyret}{
* @activity-link{https://quizizz.com/admin/quiz/5d69796bfe45c5001d3d48ed, Order of Operations Review #2 - Quizizz}
}
...
* @workbook-link{pages/complete-coe-from-arith2.adoc}

* @workbook-link{arith-to-coe3.adoc}

* @workbook-link{match-arith-coe1.adoc}
