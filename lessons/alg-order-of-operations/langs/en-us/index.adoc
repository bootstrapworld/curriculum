...
- Students complete the @workbook-link{pages/translate-coe-to-code.adoc, Practicing Circles 2 }.
...
[.lesson-instruction]
- Students complete @workbook-link{pages/translate-coe-to-code-w-sqrts.adoc, Practicing Circles with Square Roots } with their partners and test their code in the editor.
