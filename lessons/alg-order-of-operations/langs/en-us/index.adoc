...
[@lesson-intro-table]
|===
@prereqs-stds{alg-coordinate-plane}
| Lesson Goals
...
* Circles of Evaluation Mixed Review (@workbook-link{pages/Practicing-Circles-2.adoc, HTML}, @link{https://docs.google.com/document/d/1AezrjhLGDYLfiuLfjYRH_AK0vytDJQvAK4Tq5v77ztE/edit?usp=sharing, Google Doc})

ifeval::["{proglang}" == "wescheme"]
* Circles of Evaluation with Square Roots (@exercise-link{pages/Practicing-Circles-3.adoc, HTML}, @link{https://docs.google.com/document/d/1vsobkbbXTOjl4FFLdbHYRGn7l8ZbWBRptSqWYzxllxQ/edit?usp=sharing, Google Doc})
endif::[]

ifeval::["{proglang}" == "pyret"]
* Circles of Evaluation with Square Roots (@exercise-link{pages/Practicing-Circles-3.adoc, PDF}, @link{https://docs.google.com/document/d/10fX_6qL5q94kk6KylH7-2JY89LNF7b5qiohmDz_NFQY/edit?usp=sharing, Google Doc})
endif::[]
...
Option 2: Have students complete the @workbook-link{pages/Practicing-Circles-2.adoc, Mixed Review worksheet } and / or the @workbook-link{pages/Practicing-Circles-3.adoc, Square Roots worksheet } with their partners and test their code in their coding environment.
