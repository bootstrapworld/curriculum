...
@ifproglang{pyret}{
* @link{https://teacher.desmos.com/activitybuilder/custom/5dcad0b2ef54cc0c830fd4df, Matching Circles of Evaluation and Code - Desmos Activity}
...
[.lesson-instruction]
Have students turn to @workbook-link{pages/arith-to-coe-to-code-intro-w-parentheses.adoc} and draw the circles of evaluation for the four problems shown there before moving on to writing code.  If you want to give students more practice connecting expressions with Circles of Evaluation before introducing code, have them work on @workbook-link{pages/complete-coe-from-arith.adoc}, @workbook-link{pages/arith-to-coe.adoc}, and/or @workbook-link{pages/match-arith-coe.adoc} in the workbook.
...
[.lesson-instruction]
- Students turn to @workbook-link{pages/arith-to-coe-to-code-intro-w-parentheses.adoc} page in their workbook. They should have already completed their circles and checked their work. Now they will use the circles to convert the expressions to code.
- Once students are confident translating expressions to code using circles of evaluation, have them complete@workbook-link{pages/arith-to-coe-to-code-outro.adoc}
- If time allows, partners should take turns entering the code into the editor.
- Additional workook pages for translating Circles of Evaluation to code include @workbook-link{pages/complete-code-from-coe.adoc}, @workbook-link{pages/translate-coe-to-code.adoc} and @workbook-link{pages/match-coe-to-code.adoc}. 
...
* @exercise-link{pages/matching-coe-exp.pdf, A printable set of cards for physically matching expressions with circles of evaluation}

* @exercise-link{pages/complete-coe-from-arith2.adoc}

* @exercise-link{arith-to-coe3.adoc}

* @exercise-link{match-arith-coe.adoc}

* @workbook-link{translate-coe-to-code.adoc}

* @exercise-link{pages/complete-coe-from-arith.adoc} 

* @exercise-link{pages/arith-to-coe.adoc} 

* @exercise-link{pages/arith-to-coe2.adoc} 

* @exercise-link{pages/coe-to-arith.adoc} 
...
* @exercise-link{pages/coe-to-code.adoc} 
