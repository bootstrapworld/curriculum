...
@span{.right}{@centered-image{images/cat-dog.png, cat dog, 400}}
...
@span{.right}{@centered-image{images/hypotenuse.png, hypotenuse, 400}}
...
@span{.right}{@centered-image{images/4-rt-triangles.png, 4 rt triangles, 400}}
