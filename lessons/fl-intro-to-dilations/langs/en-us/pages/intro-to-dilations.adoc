...
Have students open the Scaling Exploration teachpack and investigate with their partner, using @workbook-link{pages/intro-to-dilations-wb1.adoc} as a guide.
