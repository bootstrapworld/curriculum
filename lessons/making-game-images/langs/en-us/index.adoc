...
@lesson-description{Students choose, import, scale and orient images for their game, practicing reading comments to make sense of and begin to edit a large body of code.}
...
@ifproglang{wescheme}{
* @link{https://docs.google.com/presentation/d/1V6FGuMjDPcwp767AY0arxQ99kwnUCHo8Ifnzw5n6brQ/, Lesson Slides}
* @link{pages/LinkingImagesGuide.pdf, Linking Images Guide - PDF}
}
@ifproglang{pyret}{
* @link{https://docs.google.com/presentation/d/19wYdkpWnoMLAQW75pGDef6NzvBNkwMzO_kkdJBQdvpQ/, Lesson slides}
* @link{pages/LinkingImagesGuide.pdf, Linking Images Guide - PDF}
}
...
@ifproglang{pyret}{ @online-exercise{https://code.pyret.org/editor#share=1sdxxteW0ZpGXjdZQA-rBAqV2OEjLTfwF, Blank Game Starter File }.
}
