...
As students investigate the Game Starter File file with their partner, ask students to record what they Notice, and then what they Wonder on @printable-exercise{pages/NoticeAndWonder.adoc}.
|===
