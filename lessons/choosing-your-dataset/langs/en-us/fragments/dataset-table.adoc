...
NYPD Stop, Search & Frisk 2019::
  ...
  link:https://code.pyret.org/editor#share=1nN3gc6EkEpRIeYlNe2RbNPUI77Y2MEj3&v=22f3b65[Starter File, window="_blank"]
Refugees 2018::
...
Esports Earnings::
  ...
  link:https://code.pyret.org/editor#share=1Brnu1OjiPSDla3n1ZeDhZLRtWjitECUu&v=31c9aaf[Starter File, window="_blank"]
MLB Hitting Stats::
