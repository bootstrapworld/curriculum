...
@lesson-description{Students select a real world dataset to investigate for the remainder of the course and begin their study of the data by identifying categorical and quantitative columns and defining a few logical subsets.}
