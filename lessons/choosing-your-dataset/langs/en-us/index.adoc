...
[[Datasets]]
=== Investigate
Have students choose a dataset that is interesting to them! They should have at least two questions that the dataset can help them answer, and write them on @printable-exercise{pages/whats-on-your-mind.adoc}. *Teacher's Note:* we've assembled some @link{about-datasets/for-teachers-about-datasets.html, tips for working with individual datasets here}.
