...
data and identifying categorical and quantitative columns, data types,
...
_Students can also find their own dataset_, and use this @link{https://code.pyret.org/editor#share=12v7kzbxHt2LaSe2uI2d_OnssxtTNF0A8, Blank Starter file}. See this @link{https://youtu.be/7CyvyKWUHBs, tutorial video} for help importing your own data into Pyret.
...
--
////
We have also compiled some @opt-printable-exercise{../../pathways/data-science/langs/en-us/resources/about-datasets/for-teachers-about-datasets.adoc, notes on these datasets}, which we recommend for all teachers before having their students choose a dataset.
////
=== Synthesize
