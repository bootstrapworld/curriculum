...
=== Overview
[.lesson-point]
Note: This section should be split across multiple days!
...
- You described the @vocab{columns} in the Animals Dataset, identifying which were @vocab{categorical} and which were @vocab{quantitative}, and whether they were Numbers, Strings, Booleans, etc.
