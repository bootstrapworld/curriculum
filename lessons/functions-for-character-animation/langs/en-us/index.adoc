...
=== Investigate
[.lesson-instruction]
- Have students sign in to @starter-file{program-list} and open their saved Game Starter Files, or @starter-file{game, make a new copy}.
- Examine the `update-danger` function
