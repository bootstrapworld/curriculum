...
Want 2-D movement, and some programming exposure to data structures? Have students complete @opt-printable-exercise{pages/2d-character-movement.adoc} to learn how to modify these functions to allow movement in the x __and__ y directions!
|===
