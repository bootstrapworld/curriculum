...
* Reverse Engineer Handout(@link{https://docs.google.com/document/d/1e6ice3yQ6auq4zVU9_YAujxFuxEIraKXuR0ihMaJQ1U/copy, Google Doc}, @worksheet-link{workbook-pages/ReverseEngineerGame.pdf,PDF})
