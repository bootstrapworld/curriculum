...
@worksheet-link{workbook-pages/ReverseEngineerGame.pdf, Reverse Engineer a Game} worksheet in pairs.
...
@worksheet-link{workbook-pages/ReverseEngineerGame.pdf, Reverse Engineer a Game} worksheet a second time but using one of the 10 games listed on the board.
