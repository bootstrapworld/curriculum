...
The *five-number summary* can be used to draw a *box plot*. 
	...
	- Each of the four sections of the box plot contains 25% of the data. If the values are distributed evenly between the minimum and the maximum, the four sections of the box plot will be equal in width.
