...
[.lesson-instruction]
Open your workbooks to @worksheet-link{pages/summarizing-columns-in-animals.adoc}. We’ve already filled in the answer to Question 1 for you (`pounds`). Under the “measures of center” section, fill in the computed mean.
...
* Compute the median for the `pounds` column in the animals dataset, and add this to @worksheet-link{pages/summarizing-columns-in-animals.adoc}. 
...
=== Investigate
[.lesson-instruction]
Compute the `modes` of the `pounds` column, and add it to @worksheet-link{pages/summarizing-columns-in-animals.adoc}. What did you get? 
...
== Exercises
@worksheet-link{pages/critiquing-findings.adoc, Critiquing Findings}
