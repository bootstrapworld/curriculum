...
== Do Now
[.lesson-instruction]
Open your workbooks to @workbook-link{pages/summarizing-columns-in-animals.adoc, Summarizing Columns}. We’ve already filled in the answer to Question 1 for you (`pounds`). In your animals starter file, make a `box-plot` for the `pounds` column, and fill in the 5-number summary for that column in your workbook.
...
[.lesson-instruction]
Open your workbooks to @workbook-link{pages/summarizing-columns-in-animals.adoc, Summarizing Columns}. Under the “measures of center” section, fill in the computed mean.
...
* Compute the median for the `pounds` column in the Animals Dataset, and add this to @workbook-link{pages/summarizing-columns-in-animals.adoc, Summarizing Columns}. 
...
=== Investigate
[.lesson-instruction]
Compute the `modes` of the `pounds` column, and add it to @workbook-link{pages/summarizing-columns-in-animals.adoc, Summarizing Columns}. What did you get? 
