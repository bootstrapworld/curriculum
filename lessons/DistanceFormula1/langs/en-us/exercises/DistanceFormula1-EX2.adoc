@design-recipe-exercise{ "collide?" "Use the Design Recipe to write a function ’collide?’, which takes in the coordinates of two objects and checks if they are within 50 pixels of each other" 
