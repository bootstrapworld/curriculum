...
Students should have their workbook, contracts page, a pencil, and their computers with a WeScheme tab opened and logged into.
...
Have students use this distance formula worksheet to model the distance formula with the Circles of Evaluation and translate it to code.
