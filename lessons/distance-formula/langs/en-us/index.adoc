...
<<<<<<< HEAD
--
We are about to tackle some of the most challenging code from this course. You are up for the challenge... but it's going to take some practice to make sense of. We're going to make sense of the code using

* Circles of Evaluation:  @printable-exercise{pages/distance-coe.adoc}
* From looking at examples: @printable-exercise{pages/distance-on-coordinate-plane.adoc}
=======
...
Optional: Have students use this @opt-printable-exercise{pages/Distance-bw-Two-Points-Multiple-Representations.pdf, Multiple Representations: Distance between two points} to model the distance between two point with the Circles of Evaluation, Code, Computations and a Graph. +
>>>>>>> 6f0c242166358e79eef2990ed1f8cf465c5b557a
