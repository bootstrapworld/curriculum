...
@link{pages/olympics-project.html, Olympics Project}
...
@span{.right}{@centered-image{images/lr-explained.png, LR explained, 400}}
...
@span{.right}{@centered-image{images/lin-reg-2.png, lin reg 2, 400}}
