...
A predictor __only makes sense within the range of the data that was used to generate it__. For example, a regression line predicting weight from height based only on adults could predict an infant to have a weight less than zero!
