...
[.lesson-instruction]
Take turns playing the game in pairs. After you've both had a chance to play, write down what you _notice_ about the game on @workbook-link{pages/NoticeAndWonder.adoc}. "Notice"s should be sentences, not questions - what stood out to you? What do you remember?
...
- Exit Slip: what role do coordinates play in video games?
