...
@description{Students pretend to be terrible data scientists who develop and support a claim based on faulty sampling techniques (selection bias, bias in the study design, poor choice of summary data, and confounding variables).}
