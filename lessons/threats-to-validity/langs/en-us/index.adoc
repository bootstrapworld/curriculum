...
. *Bias in the study design* - Suppose you survey a random sample of pet owners that includes representative numbers of both cat and dog owners. But you ask them a “loaded” question like “Since annual vet care comes to about $300 for dogs and only about half of that for cats, would you say that owning a cat is less of a burden than owning a dog?” This could easily lead to a misrepresentation of people’s true opinions. Similarly, a study that asks people to identify their favorite pet, but only gives cats and dogs options, denies people the opporunity to share their passion for rabbits or iguanas!
...
=== Investigate
[.lesson-instruction]
- Students should fill in the Findings portion of their @starter-file{research-paper}, discussing threats to validity and drawing conclusions from their linear regression results.
