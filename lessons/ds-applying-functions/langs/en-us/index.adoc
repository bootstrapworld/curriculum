...
=== Investigation
[.lesson-instruction]
Have students complete @worksheet-link{pages/applying-functions.adoc}.
...
- @worksheet-link{pages/fun-with-images.adoc, Fun with images!}
- @worksheet-link{pages/practicing-contracts-2.adoc, More Practicing Contracts}
- @worksheet-link{pages/matching-expressions-2.adoc, More Matching Expressions}
