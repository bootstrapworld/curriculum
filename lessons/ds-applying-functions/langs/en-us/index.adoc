...
@lesson-description{Students how to apply Functions, and how to interpret the information contained in a Contract: Name, Domain and Range. They then use this knoweldge to explore more of the Pyret language.}
...
- The values that we give to a function are called its @vocab{arguments}. How many arguments does @math{f} expect?
...
Have students type this line of code into the interactions area and hit Enter: `num-min(84, 140)`.

- What is the name of this function?
- What did the expression `num-min(16, 99)` evaluate to?
...
=== Investigation
[.lesson-instruction]
Have students complete @worksheet-link{workbook-pages/applying-functions.adoc}.
...
- @worksheet-link{workbook-pages/fun-with-images.adoc, Fun with images!}
- @worksheet-link{workbook-pages/practicing-contracts-2.adoc, More Practicing Contracts}
- @worksheet-link{workbook-pages/matching-expressions-2.adoc, More Matching Expressions}