...
[.lesson-instruction]
- How would you expect this weight limit affect adoption times of animals at the shelter?
- Make box-plots for the `pounds` and `weeks` column. What shapes do you see?
- Does this suggest the possibilty of a relationship between these two columns?
...
[.lesson-instruction]
Write your question on the bottom of @printable-exercise{pages/data-cycle-scatter-plot.adoc}, and complete the Data Cycle for your new question.
