...
@lesson-description{Students investigate scatter plots as a method of visualizing the relationship between two quantitative variables. In the programming environemt, points on the scatter plot can be labelled with a third variable!}

[@lesson-intro-table]
|===
@prereqs-stds{displaying-categorical-data}
| Lesson Goals
