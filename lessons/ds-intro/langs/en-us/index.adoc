...
=== Launch
Have students open the @starter-file{animals-spreadsheet} in a browser tab, or turn to @printable-exercise{pages/animals-dataset.adoc} in their Student Workbooks.
