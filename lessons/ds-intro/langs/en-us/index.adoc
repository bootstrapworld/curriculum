...
@lesson-description{Students are introduced to the Animals Dataset, and learn about Tables, Categorical and Quantitative data. They are also introduced to the Pyret IDE, and see how to import a table into Pyret and print it out in the Interactions Area.}
...
* link:{pathwayrootdir}/exercises/OpeningQuestions.pdf[Opening questions] printed for each student, group of students, or posted around the room.
...
[.lesson-instruction]
--
What kind of data -- categorical or quantitative -- are the following pieces of information?
