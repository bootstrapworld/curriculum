...
| Preparation
|
* Make sure student computers can access @link{https://docs.google.com/spreadsheets/d/19m1bUCQo3fCzmSEmWMjTfnmsNIMqiByLytHE0JYtnQM/edit#gid=0, the Animals Spreadsheet} and the @link{https://code.pyret.org/editor#share=1Z8ncVGKqWiED_wHl8TlNF3D9AGBb7awm&v=9dc9cc4, Animals Starter File}.
...
- @link{pages/what-can-you-answer.adoc, What can you answer?}
