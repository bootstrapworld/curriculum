...
* @link{pages/OpeningQuestions.pdf, Opening questions} printed for each student, group of students, or posted around the room. *Note:* these are just ideas to get your started. Use questions that you know will interest __your__ students!
...
=== Investigate
[.lesson-instruction]
- _How would you measure?_ Give students 5 minutes to think about what information they would need to collect, to find the answer.
...
- *Compute questions* -- These can be answered by computing an answer across a single row or column. Examples of computing questions might be “how much does the heaviest animal weigh?” or “What is the average age of animals from the shelter?”
