...
* @link{pages/OpeningQuestions.pdf, Opening questions} 
* @link{https://docs.google.com/spreadsheets/d/1VeR2_bhpLvnRUZslmCAcSRKfZWs_5RNVujtZgEl6umA/edit?usp=sharing, the Animals Spreadsheet}
...
=== Launch
Have students open the @link{https://docs.google.com/spreadsheets/d/1VeR2_bhpLvnRUZslmCAcSRKfZWs_5RNVujtZgEl6umA/edit?usp=sharing, Animals Spreadsheet} in a browser tab, or turn to @workbook-link{pages/animals-dataset.adoc} in their Student Workbooks. 
...
[.lesson-instruction]
- Turn to @workbook-link{pages/questions-and-column-descriptions.adoc} in your Student Workbook. What do you _Notice_ about this dataset? Write down your observations in the first column.
...
* On @workbook-link{pages/questions-and-column-descriptions.adoc} in your Student Workbook, fill in the blanks for questions 8-13.
--
...
- Look back at the Wonders you wrote on
  @workbook-link{ds-intro/pages/questions-and-column-descriptions.adoc}. Are any of these Lookup, Compute, or Relate questions? Circle the question type that’s appropriate. Can you come up with additional examples for each type of question?

=== Synthesize
Have students share their questions with the class. Allow time for discussion!

Have students reflect on what they learned by writing on @workbook-link{pages/whats-on-your-mind.adoc}. Some prompts that may be helpful:
...
- @exercise-link{pages/what-can-you-answer.adoc}