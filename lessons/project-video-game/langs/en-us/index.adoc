...
| *0{empty}.  Game title*
| @lesson-link{lessons/coordinates, Coordinates and Game Design} and @lesson-link{lessons/making-game-images, Making Game Images}

| @printable-exercise{coordinates/pages/BrainstormGame.adoc}

| *1{empty}. Making the Danger and the Target Move*
| @lesson-link{lessons/functions-for-character-animation, Functions for Character Animation}
...
| @lesson-link{lessons/player-animation, Player Animation}
...
| *4{empty}. Collisions*
| @lesson-link{lessons/inequalities-collision, Collision Detection - Distance and Inequality} @lesson-link{lessons/inequalities-collision-wescheme, Collision Detection - Distance and Inequality}
