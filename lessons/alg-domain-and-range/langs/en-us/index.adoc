...
- If you have time, students could complete @activity-link{https://teacher.desmos.com/activitybuilder/custom/5fc5415a24be4c0d054d73b2, Matching Expressions and Contracts (Desmos Activity)}
}
...
@ifproglang{pyret}{
- @activity-link{https://teacher.desmos.com/activitybuilder/custom/5fc90a1937b6430d836b67e7, Matching Images to Code (Desmos Activity)}}
