...
*5* is our @vocab{base} in both of the equations above.
...
@A{What power do we raise 3 to in order to reach 81?}
...
(b) "The power you raise 2 to get 128"
}
}
...
@objective{logarithms-model-params}

=== Overview
Students are introduced to the form of logarithmic models, and explore the role the coefficients play using a custom-built Desmos slider activity.
