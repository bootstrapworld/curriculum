...
In fact, logarithmic compression of sensory input holds true for virtually every sense we have! The @link{https://en.wikipedia.org/wiki/Weber%E2%80%93Fechner_law, Weber–Fechner law} states that the relationship between _stimulus_ (real-world sensory input) and _perception_ (how we perceive that input) is logarithmic!
