...
You just created a *new type of data visualization*, called a @vocab{line graph}. In some situations the explanatory variable is continuous meaning that you know there are values in between the points.  
