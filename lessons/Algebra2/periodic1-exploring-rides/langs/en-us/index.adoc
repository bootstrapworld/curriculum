...
@A{Guide the converstation toward the conclusion that YES there is a relationship.}
...
- The Babylonians chose to use 360 slices to map out the "circle" representing the night sky, because 360 is roughly the number of days in a year and most easy-to-see constellations repeat their cycles annually.
  * 360 is also easily divided by common numbers like 2, 3, 4, 6, 8, 9, 10, and 12, which simplifies calculations.
- Babylonians also noticed that there were roughly 12 full moons each year. 
  * 12 is a convenient number for people counting with their hands, because each thumb is able to reach 12 knuckles on its hand.
...
- @right{@image{images/egyptian-sundial.jpg, 150}}Many ancient peoples divided the night and day into 12 slices each (giving us 24 hours). 
  * @link{https://en.wikipedia.org/wiki/Sundial, Sundials} map the journey of the shadow cast by the sun as it moves across the sky, dividing the map into 12 slices. The oldest-known sundial is from 1500 B.C.! 
