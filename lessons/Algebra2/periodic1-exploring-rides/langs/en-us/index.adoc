 ...
 * How many minutes are represented by 1 degree?
   *** @math{\frac{1}{6}}
 * How many minutes are represented by 10 degrees?
   *** @math{1}
}
...
- Return to the @starter-file{alg2-unit-clock}, change `num-slices` to 360, and click "Run". Does this change the shape of the curves?
...
- Can you divide the clock into 70 slices? 92? Does this change the shape of the curves?
- Change the definition of `is-cw` so that the clock moves _counter_ clockwise. Does _this_ change the shape of the curves?
- }
