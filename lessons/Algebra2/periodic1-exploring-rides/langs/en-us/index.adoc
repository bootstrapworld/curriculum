...
Most calculators abbreviate these funtions as `sin` and `cos` and bury the distinction between whether or not they consume @vocab{radians} or @vocab{degrees} somewhere in the settings.
...
- Note that to find the Sine of @math{0.25\pi} in Pyret you would need to know use `sin(0.25 * PI)`
}
