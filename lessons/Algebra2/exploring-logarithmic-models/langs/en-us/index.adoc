...
@optional For practice differentiating between quadratic, exponential, and logarithmic relationships, optional exercises are available for @opt-printable-exercise{classifying-tables.adoc, Tables}, @opt-printable-exercise{classifying-plots.adoc, Graphs} and @opt-printable-exercise{classifying-examples.adoc, Examples}.
