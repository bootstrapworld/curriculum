...
=== Overview
Having identified that the wealth-v-lifespan scatter plot is neither linear, quadratic, or exponential, students learn about characteristics of logarithmic functions in graphical, tabular, and function notation form.
