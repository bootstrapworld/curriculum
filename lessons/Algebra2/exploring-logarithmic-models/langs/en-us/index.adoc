...
You will want to:
 * Open @starter-file{alg2-wealth-v-health-desmos}.
...
This transformation changed the _kind of growth_ from logarithmic to linear: the term went from @math{a \log_{10}(x)} to @math{ax}. Instead of increasing logarithmically by @math{a}, our new function increases __linearly__ by @math{a}.
