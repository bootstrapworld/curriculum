...
@teacher{Sync or pace students to *Slide 4: Exploring Logarithmic Functions* of @starter-file{alg2-log-desmos}. Decide whether you want to debrief as a class after they complete each section of @printable-exercise{graphing-models.adoc} or will wait to debrief at the end.}
...
@Q{How does @math{a} and @math{c} compare with other students'? Are they very similar or very different?}
...
- With that image in mind, let's complete the last section of @printable-exercise{changing-scale.adoc}.
}
