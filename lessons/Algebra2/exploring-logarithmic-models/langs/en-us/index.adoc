...
This section builds the foundation for _linearization_, in which students will transform the points themselves in the following section. (Note: this also opens the door for teaching inverse functions!)
