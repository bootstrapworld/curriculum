...
@teacher{Sync or pace students to _Slide 5: Wealth-v-Health (Logarithmic)_ of @starter-file{alg2-log-desmos}.}

@lesson-instruction{
- Complete the first section of @printable-exercise{changing-scale.adoc}, using _Slide 5: Wealth-v-Health (Logarithmic)_ of the *Desmos* file.
...
@teacher{Sync or pace students to _Slide 6: Wealth-v-Health (Transformed)_ of @starter-file{alg2-log-desmos}.}

@lesson-instruction{
- Complete @printable-exercise{transforming-data.adoc}, using _Slide 6: Wealth-v-Health (Transformed)_ of the *Desmos* file.
