...
[.lesson-instruction]
- Complete the first section of @printable-exercise{transforming-axis.adoc}, using @starter-file{alg2-wealth-v-health-logarithimic-desmos}.
...
[.lesson-instruction]
Complete the last section of @printable-exercise{transforming-axis.adoc}, using @starter-file{alg2-wealth-v-health-logarithimic-desmos}.
