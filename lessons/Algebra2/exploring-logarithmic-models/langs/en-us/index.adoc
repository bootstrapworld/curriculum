...
- Optional: Use @opt-online-exercise{https://www.desmos.com/calculator/l1rjtbxw9j, Wealth-v-Health - Linear} to try fitting linear models for this dataset
- Optional: Use @opt-online-exercise{https://www.desmos.com/calculator/hpieba0sit, Wealth-v-Health - Quadratic} to try fitting quadratic models for this dataset
- Optional: Use @opt-online-exercise{https://www.desmos.com/calculator/plcreyyex2, Wealth-v-Health - Exponential} to try fitting exponential models for this dataset
