...
- the *slope* in the transformed, linear model = the *log coefficient* in the un-transformed logarithmic model

- the *vertical shift* in the transformed, linear model = the *vertical shift* in the un-transformed logarithmic model
}
