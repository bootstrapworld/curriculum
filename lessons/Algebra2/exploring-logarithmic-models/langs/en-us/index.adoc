...
@right{@image{images/decibels-table.png, 350}}@vocab{Logarithmic relationships} *allow us to compare things of very different sizes!*
...
@slidebreak
@right{@image{images/view-from-airplane.jpg, 350}}@ifslide{@vocab{Logarithmic relationships} *allow us to compare things of very different sizes!*
}
...
@slidebreak
@right{@image{images/railroad-tracks.jpg, 350}}@ifslide{@vocab{Logarithmic relationships} *allow us to compare things of very different sizes!*}
...
@slidebreak
@right{@image{images/chili.png, 150}}@ifslide{@vocab{Logarithmic relationships} *allow us to compare things of very different sizes!*}
...
*No matter the base, @math{log(1)} will always be zero!*
...
Since @math{log_{anything}(1) = 0}, the value of a standard log model at @math{x=1} will always be @math{0 + c}.
