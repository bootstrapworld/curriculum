...
[.linkInstructions]
For this page, you'll need to have **Exploring Logarithmic Functions (Desmos)** open on your computer.
...
@n What would the next number be, if you were to add one at the far right: @fitb{5em}{} __Describe__ the pattern you used to find it: @fitb{}{}
...
@n What would the next number be, if you were to add one at the far right: @fitb{5em}{} __Describe__ the pattern you used to find it: @fitb{}{@ifsoln{the numbers increase, **multiplying** by a constant factor}}

@n What is the shape of the point cloud __now?__  @fitbruby{}{@ifsoln{It's linear!}}{Is it linear? Quadratic? Exponential? Something else?}
