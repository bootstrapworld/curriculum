...
- *pc-gdp-in-thousands* - "per-capita GDP in thousands of $US": the average GDP _per-person_ in thousands of $US
...
!===
| @n Make a scatter plot showing the relationship between `pc-gdp-in-thousands` and `median-lifespan`, and sketch its plot below.
