...
@n Do you think you see a correlation? If so, describe it, using the terms linear/nonlinear and strong/weak.
...
|===
|
@hspace{3em}@math{f(x) = }@fitbruby{10em}{}{initial value (a)}@math{\times}@fitbruby{10em}{}{growth factor (b)}@math{^x + } @fitbruby{10em}{}{vertical shift (k)}
|
@fitbruby{10em}{}{R^2^}
|===
