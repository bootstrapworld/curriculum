...
@n What is the value of @math{x} when @math{log_{10}(x) = 6}? @fitb{6em}{@ifsoln{1,000,000}} @hspace{1em} What about when @math{2log_{10}(x) = 6}? @fitb{5em}{@ifsoln{1,000}} @hspace{1em} When @math{3log_{10}(x) = 6}? @fitb{5em}{@ifsoln{100}}
