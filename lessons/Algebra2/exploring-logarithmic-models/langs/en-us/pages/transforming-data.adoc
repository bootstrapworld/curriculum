...
@fitb{}{@ifsoln{We are using the function @math{g(x)} to take the log of `pc-gdp-in-thousands`}}
...
@n *Rescale* the graph ([.desmosbutton]#{magnifying}#) to see the cloud. Circles the type of function that best describes the shape of this point cloud: +
@center{@ifsoln-choice{Linear} @hspace{10em} Quadratic @hspace{10em} Exponential}
