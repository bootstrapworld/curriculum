...
@n Look back at the values you wrote for log coefficient (@math{a}) and vertical shift (@math{c}) on question 8 of @printable-exercise{exploring-logarithmic-models/pages/transforming-axis.adoc} and copy them here:
