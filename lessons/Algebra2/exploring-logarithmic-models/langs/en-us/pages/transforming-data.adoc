...
@n *Rescale* the graph ([.desmosbutton]#{magnifying}#) to see the cloud. What is the shape of this point cloud?   @hspace{2em} @ifsoln-choice{linear}@ifnotsoln{&#9744;}  @hspace{2em} 
