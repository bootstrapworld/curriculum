...
@n Use `fit-model` to calculate the value of @math{R^2}: @fitb{}{@ifsoln{0.66311}}

@n How do you interpret this model? @fitb{}{@ifsoln{A 10x increase in per-capita GDP is associated with median-lifespan increasing by 11.9 years}}
