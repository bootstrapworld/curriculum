...
@n Use the values produced by `lr-plot` to complete the model: @math{logarithmic(x) =} @fitbruby{9em}{@ifsoln{11.9011}}{slope} @math{\times log_{10}(x) +} @fitbruby{9em}{@ifsoln{24.2636}}{scaling factor}
