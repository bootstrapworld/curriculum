...
@n Use the sliders for @math{a} and @math{k} to create the best-fitting logarithmic model you can find, and write it below.

@vspace{1ex}

@indented{_Note: The Bootstrap Pyret function `log` always uses @math{b = 10}._}
