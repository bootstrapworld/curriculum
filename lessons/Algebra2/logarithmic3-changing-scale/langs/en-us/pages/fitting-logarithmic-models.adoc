...
@link-instructions{You should be on *Slide 8: Wealth-v-Health (Logarithmic, w Scaled Axes)* of *Fitting Wealth-v-Health and Exploring Logarithmic Models (Desmos)*.}
