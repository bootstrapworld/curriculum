...
@link-instructions{You should be on *Slide 8: Wealth-v-Health (Logarithmic, with Scaled Axes)* of *Fitting Wealth-v-Health and Exploring Logarithmic Models (Desmos)*.}
...
@n Why does transforming the *x-axis* make our data look linear? @fitb{}{} +
@blanklines{2}{
