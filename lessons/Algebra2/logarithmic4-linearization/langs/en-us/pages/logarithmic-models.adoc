...
@n Find the definition of `g(r)` in the @starter-file{alg2-countries}. What does this function do? @fitb{}{} +
@fitb{}{@ifsoln{`g` produces the log of the `pc-gdp` column, which it gets from the country it's given}}

@n At the end of the program, find: @hspace{1em}@show{(code '(define countries-transformed (build-column countries-table "log(pc-gdp)" g)))}

[.indentedpara]
--
What do you think this code does? @fitb{}{@ifsoln{It defines a new table called `countries-transformed` -- the result of building  "log(pc-gdp)".}}
...
@fitbruby{8em}{@ifsoln{192}}{how many?}
@fitbruby{8em}{@ifsoln{countries}}{what?} whose 
@fitbruby{15em}{@ifsoln{per-capita GDP}}{x-variable} ranged from
@fitbruby{7em}{@ifsoln{587}}{x-min} to
@fitbruby{7em}{@ifsoln{144104}}{x-max}
@fitbruby{8em}{@ifsoln{dollars}}{x-variable units}. 

@n Possible limitations of this model include @fitbruby{}{@ifsoln{Data is from a single year and severely skewed to the right.}}{uneven distribution, high variability, small sample size, etc.}

@n Let's interpret this model: __A country where the @fitbruby{25em}{@ifsoln{pc-gdp}}{explanatory variable (x)} is @fitbruby{3em}{@ifsoln{10}}{base (b)} times higher than another is also predicted to have a @fitbruby{20em}{@ifsoln{median-lifespan}}{response variable (y)} that is @fitbruby{8em}{@ifsoln{11.9}}{log coefficient (a)} @fitbruby{10em}{@ifsoln{years}}{y-axis units} longer.__

@n Add the definition of `logarithmic3` to your starter file. Then calculate the @vocab{S-value}s to complete the table below using `fit-model`:
...
@n Predictions made with the logarithmic model are expected to have
