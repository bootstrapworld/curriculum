...
What do you think it does? @fitb{}{@ifsoln{It defines a new table called `countries-transformed` -- the result of building  "log(pc-gdp)".}}
...
@center{
@math{y = } @fitbruby{10em}{@ifsoln{11.9012}}{slope} @math{x + } @fitbruby{10em}{@ifsoln{24.2636}}{vertical shift} @hspace{15em} @math{S:}@fitb{10em}{@ifsoln{4.4786}}
}
