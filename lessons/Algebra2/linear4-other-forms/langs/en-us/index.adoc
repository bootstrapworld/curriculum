...
@lesson-point{
@math{f(x) = m(x-h) + k} is an expanded version of the slope-intercept form that allows us to change both the horizontal shift (@math{h}) and the vertical shift (@math{k}).
}
