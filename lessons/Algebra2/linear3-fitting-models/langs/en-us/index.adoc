...
- Compare this optimal model to the models you built on @printable-exercise{model-college-v-income-2.adoc} (and, if you completed it, to the models you built on @opt-printable-exercise{model-college-v-income-3.adoc}).
}
