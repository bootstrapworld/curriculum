...
@lesson-instructions{
Complete @printable-exercise{model-college-v-income-2.adoc}, following the directions to define new models using what you know about slope and y-intercept.
}
