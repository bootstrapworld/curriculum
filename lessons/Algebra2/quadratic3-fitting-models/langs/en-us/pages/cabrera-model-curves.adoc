= Modeling Bat Angle v. Hit Distance (curve balls)
++++
<style>
...
@link-instructions{
For this section, open *Exploring Quadratic Functions(Desmos)* to *Slide 4: Fitting a Model: Bat Angle v Hit Distance (curve balls)*. +
}
...
@link-instructions{
Open your copy of the @opt-starter-file{alg2-miguel-cabrera}. Adjust the definition for `sliders(x)` on line 48 and click "Run".
}
