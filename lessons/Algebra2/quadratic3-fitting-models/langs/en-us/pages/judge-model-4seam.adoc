= Modeling Bat Angle v. Hit Distance - A.Judge (Four-seam Fastballs)
++++
<style>
...
@link-instructions{
For this section, open *Exploring Quadratic Functions - A.Judge (Desmos)* to *Slide 6: Fitting a Model: Bat Angle v Hit Distance (4-seam fast balls)*. +
}
...
@link-instructions{
Open your copy of the @opt-starter-file{alg2-aaron-judge}.
