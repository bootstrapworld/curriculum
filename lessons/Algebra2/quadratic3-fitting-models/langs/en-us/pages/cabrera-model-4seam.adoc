...
@link-instructions{
For this section, open *Exploring Quadratic Functions (Desmos)* to *Slide 5: Fitting a Model: Bat Angle v Hit Distance (Four seam Fastballs)*. +
}
...
@link-instructions{
Open your copy of the @opt-starter-file{alg2-miguel-cabrera}.
