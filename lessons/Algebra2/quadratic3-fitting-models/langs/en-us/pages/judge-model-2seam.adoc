= Modeling Bat Angle v. Hit Distance - A.Judge (Two-seam Fastballs)
++++
<style>
...
@link-instructions{
For this section, open *Exploring Quadratic Functions - A.Judge (Desmos)* to *Slide 4: Fitting a Model: Bat Angle v Hit Distance (2-seam fast balls)*.
}
