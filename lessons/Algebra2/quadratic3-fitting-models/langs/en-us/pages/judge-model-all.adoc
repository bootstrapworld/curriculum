= Modeling Bat Angle v. Hit Distance - Aaron Judge (Full Data)
++++
<style>
...
@link-instructions{
For this section, open *Exploring Quadratic Functions - A.Judge (Desmos)* to *Slide 8: Fitting a Model: Bat Angle v Hit Distance (Full Data)*. +
}
