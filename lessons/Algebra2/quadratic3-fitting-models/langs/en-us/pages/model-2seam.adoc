= Modeling Bat Angle v. Hit Distance (Two-seam Fastballs)
++++
<style>
...
Adjust the definition for `fast2seam(x)` on line 51 and click "Run".
...
@indented{considering that @fitbruby{10em}{@ifsoln{hit distances}}{y-variable} in this dataset range from @fitbruby{10em}{@ifsoln{85}}{lowest y-value} to @fitbruby{10em}{@ifsoln{484}}{highest y-value}.}
