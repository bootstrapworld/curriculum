...
@link-instructions{
For this section, you'll need to have *Exploring Quadratic Functions (Desmos)* open to *Slide 3: Fitting a Model: Bat Angle v Hit Distance (Sliders)*. +
}
...
@n The vertex of the parabola drawn by this model is a @fitbruby{9em}{@ifsoln{maxima}}{minima or maxima?} at about @fitbruby{6em}{@ifsoln{(31, 430)}}{(x, y)}, which means that +
@fitb{}{@ifsoln{the optimal hitting the ball is about 31 degrees, yielding hits upwards of 430 feet.}}
...
@n The error in the model is described by an @vocab{S-value} of about @fitbruby{5em}{@ifsoln{71}}{S}@fitbruby{8em}{@ifsoln{feet}}{units}. @hspace{1em} I
