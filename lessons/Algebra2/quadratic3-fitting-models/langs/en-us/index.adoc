...
- If your students are more into the Yankees, you can find parallel versions of each of these worksheets that deal with data from Aaron Judge, which rely on @opt-starter-file{alg2-exploring-quadratics-desmos-judge}:
