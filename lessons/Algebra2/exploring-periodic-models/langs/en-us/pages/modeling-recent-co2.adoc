...
@n Use the @vocab{amplitude} and @vocab{trough} data to compute the @vocab{vertical shift} (@math{k}) or "@vocab{midline}" of the data: @fitbruby{}{@ifsoln{@lo + @a = @c}}{parts per million}
