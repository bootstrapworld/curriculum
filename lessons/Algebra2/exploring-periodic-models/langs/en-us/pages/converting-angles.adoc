...
{empty} +
@n Fill in the rows for 12, 6, and 9 o'clock, converting between hours, degrees, and radians. +
{empty} +
@n Fill in the rows for 1:30, 7:30, 10:30, and 4:30, converting between hours, degrees, and radians. +
{empty} +
