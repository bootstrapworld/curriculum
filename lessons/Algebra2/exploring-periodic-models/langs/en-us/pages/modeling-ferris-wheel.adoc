...
@link-instructions{For this section, use *Slide 2: "Modeling the Ferris Wheel Dataset (sin)"* of the *Exploring Periodic Functions* Desmos File.} You'll find *the data from the Ferris Wheel plotted in red*, along with a basic periodic model of the form @math{f(x) = a \sin(b(x - h)) + k}.
