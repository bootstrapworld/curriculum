...
@teacher{Decide whether you'd like to remind your students about using the Pythagorean Theorem and/or Trig Ratios for finding the lengths of legs of a right triangle before asking them to identify x and y for 45 degrees.}
...
@ifslide{@right{@image{images/pizza-slice.svg, 200}}}_Degrees_ divide our the circle into 360 "slices", where the tip of the slice is 1/360th of the circle. Switching our unit-clock graph from hours to degrees just changes the tick marks on the x-axis.
