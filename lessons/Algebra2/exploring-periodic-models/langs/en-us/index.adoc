...
- Open the @starter-file{alg2-ferris-wheel}, and change the definition of `periodic1` and `periodic2` to match the models defined on @printable-exercise{modeling-ferris-wheel.adoc}. How well do they fit?
}
