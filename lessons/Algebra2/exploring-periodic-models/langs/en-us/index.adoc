...
- With your partner, complete @printable-exercise{modeling-ferris-wheel.adoc}, advancing to *Slide 3: Translating from sin to cos* and *Slide 5: Modeling the Ferris Wheel Dataset (cos)*.
}
