...
@optional{Direct your students to @opt-printable-exercise{model-college-v-income-1-scaffolded.adoc} instead if they could use more support for finding the equation of the line between two points.}
...
** Point-Slope Form
* We want to define our model in Pyret. Which form makes it easiest to do that?
