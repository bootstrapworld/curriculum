...
[.lesson-instruction]
- Complete @printable-exercise{model-college-v-income-A.adoc}.
...
[.lesson-instruction]
- Complete @printable-exercise{model-college-v-income-B.adoc}.
- Based on the @math{R^2} values of the plots you created on this page, what do you think @math{R^2} means?
...
[.lesson-instruction]
- Complete the first section ("Build a Model through Trial and Error") on @printable-exercise{model-college-v-income-C.adoc}.
...
[.lesson-instruction]
- Complete the last section ("Build a Model Computationally") in @printable-exercise{model-college-v-income-C.adoc}.
- How close did you come to the optimal model? Did anything about the model surprise you?
- @optional Turn to @opt-printable-exercise{graphing-models.adoc} and sketch graphs for three of the models you wrote on @printable-exercise{model-college-v-income-A.adoc} and @printable-exercise{model-college-v-income-C.adoc}.
...
Students will be guided through an exploration of the relationship between horizontal and vertical shifts of the line. Written exercises accompany a Desmos activity we've written.
