...
@teacher{
*_NOTE:_* for students who need more scaffolding/review to find the equation of the line between two points, you may wish to use @opt-printable-exercise{model-college-v-income-1-scaffolded.adoc}
