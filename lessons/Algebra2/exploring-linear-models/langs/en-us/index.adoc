...
- Based on the @math{R^2} values and plots you created on this pag, what do you think @math{R^2} means?
...
@teacher{Sometimes the slope or y-intercept of a linear model have too many digits to be displayed clearly. When this happens, Pyret will convert them to scientific notation. While students have seen this (most likely in 8th grade), you should make sure they understand it before proceeding.}
