...
@teacher{A Statistics class would spend some time talking about what a @vocab{residual} is, and how to compute @vocab{Standard Deviation}. There is an optional @lesson-link{standard-deviation, Bootstrap lesson about Standard Deviation} as well!
}
