...
Choose three lienear models from @opt-printable-exercise{model-your-own}: your first guess, a closer guess, and then your *best* guess. For graph each model in the squares below, being sure to draw your axes. Then label the slope, y-intercept, and @math{R^2} value of each model!
