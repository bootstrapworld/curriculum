...
@n Evaluate @show{(code '(lr-plot states-table "state" "college-or-higher" "median-income"))}. What is @math{S}? @fitb{}{@ifsoln{}}
...
@n Suppose a state goes from 10% to 11% college graduation. According to this model, 
  ...
  * What if it goes from 50% to 51%? @fitb{7em}{@ifsoln{$1142}} 
  * What if it goes from 90% to 91%? @fitb{}{@ifsoln{$1142}}
