...
- Open your copy of the @starter-file{alg2-miguel-cabrera}.
...
Modern AI works the same way: it _looks for patterns_, but doesn't really _understand_ anything. As a result, they can easily come up with answers that look _mostly_ right...but aren't. That's where Data Scientists who understand the math -- and the data -- come in! They know exactly where to focus to find the vertex, the roots, or the axis of symmetry. They know exactly which form makes the most sense, given the data available.
