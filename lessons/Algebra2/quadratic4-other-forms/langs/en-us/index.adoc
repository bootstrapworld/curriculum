...
<|
- @math{a}: {nbsp}quadratic coefficient
- @math{h}: {nbsp}horizontal shift and x-coord of vertex
- @math{k}: {nbsp}vertical shift and y-coord of vertex
<| 
- @math{a}: {nbsp}quadratic coefficient
- @math{r_1}: {nbsp}first root / x-intercept
- @math{r_2}: {nbsp}second root / x-intercept
<|
- @math{a}: {nbsp}quadratic coefficient
- @math{b}: {nbsp}linear coefficient
- @math{c}: {nbsp}vertical shift
