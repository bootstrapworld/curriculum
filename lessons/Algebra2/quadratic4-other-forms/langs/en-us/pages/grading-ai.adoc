...
@blanklines{5}{
Factored form is @math{f(x) = a(x - r_1)(x - r_2)}. For those subtraction signs to turn to addition, it means the AI is getting the sign of the roots wrong! It's also getting the sign of @math{a} wrong – positive means the parabola should open _up_, but this is facing down.
}
