...
.fitbruby { --fitb-height: calc(0rem + 1em); }
</style>
++++
...
@fitbruby{90%}{@ifsoln{none}}{Root(s)/x-Intercept(s) - _record coordinate(s) or write "none" or "hard to tell"_}
...
@fitbruby{90%}{@ifsoln{(11, 0) and (243, 0)}}{Root(s)/x-Intercept(s) - _record coordinate(s) or write "none" or "hard to tell"_}
...
@fitbruby{90%}{@ifsoln{n/a}}{Root(s)/x-Intercept(s) - _record coordinate(s) or write "none" or "hard to tell"_}
...
@fitbruby{90%}{@ifsoln{(5,0)(16,0)}}{Root(s)/x-Intercept(s) - _record coordinate(s) or write "none" or "hard to tell"_}
...
@fitbruby{90%}{@ifsoln{not easy to tell}}{Root(s)/x-Intercept(s) - _record coordinate(s) or write "none" or "hard to tell"_}
