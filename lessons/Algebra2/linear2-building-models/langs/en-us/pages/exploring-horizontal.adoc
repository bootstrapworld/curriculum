...
@math{h = 4.6}, what value for @math{k} will land the solid blue line on top of the dashed black line? @fitb{}{@ifsoln{-2.3}}

@vspace{1ex}

Move the sliders to new values for @math{m = } @fitb{3em}{} and @math{h = } @fitb{3em}{}.

@n What value for @math{k} will land the solid blue line on top of the dashed black line now? @fitb{}{@ifsoln{-2.3}}
...
@math{h} for which you can't land the solid blue line on top of the dashed line by changing @math{k}?
