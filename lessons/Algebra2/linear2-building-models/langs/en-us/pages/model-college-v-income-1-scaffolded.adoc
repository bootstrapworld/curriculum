= Scaffolded: Build a Model from Samples (Optional)
++++
<style>
...
.sectionbody > .paragraph:first-child .autonum { padding-top: 0.3em; }
</style>
++++
...
- How well does it predict the correct median income for Alabama? @fitb{10em}{@ifsoln{close! 43252.922}} For Alaska? @fitb{}{@ifsoln{close! 70759.905}}
}
