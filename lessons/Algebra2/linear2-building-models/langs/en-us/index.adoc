...
@teacher{
@opt{Student workbooks also include a @printable-exercise{model-college-v-income-1-scaffolded.adoc, scaffolded version of Build a Model from Samples: College Degrees v. Income} that you can use *in place* of the more open-ended one if your students need more support with finding the equation from two points.}
}
@slidebreak{Investigate}
