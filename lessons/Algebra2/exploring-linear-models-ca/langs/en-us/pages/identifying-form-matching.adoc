...
_Note: The computer won't tell us if the relationship we see in a scatter plot is linear, so we must train our eyes to decide this ourselves. For linear relationships, we should train our eyes to assess their direction and get a feel for their strength, rather than relying completely on what numbers the computer reports._
