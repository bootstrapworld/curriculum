...
Educators choose vocabulary carefully, assigning clear names to concepts that are abstract and important. So what vocabulary word should math teachers use for @math{a}, @math{b}, and @math{c} in the parent function below?
