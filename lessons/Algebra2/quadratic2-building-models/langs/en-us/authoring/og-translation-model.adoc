...
@n The *vertex form* of a quadratic model is shown below. Fill in the blank using the "peak" of your curve from @printable-exercise{quadratic1-exploring-mpg/pages/exploring-mpg.adoc}:
