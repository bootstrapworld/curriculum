...
++++
<style>
/* Make directions take up as little space as possible */
#content #preamble_disabled{ flex-grow: 0 !important; }

.autonum { padding-top: 0.5em !important; }
...
[.FillVerticalSpace, cols="^.>1a,^.>1a,^.>1a,^.>1a", options="header"]
|===
| (first airing) +
x = 1
| (second airing) +
