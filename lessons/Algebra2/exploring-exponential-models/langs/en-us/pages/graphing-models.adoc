...
== Base @math{b}
@n Make sure @math{k = 0} and @math{a=1}. Experiment with @math{b}. *For what values of @math{b} is the function _undefined_?* (the line will disappear)? @fitb{}{@ifsoln{negative}}
