...
__For this section, you'll need to have **Slide 3: Exploring Exponential Models** of **Modeling Covid Spread (Desmos)** open on your computer.__ The curve you'll see is the graph of @math{h(x) = 2^x}. +
