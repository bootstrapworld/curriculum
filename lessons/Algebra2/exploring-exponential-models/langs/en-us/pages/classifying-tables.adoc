...
Decide whether each table is best described by a linear, quadratic, or exponential model. **If the model is exponential:** Is it doubling (factor of 2)? Tripling (factor of 3)? Factor of 5? 10?
