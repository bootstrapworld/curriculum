...
@n In the Definitions Area we see rows defined for Connecticut (`CT1`), Massachusetts (`MA1`) and Maine (`ME1`). Evaluate `MA1` in the Interactions Area. What do you get back? @fitb{}{@ifsoln{A single row of the table}}

@n Write as much information as you can from `CT1`. @fitb{}{@ifsoln{1 day after 6/20/20, the state of}}
...
@hspace{1em}+a.+ How many people in Vermont tested positive on June 21st, 2020? @fitb{5em}{@ifsoln{1092}} +
@hspace{1em}+b.+ How many people in New Hampshire tested positive on June 21st, 2020? @fitb{5em}{@ifsoln{5178}} +
@hspace{1em}+c.+ How many people in Rhode Island tested positive on June 21st, 2020? @fitb{5em}{@ifsoln{15855}}
...
[.FillVerticalSpace.mainTable, cols="2a,.^1a", options="grid",stripes="none",frame="none"]
|===
|
@center{
    @ifnotsoln{@image{../images/covid-grid.png, 400}}
    @ifsoln{@image{../images/covid-scatterplot.png, 400}}
}
