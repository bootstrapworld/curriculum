...
@teacher{
@opt{Advance your teacher dashboard of @starter-file{alg2-covid-desmos} to the second slide ("How does h transform exponential functions?") and give students a change to explore how horizontal shifts would work for exponential functions.
}}
