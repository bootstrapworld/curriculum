...
@indented{_A negative @math{b} would bounce from one side of the y-axis to another. +
And, when raised to a fractional power, negative values of @math{b} might also lead to things like_ @math{\sqrt{-2}}!}
...
@teacher{In the following activities, students will:
