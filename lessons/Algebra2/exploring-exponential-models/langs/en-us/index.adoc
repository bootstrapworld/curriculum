...
- Working in pairs or small groups, complete the rest of @printable-exercise{exploring-covid.adoc}.
...
** _Another example can be found @link{https://towardsdatascience.com/simpsons-paradox-and-interpreting-data-6a0443516765, on this web page}._
}
...
- Vertical shift (@math{k}) means the same thing as it always does
...
- When @math{b > 1}, this growth is _positive_. A base of 2 means _y_ will double for every increment of _x_. This is called exponential growth.
- When @math{b < 1}, this growth is _negative_. A base of 0.5 means _y_ will drop by half for every increment of _x_. This is called exponential decay.
