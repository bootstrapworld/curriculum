...
- Any guesses as to what @math{a} describes in the model? @math{b}? (_Optional: give students time to experiment with @opt-online-exercise{www.desmos.com}._)
...
In a math classroom, this is the difference between @math{\frac {2}{3}} rendering as @math{ 0.\overline{666}} repeating or being rounded to 0.666666667.
