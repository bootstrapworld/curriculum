...
== Magnitude @math{a}
@n Try changing the value of @math{a} to -4, 0, 2. For each value, graph the parabola in the squares below.
...
@n Set @math{a} back to 1. Change the value of @math{h} to -20, 0, and 10, graphing each parabola in the squares below.
...
@n Set @math{h} back to 0. Change the value of @math{k} to -15, 0, and 15, graphing each parabola in the squares below.
