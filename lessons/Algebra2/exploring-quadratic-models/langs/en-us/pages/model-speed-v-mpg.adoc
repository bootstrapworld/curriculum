...
@fitb{}{@ifsoln{Sample response: It needs to shift right and up and curve less gradually.}}
...
After experimenting, I came up with a @fitbruby{8em}{@ifsoln{quadratic}}{form} model for this dataset showing that @fitbruby{5em}{@ifsoln{speed}}{x-variable} is correlated to @fitbruby{}{@ifsoln{gas mileage}}{y-variable}. +
@ifsoln{Note: Numerical responses will vary!} +
...
The vertex of the parabola drawn by this model is a @fitbruby{10em}{@ifsoln{maximum}}{minimum or maximum?} at about @fitbruby{8em}{@ifsoln{(45, 33)}}{(x, y)}, which means that @fitb{}{}
@fitb{}{@ifsoln{It's most efficient to drive at about 45mph, at which speed cars seem to get about 33 miles per gallon.}}
