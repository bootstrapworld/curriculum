...
- Working in pairs or small groups, complete questions 1-4 of @printable-exercise{pages/exploring-mpg.adoc}.
...
Optional: For practice differentiating between quadratic and linear relationships, optional exercises are available for @opt-printable-exercises{classifying-tables.adoc, Tables}, @opt-printable-exercises{classifying-graphs.adoc, Graphs} and @opt-printable-exercises{classifying-defs.adoc, Definitions}.
