...
@teacher{Invite students to share any examples that they develop.}
...
[.lesson-instruction]
For more practice identifying quadratic v. linear situations, complete @printable-exercise{classifying-descriptions.adoc}
