...
But what if we only have a list of x-y pairs showing only one part of the parabola? **How can we identify quadratic relationships from a sequence of numbers?**
...
@vspace{1ex} +
**If the "size of the growth" is constant, the relationship is linear.**
