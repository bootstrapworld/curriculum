...
- In the Definitions Area, find the definition of `is-MA` underneath the comment `# Define some helper functions`
- With your partner, come up with an explanation of what you think this function does
- A few lines farther down, find the definitions of `MA-table`. What do you think is happening here?
