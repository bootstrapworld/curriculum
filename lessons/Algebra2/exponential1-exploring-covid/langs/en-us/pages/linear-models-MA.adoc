...
@link-instructions{
For this page, you'll need to have the @opt-starter-file{alg2-covid-ma} open on your computer. If you haven't already, select *Save a Copy* from the "File" menu to make a copy of the file that's just for you.
}
...
@n Change the definition of the `linear` function in the @opt-starter-file{alg2-covid-ma} to match the model produced by `lr-plot` and "Save".
