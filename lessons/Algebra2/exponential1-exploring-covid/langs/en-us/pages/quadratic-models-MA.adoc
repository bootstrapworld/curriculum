...
_For this section, open your copy of the @opt-starter-file{alg2-covid-ma}._
...
@n Return to @opt-starter-file{alg2-covid-ma} and update the definitions for `quadratic1`, `quadratic2`, and `quadratic3`. +
