...
@link-instructions{
For this section, you'll need to have *Slide 1: Quadratic Model for MA* of *Modeling Covid Spread - MA(Desmos)* open on your computer.
}
...
_For this section, open your copy of the @opt-starter-file{alg2-covid-new-england}._
...
@n Return to @opt-starter-file{alg2-covid-new-england} and update the definitions for `quadratic1`, `quadratic2`, and `quadratic3`. +
