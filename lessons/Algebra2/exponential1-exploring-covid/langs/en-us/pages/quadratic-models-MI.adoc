= Quadratic Models for Covid in Michigan
++++
<style>
...
html div#body.workbookpage table.graph td {
    padding: 0 !important;
    background-image: url(../images/ca28c918eb67dcc3.png);
    background-size: 2in 1.75in;
    max-height: 1.5in;
    min-height: 1.5in;
    background-position-x: -0.3in;
    background-position-y: 0;
    background-repeat: no-repeat;
}

.graph td::before, .graph td::after { content: '' !important; }
html div#body.workbookpage table.graph td p > .mathunicode:first-child { position: unset; }
td .fitb { --fitb-pitch: calc(0 + 1em); }
...
@link-instructions{
For this section, you'll need to have *Slide 1: Quadratic Model for MI of *Modeling Covid Spread (Desmos)* open on your computer.
}
...
_For this section, open your copy of the @starter-file{alg2-covid-mi}._

@n In the space below, define `quadratic1` to be the first model you fit in Desmos.

@ifsoln{Answers for eye-balled, best-guess models will vary. One of many options might be @math{a=5.3}, @math{h=60} and @math{k=0}, which you would get the following:}

`fun quadratic1(x): (` @fitbruby{10em}{@ifsoln{14}}{a} `* (sqr( x -` @fitbruby{10em}{@ifsoln{70}}{h} `))) +` @fitbruby{10em}{@ifsoln{0}}{k} `end`

@n Return to @starter-file{alg2-covid-mi} and update the definitions for `quadratic1`, `quadratic2`, and `quadratic3`. +
Then click "Run" to load your updated definition.

@n Use `fit-model` to determine the @math{S}-value of each model using the `MI-table`.
[.indentedpara]
...
@fitbruby{5em}{@ifsoln{22,109}}{S}@fitbruby{11em}{@ifsoln{positive COVID cases}}{units}.  I
...
@fitbruby{10em}{@ifsoln{positive cases}}{y-variable} in this dataset range from 
@fitbruby{9em}{@ifsoln{104156}}{lowest y-value} to @fitbruby{9em}{@ifsoln{341925}}{highest y-value}.
