...
@ifsoln{Answers for eye-balled, best-guess models will vary. One of many options might be @math{a=7.2}, @math{h=100} and @math{k=1000}, which you would get the following:}

`fun quadratic1(x): (` @fitbruby{10em}{@ifsoln{7.2}}{a} `* (sqr( x -` @fitbruby{10em}{@ifsoln{100}}{h} `))) +` @fitbruby{10em}{@ifsoln{1000}}{k} `end`
...
The vertex of the parabola drawn by this model is a @fitbruby{10em}{@ifsoln{minima}}{minima or maxima?} at about @fitbruby{8em}{@ifsoln{(100, 1000)}}{(x, y)}, which predicts that @fitb{}{}
@fitb{}{@ifsoln{the lowest number of cases would be 1,000 at day 100}} +
The error in the model is described by an @vocab{S-value} of about 
@fitbruby{5em}{@ifsoln{43,126}}{S}@fitbruby{11em}{@ifsoln{positive COVID cases}}{units}.  I
...
@fitbruby{9em}{@ifsoln{0}}{lowest y-value} to @fitbruby{9em}{@ifsoln{551,498}}{highest y-value}.
...
@blanklines{2}{
@ifsoln{*Answers will vary.* Sample Response: I don't love the idea that this model dips to have a minima 100 days in...what I'm observing is that it just keeps growing.}
}
