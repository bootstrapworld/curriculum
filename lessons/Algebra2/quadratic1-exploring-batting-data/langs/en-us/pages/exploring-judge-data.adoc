...
@link-instructions{
For this page, you'll need to open the @opt-starter-file{alg2-aaron-judge} on your computer. If you haven't already, select *Save a Copy* from the "File" menu to make a copy of the file that's just for you. *Read the comments at the top of the file*, which describe what each column in the dataset means.
}
...
- Based on the scatter plot, what distance would you predict for a ball hit at an angle of 60 degrees? @fitb{7em}{@ifsoln{about 175 feet}}
  ...
  * Why? @fitb{}{@ifsoln{as the hit angle increases to 60 degrees, the hit distance drops to between 150 and 200 ft.}}
- How confident are you in your prediction? @hspace{3em} _not at all_ @hspace{1em} 1 @hspace{3em} 2 @hspace{3em} 3 @hspace{3em} 4 @hspace{3em} 5 @hspace{1em} _very_
}
