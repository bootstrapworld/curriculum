...
@teacher{
@image{images/cabrera-pitchspeed-v-distance.png, 150}
@image{images/cabrera-pitchspeed-v-speed.png, 150}
@image{images/cabrera-angle-v-distance.png, 150}
@image{images/cabrera-angle-v-speed.png, 150}
}
