...
@QandA{
@right{@image{images/miguel-cabrera.jpg, 200}}Among Detroit Tigers fans, Miguel Cabrera is considered one of the greatest hitters in franchise history. He won the Hank Aaron award in 2012, and was the American League MVP in 2012 and 2013.
...
@lesson-instruction{
- Turn to @printable-exercise{what-shape-model-cabrera-slider.adoc}.
...
@lesson-instruction{
- Turn to the *Fitting Curves* section of @printable-exercise{what-shape-model-cabrera-slider.adoc}.
...
- For Yankees fans, @opt-printable-exercise{exploring-judge-data.adoc} and @opt-printable-exercise{what-shape-model-judge-curve.adoc} engage students in exploring the @opt-starter-file{alg2-aaron-judge}.
  * Thinking for this page parallels @printable-exercise{exploring-cabrera-data.adoc} and @printable-exercise{what-shape-model-cabrera-slider.adoc}.

@vspace{1ex}

- The @opt-printable-exercise{exploring-mpg.adoc} engages students in exploring the @opt-starter-file{alg2-fuel-efficiency}. 
  * Thinking for this page parallels @printable-exercise{exploring-cabrera-data.adoc}
