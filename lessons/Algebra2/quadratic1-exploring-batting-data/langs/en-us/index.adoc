...
@A{How big the fields are where the practice and play - in some stadiums (like Atlanta's Truist Park) a hit of 325 feet will make it past the outfield. Some stadiums have distances exceeding 400 feet to center field.}
}
...
- @opt-printable-exercise{exploring-mpg.adoc} engages students in exploring the @opt-starter-file{alg2-fuel-efficiency}. +
