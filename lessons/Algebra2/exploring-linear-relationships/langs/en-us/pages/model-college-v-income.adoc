...
@center{
 @math{f(x) =} @fitbruby{8em}{@ifsoln{@math{5613.67}}}{slope}x + @fitbruby{8em}{@ifsoln{-83613}}{y-intercept} @hspace{5em} @show{(code '(define (f x) (+ (* (?ANS 5613.67) x) (?ANS -83613))))}
}
...
**Evaluate @show{(code '(fit-model states-table "state" "college-or-higher" "median-income" f))} in the Interactions Area.**
