...
- Working in pairs or small groups, complete question 1 (Notice and Wonder) in @printable-exercise{exploring-states.adoc}.
...
[.lesson-instruction]
- Working in pairs or small groups, complete question 2 (making displays and suggesting possible relationships) in @printable-exercise{exploring-states.adoc}.
