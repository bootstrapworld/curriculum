...
Post sample questions around the room, all of which deal with (possibly) related factors affecting citizens, states, etc. You can use the sample questions below, or come up with your own.
...
Have students break into groups, with each group selecting one of these questions. Group discussions should be brief (3-5m). What do they think the answer is? What data would they need to collect in order to find out? Have student share their answers with the group.
...
Have students discuss their answers to the @printable-exercise{pages/identifying-form-matching.adoc}, then turn to their Notice and Wonder from @printable-exercise{exploring-states.adoc}.
...
[.lesson-instruction]
Complete questions 1-5 in @printable-exercise{model-college-v-income.adoc}.
...
[.lesson-instruction]
Complete the rest of @printable-exercise{model-college-v-income.adoc}.
