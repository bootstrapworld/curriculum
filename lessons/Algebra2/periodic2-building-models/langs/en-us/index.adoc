...
When it comes to fitting periodic models to data, can you out-model an AI?
...
@Q{Do you think that all sine models could be rewritten as cosine models, and vice versa?}
}
