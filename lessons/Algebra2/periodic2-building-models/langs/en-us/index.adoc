...
- When {nbsp}@math{h} < 0, the graph shifts to the left.
- When {nbsp}@math{h} > 0, the graph shifts to the right.
...
- When {nbsp}@math{k} < 0, the graph shifts down.
- When {nbsp}@math{k} > 0, the graph shifts up.
