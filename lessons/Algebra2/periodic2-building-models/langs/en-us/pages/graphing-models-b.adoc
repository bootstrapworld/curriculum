...
@n Leaving the other sliders where they best fit the data, change *ONLY* the slider for @math{P}, experimenting with values of @math{b} close to  @math{0.2},  @math{0.1},  @math{0.05},   and   @math{0.025}, graphing each curve below. +
