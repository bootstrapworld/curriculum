...
On this page, we'll explore the role of @vocab{frequency} @math{b} in periodic functions. @link-instructions{Open the Desmos File *Exploring Periodic Functions*. You should be on *Slide 2: Modeling the Ferris Wheel Dataset (sine)* and see four sliders for @math{a}, @math{b}, @math{h}, and @math{k}.}
