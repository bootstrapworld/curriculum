...
On this page, we'll explore the role of @vocab{frequency} @math{b} in periodic functions. @link-instructions{Open the Desmos File *Exploring Periodic Functions*. You should be on *Slide 2: Modeling the Ferris Wheel Dataset (sine)* and see four sliders for @math{a}, @math{P}, @math{h}, and @math{k}. Adjusting @math{P} also changes @math{b}, which is always @math{2\pi \div P}}
...
@n Leaving the other sliders where they best fit the data, change *ONLY* the slider for @math{P}, experimenting with values of @math{b} at  @math{0.2},  @math{0.1},  @math{0.05},   and   @math{0}, graphing each curve below. +
...
@n Approximately how many minutes long is the @vocab{period}
             when *@math{b ≈ 0.104}*?       @fitb{3em}{@ifsoln{@math{60}}}
@hspace{1em} when *@math{b ≈ 0.209}*?       @fitb{3em}{@ifsoln{@math{30}}}
@hspace{1em} When *@math{b ≈ 0.418}*?       @fitb{3em}{@ifsoln{@math{15}}}
