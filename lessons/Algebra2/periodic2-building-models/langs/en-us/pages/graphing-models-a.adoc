...
@n Change *ONLY* the slider for @math{a}, experimenting with values at 100, 50, -50, and 0, graphing each curve below. *For each curve, label the coordinates at time=15, 30, and 45.*
