...
@n Change the definition of @math{p} in Desmos to match row 1 below, and adjust the definition of @math{q} to match the new curve. Complete the second row by changing the definition of @math{p} and adjusting @math{q} again.
