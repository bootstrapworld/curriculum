 ...
 * Complete the first section using the @starter-file{alg2-countries}.
 * Complete the second and third section using slides 1 and 2 of the *Desmos* link I've shared with you. (The file should be called *Fitting Wealth-v-Health and Exploring Logarithmic Models*.)
}
...
@A{It starts out rising fast on the left, but growth slows as `pc-gdp` increases to the right.}
...
@QandA{
@Q{Of the three types of functions we fit, which one seems the closest?}
}
