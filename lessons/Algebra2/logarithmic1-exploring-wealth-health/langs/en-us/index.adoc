...
@lesson-instruction{
- Working in pairs or small groups, complete @printable-exercise{fitting-models.adoc}. You'll need: 
  * the @starter-file{alg2-countries} 
  * slides 1 and 2 of the *Desmos* link I've shared with you (*Fitting Wealth-v-Health and Exploring Logarithmic Models*)
}
