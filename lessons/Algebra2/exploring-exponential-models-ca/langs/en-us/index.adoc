...
@lesson-instruction{
Use the first slide of @starter-file{alg2-covid-desmos} to complete the second section ("vertical shift") of @printable-exercise{graphing-models.adoc}.
}
...
@lesson-instruction{
Use the first slide of @starter-file{alg2-covid-desmos} to complete the last section ("initial value") of @printable-exercise{graphing-models.adoc}.
}
...
- Use your saved @starter-file{alg2-covid} to complete the rest of the page.
