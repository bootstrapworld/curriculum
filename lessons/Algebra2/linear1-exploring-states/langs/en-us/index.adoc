...
== Exploring the Data @duration{45 minutes}
...
@A{Solicit student's ideas and discuss why each display type would or would not work.}
@A{A @vocab{scatter plot} displays the relationship between two quantitative variables!}
}
