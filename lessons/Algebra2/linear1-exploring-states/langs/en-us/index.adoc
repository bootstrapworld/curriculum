...
@lesson-prereqs{contracts-strings-images, fitting-models}

@keywords{}

@add-to-lang{pie-chart, bar-chart, box-plot, mean, median}
...
We ask questions like these to get students engaged with the data. What are some other ways to get students thinking about this data?

@teacher{
Solicit ideas from teachers! Maybe there's an inter-state rivalry to be referenced (e.g. Red Sox v. Yankees), or assumptions to be challenged (e.g. does Florida really have the most old people?), etc.
}
}
