...
If your students have strong feelings about what region your state is a part of and disagree with the way the dataset has categorized it, @link{mailto:contact@bootstrapworld.org, please let us know}!}
}
...
@A{strong, but not particulary interesting:
