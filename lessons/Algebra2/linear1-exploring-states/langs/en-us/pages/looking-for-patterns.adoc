...
Pyret allows us to generate many scatter plots, quite quickly! So let's have a look and see if we can find three more relationships that appear to be fairly strong. _Hint: If you're working in the Interactions Area of Pyret, you can hit the up arrow to bring back previously used lines of code._
