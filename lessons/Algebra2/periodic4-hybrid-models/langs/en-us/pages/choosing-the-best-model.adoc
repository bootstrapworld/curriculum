...
@n The four functions below are defined in the @starter-file{alg2-co2-hybrid}. Use `fit-model` to fit `periodic-cos` and `periodic-cos2` to the `recent-table` data. 
