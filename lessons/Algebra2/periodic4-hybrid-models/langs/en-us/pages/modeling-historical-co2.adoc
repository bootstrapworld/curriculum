...
@link-instructions{Make sure you've updated the @starter-file{alg2-co2-hybrid} so that `periodic-sin` matches what you found on @printable-exercise{periodic3-fitting-models/pages/modeling-recent-co2.adoc, Modeling Recent CO2 Levels}}.
