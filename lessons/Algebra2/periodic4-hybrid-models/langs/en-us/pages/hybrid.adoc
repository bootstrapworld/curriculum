...
@link-instructions{Open your copy of @starter-file{alg2-co2-hybrid} and click "Run".}
...
Both `sine` and `cosine` models are built to follow a _horizontal_ midline with the equation @math{f(x) = 419.87}.
...
@indented{_Hint: Like `sine-composed`, this function will use `wave-sin`. What will it use instead of `midline-sin`?_}
