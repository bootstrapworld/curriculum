...
Sally sells lemonade for $1.25/cup. Each cup costs here $0.20 in ice, lemons, sugar, and cups. Describe her `revenue`, `cost`, and `profit` as functions of glasses-sold.
