...
@ifslide{@teacher{Advance to the next slide to dicuss the profit function.}}
...
- The *periodic term* (@math{4.13 \times cos(\frac{6.28}{1}(x - 2023.35))}), which described the wave that wrapped around the horizontal midline
