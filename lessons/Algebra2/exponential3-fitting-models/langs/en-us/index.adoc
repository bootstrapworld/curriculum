...
- Turn to @printable-exercise{predicting-exponential-growth.adoc}. Using the exponential model you selected on @printable-exercise{exponential-models-ma}, fill in the blanks at the top of this page.
