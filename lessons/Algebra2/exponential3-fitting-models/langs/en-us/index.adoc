...
@lesson-instruction{
In the *first section* of @printable-exercise{predicting-exponential-growth.adoc}. Define `exponential` using the model settings from the best model you identified on @printable-exercise{exponential-models-MI.adoc}.
}
