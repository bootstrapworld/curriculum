...
@teacher{Make sure your students have a link to  @starter-file{alg2-covid-mi-desmos} and you've advanced your teacher dashboard of to the fourth slide ("Exponential Model for MA") so that students are looking at the correct screen.
...
@lesson-instruction{
- In @starter-file{alg2-covid-mi}, find the definition of a function called `exponential`. Why does this definition multiply `x` by `~1`?
