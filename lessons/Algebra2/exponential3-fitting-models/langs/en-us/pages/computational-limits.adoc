...
++++
@link-instructions{
Make sure you are working in your copy of the @starter-file{alg2-covid-mi}.
}
...
@n When do you think Pyret switches from Numbers to RoughNums approximations using `~`? @fitb{}{} +
