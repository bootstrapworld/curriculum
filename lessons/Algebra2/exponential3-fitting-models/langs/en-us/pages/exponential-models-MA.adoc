...
@link-instructions{
You'll need to have *Slide 4: Exponential Model for MA* of *Modeling Covid Spread - MA (Desmos)* open on your computer.
}
...
|===
| @image{../images/covid-scatterplot-MA.png, 175}
