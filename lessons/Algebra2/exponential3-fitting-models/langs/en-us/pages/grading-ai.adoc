...
@blanklines{5}{
@ifsoln{The AI got the initial value right, with @math{a=25}. But the horizontal shift is backwards! Instead of being shifted right by 100, the AI added @math{h} instead of subtracting it.
}
}
