...
@ifsoln{*Answers will vary.* If @math{a = 7000}, @math{b = 1.012} and @math{k = 0}, you would get the following:}
@center{
@math{\text{exponential}(x) = } @fitbruby{30em}{@ifsoln{@math{7000(1.012)^x + 0}}}{@math{a(b)^x + k}}
}
