...
Decide whether each table is best described by a linear, quadratic, or exponential model. *If you chose exponential:* What is the growth factor? Doubling (factor of 2)? Tripling (factor of 3)? Factor of 5? 10?
