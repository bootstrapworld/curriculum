...
The curve you'll see is the graph of @math{h(x) = 2^x}. Another curve @math{f(x)} is hiding behind it with identical model settings: @math{k=0}, @math{b=2} and @math{a=1}.
}
