...
@teacher{
Advance your teacher dashboard of @starter-file{alg2-covid-desmos} to the *Slide 2: How does h transform exponential functions?* and give your students a chance to reinforce their understanding of @math{h-values} from other models by connecting it to exponential functions.
}
