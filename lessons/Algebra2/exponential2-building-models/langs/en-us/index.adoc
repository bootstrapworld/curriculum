...
- Growth rate: @hspace{1em}@big{@math{-20%}} @hspace{1em} or @hspace{1em}@big{@math{-0.20}}

- Growth factor (also sometimes called the decay factor): @hspace{1em}@big{@math{1 +  -0.20 = .80}}
