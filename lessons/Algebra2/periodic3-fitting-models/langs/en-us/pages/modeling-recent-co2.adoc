...
@n Find the vertical distance between @fitbruby{7em}{@ifsoln{@lo}}{the lowest @vocab{valley}} and @fitbruby{7em}{@ifsoln{@hi}}{the highest @vocab{peak}}: @fitbruby{}{@ifsoln{@hi - @lo = @show{(* 2 a)} = @a}}{@COtwo in the atmosphere in parts per million}
