...
@n The amount of @COtwo varies from @fitbruby{7em}{@ifsoln{@lo}}{the lowest @vocab{valley}} to @fitbruby{7em}{@ifsoln{@hi}}{the highest @vocab{peak}}, a change of @fitbruby{18em}{@ifsoln{@hi - @lo = @show{(* 2 a)}}}{@COtwo in the atmosphere in parts per million}
...
@n Estimate the decimal year when the data *first* crosses the midline. This is called the @vocab{phase shift} (@math{h}). @fitbruby{9em}{@ifsoln{~@h}}{years}
