...
@lesson-instruction{
- Let's use these values to construct our `periodic` model, and fit it to our data in Pyret!
...
@Q{According the @vocab{S-value}, how well does your `periodic` model fit the data in the `recent-table`?}
