...
- What did you Notice? What do you Wonder?
** The _Synthesize_ section (below) outlines several of CODAP's features that students likely observed.
...
[.lesson-instruction]
--
- Complete @printable-exercise{pages/codap-apply-functions.adoc}.
--
