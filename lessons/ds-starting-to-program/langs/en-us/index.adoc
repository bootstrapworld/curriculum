...
=== Overview
Students have already learned how to display an imported spreadsheet in the Interactions Area. This lesson starts them programming, showing students how to make Pyret do simple math, work with text, and create simple computer graphics. It also draws attention to error messages, which are helpful when diagnosing mistakes.
