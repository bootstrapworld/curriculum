...
|===
| @centered-image{../images/right-50-100.png, Right 50 100}
| @fitb{30em}{@showsoln{(sexp->code '(right-triangle 50 100 "solid" "black")) }}

| @centered-image{../images/right-100-50.png, Right 100 50}
...
[cols="^.^8a, ^.^14a", stripes="none", grid="none", frame="none"]
|===
| @centered-image{../images/isosceles-100-30.png, Isosceles 100 30}
| @fitb{30em}{@showsoln{(sexp->code '(isosceles-triangle 100  30 "solid" "black")) }}

| @centered-image{../images/isosceles-100-130.png, Isosceles 100 130}
...
|===
|@centered-image{../images/right-isosceles.png, Right isosceles}
