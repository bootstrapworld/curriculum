...
| *@n* || *A*
| @centered-image{../images/sas-120-90-70.png, SAS 120 90 70}

| @show{(sexp->code '(triangle-sas 120 90 70 "solid" "black"))}
| *@n* || *B*
| @centered-image{../images/sas-120-135-70.png, SAS 120 135 70}

| @show{(sexp->code '(triangle-sas 120 135 70 "solid" "black"))}
| *@n* || *C*
| @centered-image{../images/sas-70-135-120.png, SAS 70 135 120}

| @show{(sexp->code '(triangle-sas 70 135 120 "solid" "black"))}
| *@n* || *D*
| @centered-image{../images/sas-120-45-70.png, SAS 120 45 70}
|===
