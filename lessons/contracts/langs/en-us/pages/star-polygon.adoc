...
|===
| @centered-image{../images/star-polygon-50-8-3-outline.png, an outlined 8-pointed polygon star}
| @fitb{}{@ifsoln{@show{(code '(star-polygon 50 8 3 "outline" "black"))}}}

| @centered-image{../images/star-polygon-50-8-2-solid.png, a solid 8-pointed polygon star}
