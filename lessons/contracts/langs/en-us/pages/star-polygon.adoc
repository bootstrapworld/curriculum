...
|===
| @centered-image{../images/star-polygon-50-8-3-outline.png, Star polygon 50 8 3 outline} 	| @span{.blankline}{}
| @centered-image{../images/star-polygon-50-8-2-solid.png, Star polygon 50 8 2 solid}		| @span{.blankline}{}
