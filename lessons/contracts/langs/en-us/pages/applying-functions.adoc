...
Can you spot the mistake?				@span{.right}{@fitb{60ex}{ @showsoln{"_There is a missing comma after solid_" }}}
...
Can you spot the mistake?				@span{.right}{@fitb{60ex}{ @showsoln{"_The color is undefined_" }}}
...
Can you spot the mistake?				@span{.right}{@fitb{60ex}{ @showsoln{"_There are two many numbers_" }}}
...
Can you spot the mistake? 				@span{.right}{@fitb{60ex}{ @showsoln{"_There shouldn't be a space between triangle and the parentheses_" }}}
}
...
Can you spot the mistake?				@span{.right}{@fitb{60ex}{ @showsoln{"_It's missing a color_" }}}
...
Can you spot the mistake?				@span{.right}{@fitb{60ex}{ @showsoln{"_The number should come first_" }}}
...
Can you spot the mistake?				@span{.right}{@fitb{60ex}{ @showsoln{"_There are too many numbers_" }}}
...
Can you spot the mistake?				@span{.right}{@fitb{60ex}{ @showsoln{"_*solid* is  missing quotes_" }}}
...
Can you spot the mistake?				@span{.right}{@fitb{60ex}{ @showsoln{"_*striped* is not an available option_" }}}
