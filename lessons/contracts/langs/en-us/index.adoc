...
@lesson-description{Students learn how to apply Functions in the programming environment and interpret the information contained in Contracts: Name, Domain and Range. Image-producing functions provide an engaging context for this exploration.}

@lesson-prereqs{simple-datatypes}
...
@ifproglang{wescheme}{@link{https://wescheme.org, WeScheme}}, open the editor and press "Run" to load the image library. Then type
...
(If needed, you can print a copy of these contracts pages for your students! A link to the PDF can be found on the Teacher Resources page for this pathway)
