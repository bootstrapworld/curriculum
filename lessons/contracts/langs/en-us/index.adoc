...
** _Too few / too many arguments given, missing parentheses, etc._
- How did you figure out what to do after seeing an error message?
** _I read the error message and thought about what the computer is trying to tell me, etc._
