...
@ifproglang{wescheme}{@link{https://www.wescheme.org, WeScheme}}, open the editor, @ifproglang{pyret}{type the words *include image* on Line 1 of the Definitions area (left side) and press "Run" to load the image library. Then} type
