...
@ifproglang{wescheme}{@link{https://wescheme.org, WeScheme}}, open the editor and press "Run" to load the image library. Then type @show{(sexp->code '(sqrt 16))} into the interactions area and hit Enter.
