...
Have students open the Scaling Exploration teachpack and investigate with their partner, using the workbook as a guide. @worksheet-link{pages/intro-to-dilations-wb1.adoc, Link to Workbook Page}
...
Students practice identifying scale factors and missing lengths.  The facilitator may choose to have students work together as a class, in partners, or individually.  Some sample problems are included on @worksheet-link{fragments/intro-to-dilations-ex1.adoc}.
