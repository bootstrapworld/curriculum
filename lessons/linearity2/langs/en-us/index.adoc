...
[.lesson-instruction]
- Compute how much y increases for each increase in x to identify the @vocab{slope}.
...
[.lesson-instruction]
How do we find the @vocab{slope} and @vocab{y-intercept} for this function, _without_ having to sort or extend the table?
...
[.lesson-instruction]
How many points do we need to draw a straight line?
...
* Are there other strategies could we have used to find the slope?
