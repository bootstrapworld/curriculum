...
@ifproglang{codap}{
* @link{https://docs.google.com/presentation/d/1-r7mOckg3eHfpu4HueXl4yHxdwJmrN5B1ZXm4pLul48/edit?usp=sharing}
...
@ifproglang{codap}{Students should open @link{https://codap.concord.org/app/static/dg/en/cert/index.html#shared=https%3A%2F%2Fcfm-shared.concord.org%2FcB4wG0wo1lWCI77dtj9C%2Ffile.json, Animals Dataset - Full population}.}
...
@ifproglang{codap}{@centered-image{images/sampler-plugin-default.PNG,"" ,250}}
