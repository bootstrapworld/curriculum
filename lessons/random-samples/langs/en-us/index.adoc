...
There's more to taking a good sample than just taking a _big_ sample. Suppose you want to take a survey of people's faiths in your neighborhood. There's a temple right down the street, so we could get a nice big sample by asking everyone there!
