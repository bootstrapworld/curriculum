...
[.lesson-point]
p-value: the likelyhood that a pattern is found in a sample, when no such pattern exists in the population

Statisticians would use more formal language to describe this highly unlikely, "one in a million chance". They call it the *p-value*, and use a decimal to represent the chance.

[options="header"]
|===
| Most people say...					| Statisticians say...
| "There's a one-in-10 chance of this!"	| "The p-value is 0.1"
| "There's a one-in-100 chance of this!"| "The p-value is 0.01"
| "There's a two-in-100 chance of this!"| "The p-value is 0.02"
