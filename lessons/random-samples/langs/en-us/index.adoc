...
@lesson-description{Students learn how to define random samples in @ifproglang{pyret}{Pyret} @ifproglang{codap}{CODAP} and are introduced to statistical inference and the role of sample size.}
