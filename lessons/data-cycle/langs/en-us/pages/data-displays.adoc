...
Fill in the tables below, then look up the Contract for that display  and record the code you need to make it in Pyret. If time allows, try typing it in to see your display! _The first column has been filled in for you._
