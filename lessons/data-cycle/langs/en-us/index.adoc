...
=== Investigate
[.lesson-instruction]
Have students complete ...TBD - cart sort activity?...
...
- *Arithmetic questions* -- These can be answered by computing an answer across a single column. Examples of computing questions might be “how much does the heaviest animal weigh?” or “What is the average age of animals from the shelter?”

- *Statistical questions* -- These questions are where things get interesting, because the answer is never just a single number or row. If we asked "how old are animals at the shelter", there are lots of ways to answer: we could report back the average age, or the age that shows up most frequently. Examples of statistical questions might be "how long does it take for an animal to get adopted?" or "What's a typical age for the cats?". And some statistical questions deal with _relationships between *two* columns_: “Do cats tend to be adopted faster than dogs?” or “Are older animals heavier than young ones?”
...
- If our question is "who is the heaviest animal?", what rows do we need? What column(s)? _We need to compare every row, and we only look at the `pounds` column_
