...
@objective{Explain the difference between Categorical and Quantitative data}
@objective{Identify whether a variable in a dataset is Categorical or Quantitative}
@ifproglang{pyret}{
