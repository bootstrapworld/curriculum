...
@learning-objective{Explain the difference between Categorical and Quantitative data}
@learning-objective{Identify whether a variable in a dataset is Categorical or Quantitative}
@ifproglang{pyret}{
@learning-objective{Identify the Header Row and Identifier Column of a Table}}
