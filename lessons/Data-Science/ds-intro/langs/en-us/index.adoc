...
This pedagogy is a @dist-link{pages/notice-wonder.pdf, widely-used best practice in Math-Ed}, and is used throughout this course.
...
@lesson-instruction{
- Turn to @printable-exercise{questions-and-column-descriptions.adoc}. What do you __Notice__ about this dataset? Write down your observations in the first column.
