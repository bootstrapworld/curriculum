...
* You may want to make copies of the @dist-link{courses/data-science/back-matter/pages/animals-dataset.adoc, Animals Table} if you aren't working with a printed workbook. @ifpathway{If you are working with a printed workbook, the table is included in the back of the book.}
...
=== Launch
@lesson-instruction{
Open the @starter-file{animals-spreadsheet} in a browser tab, or turn to the @dist-link{courses/data-science/back-matter/pages/animals-dataset.adoc, Animals Table}. @ifpathway{If you are working with a printed workbook, the table is included in the back of the book.}
}
