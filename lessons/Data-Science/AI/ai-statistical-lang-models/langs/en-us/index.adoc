...
@lesson-instruction{
- Complete @printable-exercise{construct-model.adoc}.
}
...
- Tip: You will be able to work more efficiently if you open the handout on a computer and use "Control-F" on a PC or "Command-F" on a Mac to help you locate and count words.
...
@A{Yes. When considering which word to generate next, there was always one word that was clearly the most probable.}
...
@QandA{
@Q{What four-word phrase did you generate?}
@{The class should be split between "The spider that catch"}
