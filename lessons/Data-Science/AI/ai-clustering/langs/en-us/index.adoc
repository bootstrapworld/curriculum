...
The alien wants to find some structure among the data, and wonders if Earthlings have socio-politicaal structures organized by general proximity.
...
@lesson-instruction{
- Open @starter-file{alien-data} and click "Run".
