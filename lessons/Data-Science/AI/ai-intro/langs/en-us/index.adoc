...
An example of ML would be the particular algorithm that determines the angle of the steering wheel on a self-driving car. Combine with that algorithm with the technology that allows the car to detect people, read signs, and assess road conditions and you have an example of AI.
