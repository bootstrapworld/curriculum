...
@teacher{For the questions and prompts below, you can guide students verbally and via class discussion. If you'd prefer, another option is to print and distribute @printable-exercise{count-bar-pie.adoc}. Part A of this page includes the same questions and prompts along with space for stuents to record their responses.}
...
@teacher{Part B of @printable-exercise{count-bar-pie.adoc} corresponds with the questions and prompts below.}
