...
@learning-objective{Read and create pie and bar charts}
@learning-objective{Explain the difference between pie and bar charts}
@learning-objective{Read and create stacked and multi bar charts}
@learning-objective{Explain the difference between pie and bar charts}
