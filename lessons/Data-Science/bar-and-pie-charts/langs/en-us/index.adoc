...
@optional{Complete @opt-printable-exercise{data-cycle-categorical.adoc}.}

@teacher{Note: This page is a preview of @lesson-link{data-cycle}, which we will discuss in depth in a dedicated lesson and revisit throughout this course.} 
