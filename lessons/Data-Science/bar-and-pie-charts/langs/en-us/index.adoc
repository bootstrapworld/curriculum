...
When you click "Run", the @opt-starter-file{bar-and-pie-chart-survey-starter} builds a side-by-side `count` frequency table, `bar-chart` and `pie-chart` comparison. 
