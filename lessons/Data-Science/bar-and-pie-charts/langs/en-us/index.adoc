...
@teacher{For the questions and prompts below, you can guide students verbally and via class discussion. If you'd prefer, another option is to print and distribute @opt-printable-exercise{count-bar-pie.adoc}. Part A of this page includes the same questions and prompts along with space for students to record their responses.}
...
@teacher{Part B & C of @opt-printable-exercise{count-bar-pie.adoc} correspond with the questions and prompts below.}
