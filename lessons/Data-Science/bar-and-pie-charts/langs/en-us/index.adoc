...
In this situation, we want to use the values in the __first__ column for the labels of our pie slices or bars, and the values in the _second_ column for the size. We have contracts for those, too:
