...
Decide what data you want your students to work with. 

- Option 1: Have students build bar or pie charts in Pyret from @starter-file{food} or any of the @link{https://www.bootstrapworld.org/materials/fall2023/en-us/lessons/choosing-your-dataset/pages/datasets-and-starter-files.html, data sets in our library}.

- Option 2: Assign students the task of finding a pie or bar chart on the internet about a topic of interest to them to use as a starting point.

- Option 3: Have students build a pie or bar chart in google sheets based on a summary statistic they find about an issue that is of interest to them and then use the same statistic as the basis of their infographic.

- Option 4: Create a list of ratio statements from stats you gather about issues you believe will interest your students and have them each select a statement from the list to use in making a bar or pie chart and a corresponding infographic.

== Student Task

Your goal is to present an infographic alongside the bar or pie chart that inspired it.
