...
Use the Data Cycle to explore the distribution of one or more categorical columns using *bar-chart*, *pie-chart*, *stacked-bar-chart* or *multi-bar-chart* and write down your findings.
