...
[.FillVerticalSpace, cols="^.^2a,^.^2a,^.^2a", frame="none", grid="none", shading="none"]
|===
...
[.FillVerticalSpace, cols="^.^2a,^.^2a", frame="none", grid="none"]
|===
...
@opt{If time permits, have students complete @opt-printable-exercise{pages/identifying-form-matching.adoc} and/or the @opt-starter-file{correlations} card sort.}
...
@ifnotslide{
@lesson-instruction{Complete @printable-exercise{pages/reflection-correlations.adoc} with your partner and be ready to discuss your thinking with the class.
}
}

@ifslide{
Discuss the following questions with your partner and record your thinking on @printable-exercise{pages/reflection-correlations.adoc}
...
=== Investigate
@lesson-instruction{
- Complete @printable-exercise{pages/identifying-form-open-ended.adoc}. 
