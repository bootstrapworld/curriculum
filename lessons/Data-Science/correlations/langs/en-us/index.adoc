...
- Why is a problem for society, that people confuse correlation and causation?
...
- Investigate these correlations. If you're using a printed workbook, you'll find some blank Design Recipes at the back, just before the Contracts.
