...
@ifnotslide{
@lesson-instruction{Complete @printable-exercise{reflection-correlations.adoc} with your partner and be ready to discuss your thinking with the class.
}
}

@ifslide{
Discuss the following questions with your partner and record your thinking on @printable-exercise{reflection-correlations.adoc}
