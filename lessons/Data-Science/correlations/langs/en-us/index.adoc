...
@objective{Confirm if a scatter plot appears linear}
@objective{Understand how correlation assesses direction in a linear relationship}
@objective{Understand how correlation measures strength in a linear relationship}
