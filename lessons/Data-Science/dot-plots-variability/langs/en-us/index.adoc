...
@A{Greater variability usually results in a wider spread, while decreased variability results in a more narrow spread. Datasets with low variability generally have a lot of repetition, whereas datasets with high variability have little repetition.}
