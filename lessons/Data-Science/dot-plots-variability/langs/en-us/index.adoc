...
We can also characterize a dataset by thinking about its @vocab{variability}, how different or alike the data points are. We can even consider the variability of categorical data!
