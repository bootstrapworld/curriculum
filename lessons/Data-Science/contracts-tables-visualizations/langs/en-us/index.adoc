...
@add-to-lang{sort, first-n-rows, count, bar-chart, pie-chart, histogram, box-plot, scatter-plot, lr-plot, line-graph, overlay, translate, above, rotate, scale}
...
== Functions for Making Data Visualizations
