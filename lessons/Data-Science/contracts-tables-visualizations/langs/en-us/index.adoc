...
@lesson-instruction{
Complete the second section of @printable-exercise{functions-for-tables.adoc}: *Summarizing a Column using `count`*.
}
...
@lesson-instruction{
Let's explore some more table functions, by completing the first two sections of @printable-exercise{functions-for-tables-cont.adoc}.
}
...
- Before moving on to the second question, be sure you've translated you Circle of Evaluation into code and tested it out in @starter-file{animals}.
}
