...
@n What is the frequency of animals with 4 legs? @fitb{}{@ifsoln{29}}
...
@n These tables are called @vocab{Frequency Tables}, which are used often in the real world. Give two examples of where you've seen them before:
