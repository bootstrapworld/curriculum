...
These lines (that we see the point clouds clustering around) are known as @vocab{models} for the data. The straight-line function describing a linear relationship is called a _linear model_.
...
- We have no way of knowing whether or not @vocab{S-values} represent a small or large amount of error until we consider them in relation to the range of the dataset! _(e.g. errors of $20,000 are huge in the context of average teacher salary, but small in the context of national budgets.)_
--
