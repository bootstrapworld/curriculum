...
These models were built using data about 
...
@fitbruby{8em}{@ifsoln{lizards}}{what?} in the dataset are disproportionately
@fitbruby{23em}{@ifsoln{fixed and/or female}}{columns with uneven distribution}.
