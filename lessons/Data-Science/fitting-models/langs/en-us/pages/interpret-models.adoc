...
@fitbruby{5em}{@ifsoln{weeks}}{y-units} and that, +
...
@fitbruby{8em}{@ifsoln{weeks}}{units}, which is
@fitbruby{18em}{@ifsoln{extreme}}{insignificant, moderate, significant, extreme} considering that
@fitbruby{10em}{@ifsoln{weeks}}{y-variable} in this dataset range from
...
@fitbruby{8em}{@ifsoln{weeks}}{units}, which is
@fitbruby{18em}{@ifsoln{significant}}{insignificant, moderate, significant, extreme} considering that
@fitbruby{10em}{@ifsoln{weeks}}{y-variable} in this dataset range from
@fitbruby{7em}{@ifsoln{2}}{lowest y-value} to
@fitbruby{7em}{@ifsoln{8}}{highest y-value}.
...
@fitbruby{5em}{}{S}
@fitbruby{8em}{@ifsoln{weeks}}{units}, which is
@fitbruby{18em}{}{insignificant, moderate, significant, extreme} considering that
@fitbruby{10em}{@ifsoln{weeks}}{y-variable} in this dataset range from
@fitbruby{7em}{@ifsoln{2}}{lowest y-value} to
@fitbruby{7em}{@ifsoln{8}}{highest y-value}.
