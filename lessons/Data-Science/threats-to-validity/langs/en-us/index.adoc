...
- On @printable-exercise{fake-news.adoc}, you’ll find some deliberately misleading claims made by slimy Data Scientists. 
  * Why shouldn't these claims be trusted?
- Once you’ve finished, consider your own dataset and analysis: 
   * Turn to @printable-exercise{lies-darned-lies-n-statistics.adoc} and come up with four misleading claims based on data or displays from your work.
...
- Can anyone think of a time in your life where you spotted a statistic being misused?
- As you move through the world over the next several weeks, keep your eyes peeled for misused statistics and bring the examples you find to class to share!
