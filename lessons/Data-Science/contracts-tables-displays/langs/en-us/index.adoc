...
++++
<style>
.circle2 .expression .expression { background: lightblue; }

.circle3 .expression { background: lightgreen; }
.circle3 .expression .expression { background: white; }
.circle3 .expression .expression .expression { background: lightblue; }
</style>
++++
