...
@learning-objective{sort & count columns of data in the programming environment}
@learning-objective{make pie charts, bar charts, histograms and box plots in Pyret}
@learning-objective{understand how to read contracts for any Pyret function}
