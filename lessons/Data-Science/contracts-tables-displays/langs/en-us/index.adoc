...
@indented{If we want to see the ten youngest animals, our diagram would look like this.}
...
@indented{If we wanted to get extra fancy and see the species count for the youngest ten animals, we could add another layer to our Circle of Evaluation.}
...
@indented{This diagram would translate to the code that follows. @show{(coe exp1)}} 
