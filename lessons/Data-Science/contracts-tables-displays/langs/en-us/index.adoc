...
@teacher{
For older students who already know about these plots (or who just want to explore more of what's available!), there is @printable-exercise{exploring-displays-2.adoc, a similar page} that covers scatter plots, linear regression plots, and line graphs!
}
