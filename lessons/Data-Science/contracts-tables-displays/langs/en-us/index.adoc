...
++++
<style>
/* all circle borders should be red, except....*/
.circleevalsexp .expression { border-color: red; }

/* top-level circles should be black */
.circleevalsexp > .expression { border-color: black; }

/* for circles tagged with class "middle-blue", make the second expression blue */
.middle-blue .circleevalsexp > .expression > .expression { border-color: blue; }
