...
__Values like Numbers, Strings, and Booleans are still written by themselves. It’s only when we want to use a function that we need to draw a Circle.__
...
@ifslide{
@do{
(define expB '(first-n-rows animals-table 5))
}
