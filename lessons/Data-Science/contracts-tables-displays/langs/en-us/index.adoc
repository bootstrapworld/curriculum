...
- Then work to complete @printable-exercise{exploring-displays.adoc}, generating each of the other 3 visualizations. Some of them may be new to you - you are not expected to be an expert in them yet, but you should be able to figure out how to use the Contract to get them building!
}
...
@opt{For more practice making tables and visualizations by composing functions, have students complete @opt-printable-exercise{coe-displays-2.adoc}}
