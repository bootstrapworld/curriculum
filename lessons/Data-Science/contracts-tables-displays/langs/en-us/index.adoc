...
The goal here is for students to become familiar with __using__ @dist-link{Contracts.shtml, Contracts} to write expressions that will produce displays. Knowing how to _make_ a histogram doesn't mean a student really understands histograms! 
