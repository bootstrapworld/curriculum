...
__The following lines of code are all BUGGY! Read the code and the error messages below, and see if you can catch the mistake WITHOUT typing the code into @proglang.__
