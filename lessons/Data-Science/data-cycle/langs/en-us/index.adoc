...
@learning-objective{Articulate the parts of the Data Cycle}
@learning-objective{Tell the difference between Lookup, Arithmetic, and Statistical questions}
@learning-objective{Come up with their own examples of Lookup, Arithmetic, and Statistical questions}
