...
_"We wanted to know if more animals at the shelter were fixed on unfixed. To answer this, we counted how many were fixed and how many were unfixed. We found that more animals were fixed (18) than unfixed (14). This made us wonder if that proportion was the same for all species, or all ages - or whether fixed animals got adopted faster than unfixed ones."_
