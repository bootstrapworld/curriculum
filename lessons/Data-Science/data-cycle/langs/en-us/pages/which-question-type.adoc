...
- **Statistical** - Best asked with "in general" attached, because the answer isn't black and white. If we ask "are dogs heavier than cats?", we know that not every dog is heavier than every cat! We just want to know if it is __generally true__ or __generally false__!
- **Can't Answer** with the data in the table.
