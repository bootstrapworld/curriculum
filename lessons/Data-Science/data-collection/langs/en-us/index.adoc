...
@objectives
@objective{Identify different data-hygiene problems that can mess up analysis}
@objective{Use response validation in Google Forms}
@objective{Import data from a Google Sheet into Pyret}
