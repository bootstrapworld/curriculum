...
@learning-objective{Identify different data-hygiene problems that can mess up analysis}
@learning-objective{Use response validation in Google Forms}
@learning-objective{Import data from a Google Sheet into Pyret}
