...
@n How many cats are represented in this sample? @fitb{3em}{@ifsoln{10}}
...
@n There are N=10 distances. What is N-1? @fitb{4em}{@ifsoln{9}} @hspace{2em} Divide the sum by _N-1_. What do you get? @fitb{}{@ifsoln{6}}
