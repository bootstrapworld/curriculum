...
@n What is the mean age of the cats in this histogram? @fitb{}{@ifsoln{8.5}}
...
| squared distance 	 |10.1 |10.1 |10.1 |10.1 | 4.8 | 4.8 | 1.4 | 0.7 | 7.9 | 7.9 |139.7
|===
}

@vspace{1ex}

@n Add all the squared distances. What is their sum? @fitb{3em}{@ifsoln{340}}

@n Divide the sum by _N-1_. What do you get? @fitb{}{@ifsoln{34}}

@n Take the square root to find the *standard deviation*! @fitb{}{@ifsoln{~5.83}}
