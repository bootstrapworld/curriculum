...
| squared distance 	 |10.2 |10.2 |10.2 |10.2 | 4.8 | 4.8 | 1.4 | 0.7 | 7.8 | 7.8 | 139.2
|===
}

@vspace{1ex}

@n Add all the squared distances. What is their sum? @fitb{3em}{@ifsoln{207.2}}

@n Divide the sum by _N-1_. What do you get? @fitb{}{@ifsoln{20.72}}

@n Take the square root to find the *standard deviation*! @fitb{}{@ifsoln{~4.55}}
