...
Should we suspect a scam if the stranger’s coin flipped heads 10 times in a row? The probability of a fair coin getting all heads for 10 flips in a row is @math{{\frac{1}{2}}^{10}}, or roughly 0.001.
