...
@objectives
@objective{Understand the connection between probability and inference}
@objective{Understand the need for random samples}
@objective{Understand the role of sample size}
@objective{Take random samples from a population}
