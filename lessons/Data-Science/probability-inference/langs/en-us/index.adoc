...
@learning-objective{Understand the connection between probability and inference}
@learning-objective{Understand the need for random samples}
@learning-objective{Understand the role of @vocab{sample size}}
@learning-objective{Take random samples from a population}
