...
- Let's complete question 4 together and label the clusters, gaps, outliers, and peaks on the dot plot in the first section of @printable-exercise{interpret-dot-plots.adoc}.
** There is a peak at 4.
** There is a cluster from 3 to 6.
** There are gaps at 7 and 10.
** There is an outlier at 12.
- Let's discuss question 5: What do those peaks, clusters, gaps, and outliers tell us about the dataset?
- With your partner, respond to question 6, describing what you can conclude about students' name lengths in Group B.
}

@teacher{
Discuss and review students' responses to question 6. Students will complete the final section of @printable-exercise{interpret-dot-plots.adoc} after a brief class discussion on typicality.}
...
[.FirstTable, cols="^.^8a,^.^1,^.^8a", frame="none", grid="none"]
|===
