...
| Relevant Resources
|
- @link{https://www.scientificamerican.com/article/racial-bias-found-in-a-major-health-care-risk-algorithm/, Racial Bias in Algorithms used to determine Medical Care}
