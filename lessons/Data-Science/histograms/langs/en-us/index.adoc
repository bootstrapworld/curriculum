...
@objectives
@objective{create histograms using the Animals Dataset}
@objective{create visualizations of frequency using their chosen dataset, and write up their findings}
