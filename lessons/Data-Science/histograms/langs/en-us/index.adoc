...
Want to check student mastery of the content you've just taught? Administer @starter-file{histograms-check1-desmos} (Desmos) to get a snapshot of your students' current level of mastery.  Make sure you have created a link or code for your class to the assessment.
...
Want to check student mastery of the content you've just taught? Administer @starter-file{histograms-check2-desmos} (Desmos) to get a snapshot of your students' current level of mastery. Make sure you have created a link or code for your class to the assessment.
