...
[.lesson-instruction]
* Open your saved Animals Starter File, or @starter-file{animals, make a new copy}, and turn to @opt-printable-exercise{choosing-bin-size.adoc}.
@pathway-only{
* Find the contract for the `histogram` function in your @pathway-link{resources/pages/contracts.pdf, Contracts pages}.
}
