...
Students will apply what they have learned about histograms to the dataset they chose from our @lesson-link{choosing-your-dataset/pages/datasets-and-starter-files.adoc, "List of Datasets"} in the @lesson-link{choosing-your-dataset} lesson and add two items to their @starter-file{exploration-project}:

. at least two histograms 
. any interesting questions that emerge
