...
[.lesson-instruction]
* **OPTIONAL:** instead of reviewing through the items below as a class discussion, students can complete @opt-printable-exercise{choosing-bin-size.adoc, this guided worksheet} individually or in small groups.
