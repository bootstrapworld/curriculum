...
|
@preparation{
- There is an interactive Desmos activity in the lesson. 
  * Open @starter-file{histograms} and make a code or link to share with students.  
...
Want to check student mastery of the content you've just taught? Administer @starter-file{histograms-check1-desmos} (Desmos) to get a snapshot of your students' current level of mastery.  Make sure you have created a link or code for your class to @starter-file{histograms-check2-desmos}.
...
Want to check student mastery of the content you've just taught? Administer @starter-file{histograms-check2-desmos} (Desmos) to get a snapshot of your students' current level of mastery. Make sure you have created a link or code for your class to @starter-file{histograms-check2-desmos}.}




Alternatively, we offer a compilation of both Checkpoints in @starter-file{histograms-cumulative-desmos} (Desmos).
}
