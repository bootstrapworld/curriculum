...
@A{Because a bar chart visualizations categorical data, we can rearrange the bars in any order we wish. Because the quantitative data of a histogram must follow a natural order, bars cannot be rearranged.}
...
You may need to help students locate the “Histogram” slide in the "Making Visualizations" section. They will need to duplicate the slide to add their second display. The “My Questions” section is at the end of the slide deck._
