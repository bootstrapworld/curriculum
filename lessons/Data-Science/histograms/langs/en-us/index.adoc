...
Want to check student mastery of the content you've just taught? Administer @starter-file{histograms-check1-desmos} (Desmos) to get a snapshot of your students' current level of mastery.
...
Want to check student mastery of the content you've just taught? Administer @starter-file{histograms-check2-desmos} (Desmos) to get a snapshot of your students' current level of mastery.
