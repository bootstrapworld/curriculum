...
- There’s no strict numerical way to order these bars. 
  ...
  * But *sometimes there’s one order that makes sense than the others*. For example, it would be logical to show the number of t-shirt sizes in order of smallest to largest shirt.
