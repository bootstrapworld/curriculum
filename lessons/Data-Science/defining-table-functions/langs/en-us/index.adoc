...
- Complete the Design Recipe Telephone @opt-printable-exercise{dr-telephone-wrap-1.adoc, Wrap Up for Set 1} __(or__@opt-printable-exercise{dr-telephone-wrap-2.adoc,__Set 2})__,using the Circles of Evaluation to diagram how you would combine the functions to build the display.
- Then test out the expression you come up with in @proglang and record what you learn from the display.
@star @opt-printable-exercise{dr-telephone-wrap-3.adoc} uses helper functions from both DR Telephone sets!
}
}
