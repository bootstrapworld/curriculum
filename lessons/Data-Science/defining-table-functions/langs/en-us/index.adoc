...
- For students using a printed workbook, you'll find a page with @opt-printable-exercise{pages/2-blank-recipes.adoc, two blank Design Recipes}, as well as pages with @opt-printable-exercise{pages/data-cycle-1.adoc, blank data cycles} to support you in writing table functions.
