...
=== Overview
Primary: Students use different representations of functions to define functions that consume _Rows_.
...
- For students using a printed workbook, you'll find a page with @opt-printable-exercise{pages/2-blank-recipes.adoc, two blank Design Recipes}.
