...
|@center{__everyone folds over the previous section, and passes their paper to the right__}
_
| **Round 2 - Writing Examples __based solely on the Contract and Purpose Statement__**
[cols="1a,1a,1a"]
!===
...
|  **Round 3 - Writing Function Definitions __based solely on the Examples__**
[cols="1a,1a,1a"]
!===
...
@lesson-instruction{
Once your group has completed the three Design Recipes:

- Add your new functions to the @starter-file{row-functions}. 
- Complete the Design Recipe Telephone @printable-exercise{dr-telephone-wrap-1.adoc, Wrap Up for Set 1} __(or__@opt-printable-exercise{dr-telephone-wrap-2.adoc,_Set 2_} __)__,using the Circles of Evaluation to diagram how you would combine the functions to build the display.
- Then test out the expression you come up with in @proglang and record what you learn from the display.
}
