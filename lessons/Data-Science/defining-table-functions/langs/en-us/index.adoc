...
@learning-objective{write functions that consume a Row and perform a _lookup_ to produce a column}
@learning-objective{write functions that consume a Row and _compute_ to produce an Image}
@learning-objective{write functions that consume a Row and _compute_ to produce a Boolean}
