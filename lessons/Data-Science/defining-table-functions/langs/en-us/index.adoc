...
- Unfold the page and type the full Design Recipe into the Definitons Area of the @starter-file{animals}.
- If your function is a Boolean-producing function, make sure that at least one of the exampes should produce true and at least one should produce false. If not, add an additional example.
- Click run and confirm that all test pass.
