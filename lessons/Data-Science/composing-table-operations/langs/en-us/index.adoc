...
@objectives
@objective{Compose table operations to conduct more sophisticated analyses.}
@objective{Diagram their composition to make sense of the order of operations}
@objective{Find bugs when table operations are not composed in the correct order}
