...
@teacher{
Want to check student mastery of the content you've just taught? Administer @assessment{histograms-check-1, Histograms: Visualizing Shape Formative Assessment 1} to get a snapshot of your students' current level of mastery. Make sure you have created a link or code for your class to the assessment.

Alternatively, we offer a compilation of both Checkpoints in @assessment{histograms-cumulative, Histograms: Visualizing Shape Cumulative Assessment}.
}
...
@teacher{
- Want to check student mastery of the content you've just taught? Administer @assessment{histograms-check-2, Histograms: Visualizing Shape Formative Assessment 2}.
- Alternatively, we offer a compilation of both Checkpoints in @assessment{histograms-cumulative, Histograms: Visualizing Shape Cumulative Assessment}.
}
