...
@teacher{
Want to check student mastery of the content you've just taught? Administer @assessment{histograms-cumulative, Show What You Know: Histograms, Visualizing Shape}.
}
