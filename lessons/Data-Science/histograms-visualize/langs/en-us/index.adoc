...
@lesson-instruction{
- Turn to the first section of @printable-exercise{making-histograms.adoc} and use the data providedto complete the frequency table and corresponding data visualization.
