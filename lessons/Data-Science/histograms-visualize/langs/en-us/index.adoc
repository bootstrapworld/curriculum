...
We have already discussed how histograms are similar and different to dot plots: both display the frequency and distribution of quantitative data--but histograms give us a collective overview of the data, while dot plots allow us to see individual points.
