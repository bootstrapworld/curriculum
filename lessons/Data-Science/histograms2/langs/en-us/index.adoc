...
@lesson-prereqs{histograms, ds-intro}
...
- It’s just as likely for a newborn baby old to be a certain number of inches below @vocab{average} weight as it is to be that number of inches above average weight.
- At most restaurants, the busiest dinner time is around 7pm, when most people go out to eat. But there are always a few people who want to eat earlier or later.
