...
- It’s just as likely for a newborn baby to be a certain number of inches below @vocab{average} weight as it is to be that number of inches above average weight.
