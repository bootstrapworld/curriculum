...
| Assessments
| 
- Decide whether or not you want to use our custom-built assessment tools for this lesson. If so, follow the instructions on @dist-link{pages/how-to-use-assessments.adoc}, which will explain how to administer:
@assessments
|===
...
@teacher{
Want to check student mastery of the content you've just taught? Administer @assessment{checkpoint-1, Show What You Know: Linear Regression - Checkpoint 1} to get a snapshot of your students' current level of mastery.  Make sure you have created a link or code for your class to the assessment.
...
@teacher{
Want to check student mastery of the content you've just taught? Administer @assessment{checkpoint-2, Show What You Know: Linear Regression - Checkpoint 2} to get a snapshot of your students' current level of mastery.  Make sure you have created a link or code for your class to the assessment.
...
@teacher{
Want to check student mastery of the content you've just taught? Administer @assessment{checkpoint-3, Show What You Know: Linear Regression - Checkpoint 3} to get a snapshot of your students' current level of mastery. Make sure you have created a link or code for your class to the assessment.

Alternatively, we offer a compilation of all three Checkpoints in @assessment{cumulative, Show What You Know: Linear Regression}.
}
