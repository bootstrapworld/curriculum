...
@ifsoln{@image{../images/box-plot.png, 130}}
|
...
@blanklines{3}{
@ifsoln{About the spread and distribution of the data.}
}
...
@ifsoln{@image{../images/scatter-plot-pounds-weeks.png, 130}}
|
[cols="1a", stripes="none", frame="none"]
!===
...
@ifsoln{@image{../images/lr-plot-pounds-age.png}}
|
[cols="1a", stripes="none", frame="none"]
!===
