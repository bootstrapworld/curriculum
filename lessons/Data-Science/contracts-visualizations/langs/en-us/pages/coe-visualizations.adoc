...
<<<<<<< HEAD:lessons/Data-Science/contracts-visualizations/langs/en-us/pages/coe-visualizations.adoc
@scrub{**NOTE: THE SOLUTION VERSION OF THIS PAGE IS IN THE SOLUTION PAGES FOLDER - IT HAS AN EXTRA COLUMN IN THE TABLE**}
