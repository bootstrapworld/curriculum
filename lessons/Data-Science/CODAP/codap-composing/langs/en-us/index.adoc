...
@learning-objective{Compose Transformers to create more sophisticated analyses}
@learning-objective{Diagram their composition to make sense of the order of operations}
@learning-objective{Find bugs when Transformers are not composed in the correct order}
