...
The folks at the shelter need help completing a variety of tasks! To help them, you will need an understanding of two basic data types, @vocab{Numbers} - a data type representing real numbers, and @vocab{Strings} - a data type for any sequence of characters between quotation marks.

[.lesson-instruction]
--
- Open the @starter-file{animals}.
- Complete @printable-exercise{strings-numbers.adoc} and @printable-exercise{strings-numbers2.adoc}.
- What did you Notice? What do you Wonder?
