...
++++
<style>
div#body.workbookpage .autonum { padding-top: 0.5em; }
div#body.workbookpage { --blank-height: calc(0.7em + 1em); }
</style>
++++
...
@n Do keyboard shortcuts for Undo (`Ctrl-Z` on PC, `Cmd-Z` on Mac) work in CODAP? @fitb{10em}{@ifsoln{Yes}}
...
[.data-table,cols=">.^7a,^.^3a,1,^.^1a,.^10a", stripes="none", grid="none", frame="none"]
|===
