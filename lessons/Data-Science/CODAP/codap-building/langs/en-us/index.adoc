...
@learning-objective{filter the Animals Dataset by species, fixed status, and age}
@learning-objective{transform a column in the Animals Dataset}
@learning-objective{add a column to the Animals Dataset}
