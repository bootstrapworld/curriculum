...
[.lesson-instruction]
- Turn to @printable-exercise{booleans-with-filter.adoc}.
...
[.lesson-instruction]
- On the second section of @printable-exercise{booleans-with-filter.adoc}, predict whether the Boolean is `true` or `false`.
