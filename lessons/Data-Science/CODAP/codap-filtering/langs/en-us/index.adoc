...
- Optional: Get extra practice @opt-printable{writing-purpose-statements-filter.adoc}.
- Optional: On @opt-printable{writing-examples.adoc}, provide some sample rows from the original dataset and then show what the transformed table would look when given Purpose Statement.
