...
- Students may also start feeling overwhelmed as they create and manipulate data and visualizations. Encourage students to appropriately name charts and tables and to keep their CODAP workspace as organized as possible.
