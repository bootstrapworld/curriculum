...
@learning-objective{Use Booleans to filter a dataset}
@learning-objective{Identify examples of Booleans and recognize what makes them unique}
@learning-objective{Write Purpose Statements and expressions to be used in Transformers}
