...
@n Create, save, and apply a Transformer called `filter-is-old` that creates a new dataset with animals older than 5 years.
  ...
  * How many rows does the resulting table have?@fitb{}{@ifsoln{There are 9 rows. Note: The Purpose Statement should say, "Checks the row to see if age is greater than 5."}}
