...
@n A boxplot, using `Pounds` as the x-axis, for all the animals from the shelter. _Note: The `Measure` menu has lots of options! On this page, we've included the two options that *create new visualizations*._
...
@ifsoln{
The visualization shows us the relationship between animals' age and weight.
@vspace{5ex}
...
The visualization shows us the relationship between animals' weight and weeks to adoption.
@vspace{5ex}
