...
Use the @starter-file{animals} to create the following displays in CODAP. First, fill in the blanks and check all boxes that apply. Next, create the display in CODAP. Finally, sketch the display and answer the questions.
