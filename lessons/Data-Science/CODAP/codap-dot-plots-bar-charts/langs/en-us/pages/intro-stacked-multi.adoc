...
Sometimes we want to compare _sub-groups across groups_. In this example, we want to compare the distribution of sexes across each species. Fortunately, CODAP allows us to build a variety of displays where we specify both a group and a subgroup.
