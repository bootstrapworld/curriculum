...
@learning-objective{Read and generate dot plots and bar charts from the Animals Dataset.}
@learning-objective{Recognize that we create data visualizations based on the _type_ of data we're working with - categorical or numeric, one variable or two.}
