...
This activity focuses on describing the spread of a box plot.
...
@lesson-instruction{
- With your partner, sort the cards into two piles: box plots that are roughly symmetrical, and box plots that are not roughly symmetrical.
...
@lesson-instruction{
- With your partner, complete the second section of @printable-exercise{sorting-boxplots.adoc}.
}
