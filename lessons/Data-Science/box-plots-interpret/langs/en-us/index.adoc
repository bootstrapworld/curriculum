...
@teacher{
Want to check student mastery of the content you've just taught? Administer @assessment{box-plots-interpreting-spread, Show What You Know: Box Plots - Interpreting Spread}.
}
