...
@teacher{
Want to check student mastery of the content you've just taught? Administer @assessment{box-plots-interpret, Show What You Know: Box Plots - Interpreting Spread}.
}
