...
.comparison * { font-size: 0.75em !important; }
...
@center{@image{images/age-v-weeks-species-image.png,500}}
...
@ifslide{@center{@image{images/age-v-weeks-species-image.png}}
}
...
@center{@image{images/age-bc.png, 500}}}
}
...
@center{@image{images/species-tag.png, 500}}
...
By using @vocab{row accessors} to extract these values from their dataset, students can make custom scatter plots where each data point is represented by a shape whose color indicates something about the data!
