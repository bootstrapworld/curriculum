...
@blanklines{2}{
@ifsoln{It draws a scatter plot, but in place of each dot is a new image. The image is determined by whatever the function produces for each Row.}
}
...
Can you draw any conclusions about animals that are both _young_ and _lightweight_?

@blanklines{2}{
@ifsoln{The animals that are both young and lightweight seem to be adopted relatively quickly. There do not appear to be outliers to this trend; that is, there are no young and lightweight animals that take more than 10 weeks to adopt.}
}
