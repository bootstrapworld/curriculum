...
(define sol3 '(dot-plot (random-rows animals-table 20) "species" "weeks"))
(define sol4 '(box-plot (filter (filter animals-table is-cat) is-young) "pounds"))
(define sol5 '(scatter-plot (random-rows animals-table 25) "species" "age" "weeks"))
}
...
@n A `scatter-plot` of a 25 random animals using `species` as the labels, `age` as the x-axis, and `weeks` as the y-axis.
[.FillVerticalSpace, cols="^.^1,^.^1,^.^1",options="header"]
|===
| What Rows?			| Which Column(s)?			| What will you Create?
|@ifsoln{25 random rows}| @ifsoln{species, age, weeks}| @ifsoln{scatter-plot}
|===
