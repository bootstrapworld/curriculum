...
=== Investigate
@lesson-instruction{
- Use the @starter-file{animals} to complete @printable-exercise{data-displays2.adoc}. Apply what you've learned about samples to make more sophisticated data visualizations.
