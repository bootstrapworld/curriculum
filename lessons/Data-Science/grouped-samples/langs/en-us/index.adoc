...
- @opt-printable-exercise{design-recipe-helper-funs.adoc, For students who want to create Grouped Samples of another dataset...} (For those using printed workbooks, a few of these can be found at the back.)}
