...
@learning-objective{consider explanatory and response roles of variables}
@learning-objective{make scatter plots by hand, given a list of (x,y) pairs}
@learning-objective{make scatter plots using @proglang.}
@learning-objective{identify a possible linear relationship by looking at a point cloud.}
@learning-objective{Consider unusual observations in a scatter plot.}
