...
There is an important difference, however, in that **line graphs are typically used when the x-axis measures _time_**. Only in this situation can it be appropriate to "connect the dots", because they represent the __rise__ and __fall__ of a measure over time. Without time, there's no notion of "slope"!
...
A 5-year-old tarantula is still really young, while a 5-year-old rabbit is fully grown. With differences like this, it doesn’t make sense to put them all on the same scatter plot. By mixing them together, we may be __hiding__ a real relationship, or creating the illusion of a relationship that isn’t really there!
