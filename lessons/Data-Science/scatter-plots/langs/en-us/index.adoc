...
- Make a scatter plot that visualizes the relationship between `age` and adoption time (`weeks`).
}
...
@teacher{
You may need to help students locate the “Scatter plot” slide in the "Making Visualizations" section. They will need to duplicate the slide to add their second display. The “My Questions” section is at the end of the slide deck.
}
