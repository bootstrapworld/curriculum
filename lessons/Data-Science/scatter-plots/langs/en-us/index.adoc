...
@objective{consider explanatory and response roles of variables}
@objective{make scatter plots by hand, given a list of (x,y) pairs}
@objective{make scatter plots using @proglang.}
@objective{identify a possible linear relationship by looking at a point cloud.}
@objective{Consider unusual observations in a scatter plot.}
