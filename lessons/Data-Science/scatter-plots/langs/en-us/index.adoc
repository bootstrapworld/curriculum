...
== Optional: Your Own Analysis @duration{flexible}

=== Overview
Students who are exploring their own data apply what they've learned to their own dataset.
...
== Exploration Project (Scatter Plots) @duration{flexible}
...
- Choose two quantitative columns from your data set whose relationship you are interested in exploring in a scatter plot and another column that might make sense to use as labels for your points!
...
** _You may need to help students locate the “Scatter plot” slide in the "Making Displays" section. The “My Questions” section is at the end of the slide deck._
...
Did they discover the relationships they investigated to be stronger or weaker than they expected?

What questions did the scatter plots inspire them to ask about their dataset?

What, if any, outliers did they discover when making scatter plots?
