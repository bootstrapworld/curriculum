...
[.linkInstructions]##Open the @starter-file{animals}.## Use the Data Cycle to search for relationships between columns. __The first cycle has a question to get you started. What question will you ask for the second?__
