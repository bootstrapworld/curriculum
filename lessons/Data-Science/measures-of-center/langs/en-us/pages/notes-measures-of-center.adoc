...
- When a dataset contains a small number of values, the mode may be the most descriptive measure of center. (Note that a small number of __values__ is not the same as a small number of __data points__!)
