...
__If you have a set of rulers, divide the class into groups of three such that every group has a ruler. Give each group 4-8 pennies and make sure every group has at least one pen or pencil.__
...
** _No, the mean is less than 41 pounds._
