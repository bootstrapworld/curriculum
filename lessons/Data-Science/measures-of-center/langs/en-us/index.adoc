...
@QandA{
@Q{Compute the mean, median, and mode(s) for these datasets: +
{nbsp} Dataset A: {nbsp} 17, 23, 24, 23, 22 +
{nbsp} Dataset B: {nbsp} 5, 5, 9, 9, 3, 29 +
{nbsp} Dataset C: {nbsp} 8, 34, 15, 4, 76
}
@A{A - mean: 22; median: 23; mode: 23.} 
@A{B - mean: 10; median: 7; modes: 5, 9.}
@A{C - mean: 27.4; median: 15; mode: none}
