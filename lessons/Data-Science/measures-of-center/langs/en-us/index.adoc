...
- Decide whether or not the first section of this lesson (an introduction to measures of center) is appropriate for your class. 
  * Want to get a sense of what your students already know before you decide? Looking for a do now to get the juices flowing before skipping ahead? Use our online assessment: @assessment{mean-median-modes-checkin}
...
@teacher{By the end of this section, students should be able to answer the questions on @printable-exercise{mean-median-modes.adoc}, which are the same as @assessment{mean-median-modes-checkin}. Engage your students with this section at whatever speed and level of depth you deem appropriate for them or skip to the next if you're confident they already know how to compute measures of center.}
...
@A{The ruler is balanced when the marker is at 7 inches. To balance the ruler, the total distance of the pennies _below_ the balance point must add up to the distance of the penny above the balance point.}
...
@teacher{
Want to check student mastery of the content you've just taught? Administer @assessment{measures-of-center}.
}
