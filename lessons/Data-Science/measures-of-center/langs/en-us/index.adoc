...
@opt{Complete the Mean section of @opt-printable-exercise{pages/mean-median-modes.adoc}, which has 5 problems including the one listed above.
}
...
@opt{Turn to the Median section of @opt-printable-exercise{pages/mean-median-modes.adoc}, which has space to complete these problems and three others.}
...
@opt{Have students complete these problems along with two others on the Mode(s) section of @opt-printable-exercise{pages/mean-median-modes.adoc}.
}
}
