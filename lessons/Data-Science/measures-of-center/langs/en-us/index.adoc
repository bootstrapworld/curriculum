...
- Decide whether or not the first section of this lesson (an introduction to measures of center) is appropriate for your class. 
  * Want to get a sense of what your students already know before you decide? Looking for a do now to get the juices flowing before skipping ahead?
  *** Bootstrap Digital Checkin: @scrub{@assessment{mean-median-modes-checkin}} 
  *** Paper and Pencil Option of the same thing: @printable-exercise{mean-median-modes.adoc}
...
@teacher{By the end of this section, students should be able to answer the questions on this mean, median modes checkin (paper and pencil version or bootstrap digital checkin).  Engage your students with this section at whatever speed and level of depth you deem appropriate for them.}
