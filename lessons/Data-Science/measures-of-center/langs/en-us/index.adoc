...
== Exploration Project (Measures of Center) @duration{flexible}

=== Overview

Students apply what they have learned about measures of center to their chosen dataset. In their @starter-file{exploration-paper}, they will complete the first four rows of the "Measures of Center and Spread" table. They will also interpret those measures of center, and record any interesting questions that emerge. To learn more about the sequence and scope of the Exploration Project, visit @lesson-link{project-exploration-paper}.

=== Launch

Let’s review what we have learned about computing and interpreting three measures of center - mean, median, and mode.

[.lesson-instruction]
- Describe how to compute mean, median, and mode.
...
- When is @vocab{mode} a useful way to summarize a dataset?
** _Mode is very useful when a dataset has very few values._
...
- Use Pyret to compute the mean, median and mode.
...
- Locate the "Measures of Center" section of your Exploration Project. Type in the mean, median and mode that you just identified.
- Now, add your interpretation of the measures of center and record any questions that emerged.
...
Which measures of center do they think were the most useful for their two chosen quantitative columns?

What questions did the measures of center inspire them to ask about their dataset?

When students compared their findings with those of their classmates, did they make any interesting discoveries? (For instance: Did everyone find a mode or modes? Did anyone have a measure of center that was dramatically influenced by an outlier?)
