...
- When are @vocab{modes} a useful way to summarize a dataset?
** _Modes are very useful when a dataset has very few unique values._
...
- Use Pyret to compute the mean, median and modes.

Invite students to discuss their results and consider how to interpret them.

[.lesson-instruction]
- *It’s time to add to your @starter-file{exploration-project}.*
- Locate the "Measures of Center" section of your Exploration Project. Type in the mean, median and mode(s) that you just identified.
