...
- Decide whether or not the first section of this lesson (an introduction to measures of center) is appropiate for your class. 
...
@teacher{If you know that your students do not know how to compute mean, median, and mode, you can skip the first question, below.}
