...
- The first section of the lesson is an introduction to measures of center. If you are confident that your students have a solid understanding of mean, median, and mode, you can jump to the second section of the lesson, where students will use compute measures of center in @proglang, and then consider which measure of center is the most appropriate.
...
== Introduction to Measures of Center @duration{15 minutes}
...
@teacher{Using the prompt below, invite your students to share what they know about mean, median, and mode. If your students need to review these concepts, continue to teach the entirety of this lesson section to provide instruction and practice. If your students are confident with computing mean, median, and mode, skip to the next section of the lesson, where students will (1) use Pyret to compute various measures of center and (2) begin considering the usefulness of each measure of center.}


In our work with dot plots and histograms, we often asked ourselves, "What is a typical value in this sample?"

When we posed this question, we often discovered that different students in our class had a different responses!

- Some of you looked for the value that was most commonly repeated.
- Some of you looked for the midpoint of the sample.
- Some of you searched for an appropriate "balance point" among the data points.
...
To compute the mean of any dataset, we use add up all of the values, and then divide by the number of values in the dataset. This algorithm reveals to us our balance point, without the pennies, the ruler, or the trial and error!
...
- Complete @printable-exercise{summarizing-columns-moc.adoc}, using @proglang to compute and record all three measures of center for the `pounds` column.
- Once you have completed the table, respond to the remaining questions using the information you have recorded on the table.
}

@teacher{Question 3 requires students to _apply_ their knowledge of mean and median, which can be quite difficult. (Research by Groth and Bergner (2006) suggests that oftentimes, students understanding of center does not extend beyond algorithms.) Invite students to think back to what they know about histograms and histogram shape. Challenge them to think deeply. Students will continue to consider shape in relationship to measures of center in the next section of the lesson.}
...
Consider how many policies or laws are informed by statistics! Knowing about measures of center helps us see through misleading statements.
...
@A{1. Students may mistakenly attempt to find the midpoint of the values on the horizontal axis, indicating that they connect median and “middle”, but misunderstand _what_ middle value to find. All of the raw data is available in the histogram.
}
...
@teacher{The question above is inspired by one developed for research conducted by Cooper and Shore (2008). In their work, the authors conclude that students often cannot compute measures of center from histograms because they lack attention to the context of the data. When students are confused, the authors recommend intervening by simply asking, "What are the data?" to help reorient. Urge students to discuss and defend their responses. Encourage discussion of any errors made.}
