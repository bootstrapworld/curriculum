...
- Decide whether or not the first section of this lesson (an introduction to measures of center) is appropriate for your class. 
  * Want to get a sense of what your students already know before you decide? Use our online assessment: @assessment{mean-median-modes-checkin, Show What You Know: Mean, Median, Modes Checkin}} 
  * Looking for a do now to get the juices flowing before skipping ahead?
