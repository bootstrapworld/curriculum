...
@learning-objective{Students explore the concept of center of a distribution, learning how to compute the mean, median and mode(s) of a dataset}
@learning-objective{Students find the mean, median and mode(s) of various columns in the Animals table}
