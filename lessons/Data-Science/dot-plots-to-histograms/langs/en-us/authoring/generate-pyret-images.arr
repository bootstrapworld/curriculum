...
dog-pounds-chart = render-chart(from-list.histogram(dogs.column("pounds")).bin-width(20))
  .x-axis("pounds")
  .y-axis("frequency")
dot-pounds-small-chart = render-chart(from-list.num-dot-chart(dogs-small.column("pounds"))).width(500).height(160)
dot-weeks-small-chart = render-chart(from-list.num-dot-chart(dogs-small.column("weeks"))).width(400).height(150)
...
I.save-image(dot-pounds-small-chart.get-image(), '../images/dot-plot-pounds-AUTOGEN.png')
I.save-image(dot-weeks-small-chart.get-image(), '../images/dot-plot-weeks-AUTOGEN.png')