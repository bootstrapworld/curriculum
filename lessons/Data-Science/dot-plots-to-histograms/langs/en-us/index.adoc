...
@hspace{4em}1. __Followed the_ @dist-link{pages/live-pyret-survey-instructions.adoc, Instructions to Set up and Link the Files} +
@hspace{4em}2. __Shared the *link you made to your class' copy* of the_ @opt-starter-file{histogram-survey-form}
