...
@teacher{
Want to check student mastery of the content you've just taught? Administer @assessment{dot-plots-to-histograms, Show What You Know: From Dot Plots to Histograms}.
}