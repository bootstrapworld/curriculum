...
@hspace{3em}_Assuming you've already_...

@hspace{4em}1. _Followed the_ @dist-link{pages/live-pyret-survey-instructions.adoc, Instructions to Set up and Link the Files} +
@hspace{4em}2. __Shared the *link you made to your class' copy* of the__ @opt-starter-file{histogram-survey-form}

@hspace{3em} _The data visualizations will be generated using data from your students!_ +
@hspace{3em} _And they will continue to update in real time as more of your students complete the Google Form._
