...
@learning-objective{define functions that consume rows and produce meaningful images}
@learning-objective{use helper functions to define custom pie and bar-charts, histograms, and scatter plots}
