...
@n On the three lines below, write the code that uses the `circle` function to draw a solid, blue circle whose radius is the _age of the animal_. HINT: you may need to look up the contract for `circle` in your  @pathway-link{resources/pages/contracts.pdf, Contracts pages}!
