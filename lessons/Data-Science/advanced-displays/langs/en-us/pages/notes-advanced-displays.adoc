...
- A school bus is a machine. It comes with a stereo, which could be swapped out for a new one with more features. Each stereo is a machine. And the bus needs one of them in order to play music over the speakers.
