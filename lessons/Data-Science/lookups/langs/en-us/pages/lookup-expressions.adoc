...
Make sure you've opened your *saved copy* of the @starter-file{row-functions}, in which you've defined the sample Rows from @printable-exercise{defining-rows.adoc}, such as `lizard-row`, `old-row`, etc.
