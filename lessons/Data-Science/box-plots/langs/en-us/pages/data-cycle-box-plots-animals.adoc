...
[.linkInstructions]##Open the @starter-file{animals}.## Use the Data Cycle to explore the distribution of one or more quantitative columns using *box plots*, and write down your findings.
