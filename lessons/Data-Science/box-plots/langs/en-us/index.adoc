...
== Exploration Project (Box Plots) @duration{flexible}

=== Overview
Students apply what they have learned about box plots to their chosen dataset. They will add three items to their @starter-file{exploration-paper}: (1) at least two box plots, (2) the corresponding five-number summaries, and (3) any interesting questions they develop. To learn more about the sequence and scope of the Exploration Project, visit @lesson-link{project-exploration-paper}.
...
Confirm that all students have created and understand how to interpret their box plots. Once you are confident that all students have made adequate progress, invite them to access their @starter-file{exploration-paper} from Google Drive.

[.lesson-instruction]
- *It’s time to add to your @starter-file{exploration-paper}.*
- Copy/paste at least two box plots *and* their corresponding five-number summaries. Be sure to also add any interesting questions that you developed while making and thinking about box plots.
** _You may need to help students locate the “Box Plots” section and the “Measures of Center and Spread” section. The “What Questions Do You Have?” page is at the end of the template._
...
What questions did the box plots inspire them to ask about their dataset?

What, if any, outliers did they discover when making box plots?

When students compared their your findings with those of their classmates, did they make any interesting discoveries? (For instance: Did everyone find outliers? Was there more or less similarity than expected?)
