...
- Find the @vocab{median} by splitting the data in half.
- Split the population into four equal-sized quarters (by splitting each of these halves in half) and identify the @vocab{quartiles} (boundary points between these equal quarters).
