...
@add-to-lang{box-plot, modified-box-plot, box-plot-scaled, vert-box-plot, modified-vert-box-plot, modified-vert-box-plot-scaled}
...
If you're comparing two box plots and want them to be on number lines that are scaled the same, use one of our scaled box plot functions:
...
We also have functions to make vertically oriented box plots:
