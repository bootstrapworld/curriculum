...
@A{Box plot A represents the same data as histogram C. Box plot B represents the same data as histogram D. BLAH BLAH BLAH}


[cols="^.^1a,^.^1a", header="none"]
|===
