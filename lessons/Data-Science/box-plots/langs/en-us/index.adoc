...
_Note: Even Distribution can also be correctly described as Symmetric! But, students should be encouraged to use more specific language for describing things when it's available to them._
