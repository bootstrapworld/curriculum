...
=== Investigate
@lesson-instruction{
- Use what you've learned about how box plots and histograms visualize data differently to complete @printable-exercise{matching-boxplots-to-histograms.adoc}.
...
@QandA{
@Q{Does a box plot visualize categorical or quantitative data? How many columns of data does a box plot display?}
@A{Box plots visualize a single column of quantitative data.}
