...
@QandA{
@Q{Which numbers from this dataset fall in the middle 50% of the dataset?}
@A{3, 5, 6, 7}
@Q{What is the @vocab{Interquartile Range}(@vocab{IQR}) of this dataset?}
@A{5 because Q3 - Q1 is 7.5 - 2.5}
}
