...
@learning-objective{apply one approach to measuring and displaying spread of a dataset}
@learning-objective{compare and contrast information displayed in a box plot and a histogram}
...
- There are Desmos formative assessments at the end of each lesson section.
  * Open the assessment you plan to administer (@starter-file{box-plots-check1-desmos}, @starter-file{box-plots-check2-desmos}, etc) and make a code or link to share with students.
...
Want to check student mastery of the content you've just taught? Administer @starter-file{box-plots-check1-desmos} to get a snapshot of your students' current level of mastery.  Make sure you have created a link or code for your class to the assessment.
...
Want to check student mastery of the content you've just taught? Administer @starter-file{box-plots-check2-desmos} to get a snapshot of your students' current level of mastery.  Make sure you have created a link or code for your class to the assessment.
...
Want to check student mastery of the content you've just taught? Administer @starter-file{box-plots-check3-desmos} to get a snapshot of your students' current level of mastery.  Make sure you have created a link or code for your class to the assessment.
...
Want to check student mastery of the content you've just taught? Administer @starter-file{box-plots-check4-desmos} to get a snapshot of your students' current level of mastery. Make sure you have created a link or code for your class to the assessment.

Alternatively, we offer a compilation of all four Checkpoints in @starter-file{box-plots-cumulative-desmos}.
}
