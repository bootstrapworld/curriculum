...
Want to check student mastery of the content you've just taught? Administer @starter-file{box-plots-check1-desmos} (Desmos) to get a snapshot of your students' current level of mastery.  Make sure you have created a link or code for your class to the assessment.
...
Want to check student mastery of the content you've just taught? Administer @starter-file{box-plots-check2-desmos} (Desmos) to get a snapshot of your students' current level of mastery.  Make sure you have created a link or code for your class to the assessment.
...
Want to check student mastery of the content you've just taught? Administer @starter-file{box-plots-check3-desmos} (Desmos) to get a snapshot of your students' current level of mastery.  Make sure you have created a link or code for your class to the assessment.
...
Want to check student mastery of the content you've just taught? Administer @starter-file{box-plots-check4-desmos} (Desmos) to get a snapshot of your students' current level of mastery. Make sure you have created a link or code for your class to the assessment.

Alternatively, we offer a compilation of all four Checkpoints in @starter-file{box-plots-cumulative-desmos} (Desmos).
}
