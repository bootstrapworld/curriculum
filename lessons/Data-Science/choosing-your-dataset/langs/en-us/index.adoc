...
Today we will begin working on the @starter-file{exploration-project}, which will prepare students for writing their @starter-file{research-paper}. We will return to this in upcoming lessons. We are just going to work on the first section for now.

[.lesson-instruction]
- Make a copy of @starter-file{exploration-project}, and open the starter file for your dataset.
- Complete the first set of questions in the exploration project.
