...
Gerrymandering::
  ...
  link:https://code.pyret.org/editor#share=1n7r_EhustILkf7YT_Fb4bds9VPTAlkmhStarter File, window="_blank"]
...
State Demographics::
  ...
  link:https://code.pyret.org/editor#share=16apte0f_KxAgSkMQLstbVHyvy6LD3V2A[Starter File, window="_blank"]
U.S. Income::
