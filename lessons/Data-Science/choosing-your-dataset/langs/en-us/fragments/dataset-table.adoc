...
Gerrymandering::
  ...
  link:https://code.pyret.org/editor#share=18nW4KadW2iZe68IojGksMGkd6C_VLU%5F-[Starter File, window="_blank"]
...
International Exhibition of Modern Art::
  ...
  link:https://code.pyret.org/editor#share=1QvVfimE8Ki20nAz8pqV%2D%2DsRgaltWUw4%5F[Starter File, window="_blank"]
