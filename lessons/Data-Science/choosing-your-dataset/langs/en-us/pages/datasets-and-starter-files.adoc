...
Click through the datasets below. __(Your teacher might also ask you to work with Global Food Supply @ifproglang{pyret}{@opt-starter-file{food-sheet, [Dataset\]}} @opt-starter-file{food, [Starter File\]}.)__ When you find one you'd like to use in Pyret, (1) click the "Starter File" link to open it in a new tab and (2) select "Save a copy" from the "File" menu.
