...
@Q{Make up two categorical datasets with five items, each. One dataset must have high variability, and the other must have low variability. Exchange datasets with a partner and discuss your strategy for determining the variability of each dataset.}

@Q{Make up two quantitative datasets with ten quantities, each. One dataset must have high variability, and the other must have low variability. Exchange datasets with a partner and discuss your strategy determining the variability of each dataset.}
...
== Creating Dot Plots to Judge Variability
...
@lesson-instruction{
- With a partner, complete questions 1-6 on @printable-exercise{variability-of-dot-plots.adoc}.
}
...
@lesson-instruction{
- Open the @starter-file{expanded-animals-sub-pops}, which you will need to complete question 7 on @printable-exercise{animal-weight-variability.adoc}.
- Make each dot plot, and then respond to the prompts on the table.
