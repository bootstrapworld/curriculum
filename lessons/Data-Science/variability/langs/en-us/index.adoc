...
@lesson-instruction{
Complete @printable-exercise{variability-two-ways.adoc}. Then we'll discuss as a class.
}
...
@Q{Do you agree or disagree that student in our class generally have the same number of letters in our first name?
}
