...
@fitb{}{@ifsoln{`dot-plot(months-table, "name", "months")`}}


@star Make a scatter plot of fixed dogs, comparing age to pounds using the "sticker" as the label!

@fitb{}{@ifsoln{`scatter-plot(filter(dogs, is-fixed), "name", "age", "pounds")`}}
