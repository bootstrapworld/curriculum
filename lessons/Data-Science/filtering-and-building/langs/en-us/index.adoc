...
@learning-objective{filter tables according to different criteria, using helper functions}
@learning-objective{add a column to a table using helper functions}
