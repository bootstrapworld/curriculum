...
* _Optional:_ Complete @opt-printable-exercise{design-recipe-1.adoc} and @opt-printable-exercise{design-recipe-2.adoc} to practice using the Design Recipe to write filter functions for the @starter-file{animals}.
