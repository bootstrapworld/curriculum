...
@teacher{@opt{Give students some practice filtering and building using the @opt-starter-file{putting-it-all-together}! +
Here are some options:

- Practice using the Design Recipe to write new helper functions on @opt-printable-exercise{design-recipe-1.adoc} and @opt-printable-exercise{design-recipe-2.adoc}.
- Practice using @opt-printable-exercise{coe-table-old-cats.adoc}, @opt-printable-exercise{coe-box-plot-young-dog-kilos.adoc, a Box Plot}, or @opt-printable-exercise{coe-scatterplot-old-dogs.adoc, a Scatter Plot}.
- @opt-printable-exercise{putting-it-all-together.adoc, A collection of prompts} with less scaffolding to practice defining new tables, defining new helper functions, and building displays.
}}
