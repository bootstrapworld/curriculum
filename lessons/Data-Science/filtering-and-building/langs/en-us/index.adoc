...
@Q{What is the relationship between a _row definition_ and a _row-consuming function_?}
@A{We often uses _row definitions_ when writing examples for _row-consuming functions._}
}
