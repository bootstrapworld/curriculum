...
@slidebreak
@center{@image{images/shape-sketches.png}}

@QandA{
@Q{Which of scenario describes a right skew: adult teeth or women's ages at childbirth? Explain.}
...
@A{Sketch C, above, describes a left skew.}
...
@A{Sketch B, above, describes a right skew.}
}
