...
@teacher{
For the activity below, you can either (1) direct students to use one of the blank copies of the Data Cycle in the back of their workbook or (2) print copies of @printable-exercise{data-cycle-quantitative.adoc} for students to use.
}
