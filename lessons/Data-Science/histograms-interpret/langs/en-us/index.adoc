...
@teacher{
Want to check student mastery of the content you've just taught? Administer @assessment{histograms-interpret, Show What You Know: Histograms - Interpreting Shape}.
}
