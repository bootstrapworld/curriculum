...
| Preparation
|
- There is an activity during this lesson that requires flip chart paper, tape, and markers.
- Before class, tape flip chart paper to the walls of your classroom--one poster per team of three students.
...
- Note that when the lesson is over, you will want to save students' chart papers for use during @lesson-link{box-plots}.
...
Below are two reasonable sketches; remember that these data visualizations need not be precise.

[cols="^.^1a,^.^1a"]
|===
| @image{images/women-ages-histo.png} woman's age at child birth
| @image{images/num-teeth.png} number of teeth
|===
}
...
@teacher{
Want to check student mastery of the content you've just taught? Administer @assessment{histograms-interpret}.
}
...
@teacher{Reminder: Students have the opportunity to choose a dataset that interests them from our @lesson-link{choosing-your-dataset/pages/datasets-and-starter-files.adoc, "List of Datasets"} in the @lesson-link{choosing-your-dataset} lesson. If you'd prefer to focus your class on a single dataset, we recommend the @opt-starter-file{food}.
}

@lesson-instruction{
- Open your chosen dataset starter file in @proglang.
- Choose one quantitative column from your dataset that you will represent with a histogram.
...
@teacher{
For the activity below, you can direct students to use: 

- one of the blank copies of the Data Cycle in the back of their workbook 
- @printable-exercise{data-cycle-quantitative.adoc} 
- print copies of @opt-printable-exercise{data-cycle-food-shape.adoc} if your class is working with the @opt-starter-file{food}
}
