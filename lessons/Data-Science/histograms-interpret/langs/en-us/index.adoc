...
Note: Both the problems on @printable-exercise{histograms-moc-1.adoc} and in the Launch are drawn from / inspired by research conducted by @citation{cooper-shore-2017, "Cooper and Shore (2017)"}.
}
