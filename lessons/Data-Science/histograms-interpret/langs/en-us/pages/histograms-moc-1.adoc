...
@teacher{Students might choose 6th graders because the talles bin has 10, whereas the tallest 8th grade bin has 9... but we're looking for which value the tallest bin lands on, which is between 10 and 15 for 8th graders and between 5 and 10 for sixth graders.}
