...
@link-instructions{Open @lesson-link{choosing-your-dataset/pages/datasets-and-starter-files.adoc, "your chosen dataset"}.} Use the Data Cycle to explore the distribution of one or more quantitative columns using *histograms*, and write down your findings.
