...
@learning-objective{interpret linear regression in the context of the animals table}
@learning-objective{use linear regression to quantify patterns in a dataset}
