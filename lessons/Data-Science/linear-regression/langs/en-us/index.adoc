...
@lesson-instruction{
- Complete @printable-exercise{lr-plot-explore.adoc} @ifproglang{codap}{using @starter-file{cats-only} and @starter-file{dogs-only}}. Be ready to discuss your answers with the class!
}
