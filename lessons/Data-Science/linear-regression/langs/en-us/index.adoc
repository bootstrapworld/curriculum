...
@lesson-instruction{
- Read @printable-exercise{pages/data-cycle-regression-analysis-example.adoc}, including the __Data Story__ in the Interpret Data section.
}
...
@lesson-instruction{
- Using the Animals Dataset, complete the second Data Cycle on @printable-exercise{pages/data-cycle-regression-analysis-example.adoc}.
}
