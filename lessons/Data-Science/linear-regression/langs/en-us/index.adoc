...
@teacher{
Want to check student mastery of the content you've just taught? Administer @assessment{checkpoint-1, Linear Regression: Formative Assessment 1} to get a snapshot of your students' current level of mastery.  Make sure you have created a link or code for your class to the assessment.
...
@teacher{
Want to check student mastery of the content you've just taught? Administer @assessment{checkpoint-2, Linear Regression: Formative Assessment 2} to get a snapshot of your students' current level of mastery.  Make sure you have created a link or code for your class to the assessment.
...
@teacher{
Want to check student mastery of the content you've just taught? Administer @assessment{checkpoint-3, Linear Regression: Formative Assessment 3} to get a snapshot of your students' current level of mastery. Make sure you have created a link or code for your class to the assessment.

Alternatively, we offer a compilation of all three Checkpoints in @assessment{cumulative, Linear Regression: Cumulative Assessment}.
}
