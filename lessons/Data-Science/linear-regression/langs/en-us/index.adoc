...
| Assessments
| - You're in luck! This lesson is piloting our new custom-built assessment tool. @dist-link{pages/how-to-use-assessments.adoc, Learn more how to use them now}. Looking for a report you lost about an assessment your class already took? You can always @dist-link{QuizReports.shtml, request that we resend a report}.
...
@teacher{
Want to check student mastery of the content you've just taught? Click @assessment{checkpoint-1} to create a link for your class to our custom-built assessment and get a snapshot of your students' current level of mastery.

If you'd prefer to wait until your students have completed the __entire__ lesson to check mastery, we also offer a cumulative assessment.
}
...
@teacher{
Want to check student mastery of the content you've just taught? Click @assessment{checkpoint-2} to create a link for your class to our custom-built assessment and get a snapshot of your students' current level of mastery.
...
@lesson-instruction{
- Read @printable-exercise{data-cycle-regression-analysis-animals-example.adoc}, including the _Data Story_ in the Interpret Data section.
}
...
@lesson-instruction{
- Using the Animals Dataset, complete the second Data Cycle on @printable-exercise{data-cycle-regression-analysis-animals-example.adoc}.
}
...
- Using the language you saw on @printable-exercise{data-cycle-regression-analysis-animals-example.adoc}, how would you write up the findings on this page?
...
@teacher{
Want to check student mastery of the content you've just taught? Click @assessment{checkpoint-3} to create a link for your class to our custom-built assessment and get a snapshot of your students' current level of mastery.

Alternatively, administer the compilation of all three Checkpoints in this lesson with @assessment{cumulative}
}
...
@teacher{
Reminder: Students have the opportunity to choose a dataset that interests them from @lesson-link{choosing-your-dataset/pages/datasets-and-starter-files.adoc, "List of Datasets"} in the @lesson-link{choosing-your-dataset} lesson. 

Some teachers opt instead to focus their class on the @opt-starter-file{food}. Those teachers might prefer to have their students work on @opt-printable-exercise{data-cycle-regression-analysis-food.adoc} in this next lesson section.
}
...
- @opt{You can print additional @opt-printable-exercise{data-cycle-regression-analysis-2.adoc, blank regression analysis pages} if you need them.}
}
