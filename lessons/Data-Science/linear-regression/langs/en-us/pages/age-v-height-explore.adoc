...
@blanklines{3}{@ifsoln{Answers will vary}}
...
@blanklines{2}{@ifsoln{Answers will vary}}
...
@blanklines{2}{
@ifsoln{Answers will vary. The girls seem to be growing faster. The dots stray farther from the predictor line on the `lr-plot` that includes all students.}
}
...
@blanklines{2}{
@ifsoln{All of the dots fall on the predictor line and the r-value is 1! (This is because someone's height in inches corresponds exactly to their height in centimeters.)}
}
