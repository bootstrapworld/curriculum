...
|
* Check frequently for understanding of @vocab{datatypes} and @vocab{contracts} during this lesson and throughout subsequent lessons.
...
into the editor, they created an example of a new @vocab{Datatype}, called an _Image_.
