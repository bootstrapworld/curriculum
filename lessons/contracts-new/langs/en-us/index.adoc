...
You've seen two @vocab{datatypes} already: Numbers and Strings. Did we get back either one of those? The @vocab{Range} of `star` is a datatype we haven't seen before: an `Image`!
