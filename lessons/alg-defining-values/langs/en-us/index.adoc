...
* Defining Values Exploration (@workbook-link{pages/defining-values-explore.adoc, original}, @link{solution-pages/defining-values-practice.adoc, solutions})

* Defining Values Practice (@workbook-link{defining-values-practice.adoc, original}, @link{solution-pages/defining-values-practice-2.adoc, solutions})
...
- *Performance:* Why re-evalute the same code a dozen times, when we can evaluate it _once_ and use the result as many times as we need?
...
[.lesson-instruction]
- Complete @workbook-link{pages/defining-values-explore.adoc, Defining Values - Explore} in your student workbook. What else can you define?
- Complete @workbook-link{pages/defining-values-practice.adoc, Defining Values - Practice} with their partner.
