...
There are some special lines in this file called @vocab{comments}. The programmer who wrote this code included a series of messages - called comments - that will never be read by the computer.
...
- @opt-starter-file{flags-trinidad} - If you’ve already studied @vocab{Pythagorean Theorem} and are ready to apply it.
