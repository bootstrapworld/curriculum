...
@ifproglang{wescheme}{
* @link{hhttps://docs.google.com/presentation/d/1bKY5Ia-E72xEJIIJPia2hTGhAkJQN4iykPipSbyGcxA/, Lesson Slides}
...
- For practice scaling imported graphics, open @ifproglang{pyret}{@opt-online-exercise{https://code.pyret.org/editor#share=1Z1dPVZv2THmPBTqaKgtwLtVdBSTJ4B29&v=8c4da7d, the Flag of Lebanon Starter Code.}}
@ifproglang{wescheme}{@opt-online-exercise{https://www.wescheme.org/view?publicId=8mMKtpZiZ5, the Flag of Lebanon Starter Code.}}

- For practice with composing more complex images, fix @ifproglang{pyret}{@opt-online-exercise{https://code.pyret.org/editor#share=1WbqiwGj5mFYltiB2lB2OYwWQ-E0h9X4h&v=8c4da7d, this Code for the Puerto Rican flag.}}
