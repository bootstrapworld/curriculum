...
@ifproglang{wescheme}{@link{https://www.wescheme.org/openEditor?publicId=jH25JejavW, Flags Starter File}}
@ifproglang{pyret}{@link{https://code.pyret.org/editor#share=1VOKiUiHWWqwL9xfclQGtoCnyoMHL6nT3, Flags Starter File}}
, and click Run.
...
- For a fun geometry pizzle, open @starter-file{flags-turkey}
