...
* Write down your hypothesis on @worksheet-link{pages/disproving-claim.adoc}, and how we could use this dataset to see if you’re right.
...
=== Investigate
[.lesson-instruction]
Complete @worksheet-link{pages/creating-scatterplot.adoc} in your Student Workbook.
