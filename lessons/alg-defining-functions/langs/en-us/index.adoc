...
* @exercise-link{pages/match-examples-functions1.adoc, Matching Examples & Function Definitions} 

*@exercise-link{pages/create-contracts-examples1.adoc, Creating Contracts from Examples} 

* @exercise-link{pages/create-contracts-examples2.adoc, Creating Contracts from Examples (2)} 
