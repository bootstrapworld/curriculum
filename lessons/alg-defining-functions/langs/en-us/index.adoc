...
* Mapping Examples with Circles of Evaluation worksheet (@workbook-link{pages/MappingExamplesWithCoE2.adoc, HTML})
...
- Have students complete the @workbook-link{pages/MappingExamplesWithCoE2.adoc, Mapping Examples with Circles of Evaluation (Page 25)} worksheet showing how their function examples are working.
...
- Complete the @workbook-link{pages/MappingExamplesWithCoE2.adoc, Mapping Examples with Circles of Evaluation (Page 25)} for the examples of your function.
