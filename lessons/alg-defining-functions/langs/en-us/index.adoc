...
- Have students complete the @workbook-link{pages/MappingExamplesWithCoE2.adoc, Mapping Examples with Circles of Evaluation} worksheet showing how their function examples are working.
...
- Complete the @workbook-link{pages/MappingExamplesWithCoE2.adoc, Mapping Examples with Circles of Evaluation} for the examples of your function.
