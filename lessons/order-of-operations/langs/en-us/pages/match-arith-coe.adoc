...
| @show{coe1}		|*1*@showsoln{"-C" }||*A*    | @show{mat2}
| @show{coe2}		|*2*@showsoln{"-A" }||*B*    | @show{mat4}
| @show{coe3}		|*3*@showsoln{"-E" }||*C*    | @show{mat1}
| @show{coe4}		|*4*@showsoln{"-B" }||*D*    | @show{mat5}
| @show{coe5}		|*5*@showsoln{"-D" }||*E*    | @show{mat3}
|===
