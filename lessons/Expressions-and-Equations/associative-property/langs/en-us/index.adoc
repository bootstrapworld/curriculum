...
@QandA{
@Q{The order of the groupings didn't matter for `overlay`, `beside`, or `above`. Do you think groupings will matter for any @proglang functions or operations? Why or why not?}
...
We could have simulated all of the functions that we just considered using cutouts of paper shapes.  Let's consider two functions that combine images using more complex strategies. 
@lesson-instruction{
...
@QandA{
@Q{What do you Notice about the three Circles of Evaluation? How about the two expressions that accompany them?}
