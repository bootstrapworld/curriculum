...
@do{
  ...
  (define coe6a '((?ANS *) ((?ANS +) (?ANS 6) (- (?ANS 20) 15)) (+ 5 (* (?ANS 2) 2))))
  (define coe6b '((?ANS *) (+ 6 5) ((?ANS +) 5 4)))
  (define coe6c '((?ANS *) 11 (?ANS 9)))
}


The Circles of Evaluation below show a step-by-step computation ("× ÷ + -") ending with an answer. Some of the steps are missing numbers and operators! Fill in those parts, so that each sequence will end with the answer shown on the right. The first one has been done for you.
