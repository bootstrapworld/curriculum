...
|
* Computation is the first tool students will use to think about equivalence.
* This lesson foreshadows additional laws of arithmetic that will be covered later. Keep a running list of the properties that students spot to refer to down the road.
|===
