...
=== Overview
Students explore computation and equivalence through two different activities -- "Equivalent or Not?" and "Which One Doesn't Belong?"
...
@lesson-instruction{
- Turn to @printable-exercise{equivalent-or-not.adoc}.
- Look at the first pair of Circles of Evaluation on the page.
}

@QandA{
@Q{Are they equivalent? How do you know?}
@A{Explanations will vary. And may or may not involve computation.}
}

@slidebreak{Launch}

@lesson-instruction{
- Complete the rest of @printable-exercise{equivalent-or-not.adoc}
}
