...
- Need a challenge?
 * Create a Circle of Evaluation with as many nested Circles as you possibly can.
 * Create a Circle of Evaluation with only odd numbers.
 * Create a Circle of Evaluation that includes the number 1000.
 * Create a Circle of Evaluation that includes the fraction @math{\frac{1}{2}}
- You have 5 minutes.
}
