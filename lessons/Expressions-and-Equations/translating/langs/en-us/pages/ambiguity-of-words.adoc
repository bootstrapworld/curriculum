...
Each expression below can be interpreted two ways. Record both Circles of Evaluation and the corresponding arithmetic expressions for each. We've started the first one for you.
