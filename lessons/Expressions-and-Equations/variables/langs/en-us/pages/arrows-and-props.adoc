...
tr:nth-of-type(1) span.arrow:nth-of-type(3)::before { content: '×÷+-' }
...
tr:nth-of-type(3) span.arrow:nth-of-type(3)::before { content: '×÷+-' }
...
tr:nth-of-type(5) span.arrow:nth-of-type(1)::before { content: '×÷+-' }
