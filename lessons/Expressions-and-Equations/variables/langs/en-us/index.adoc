...
@description{Students use properties to determine whether or not expressions are equivalent.}
...
@lesson-instruction{
- Complete @printable-exercise{equivalent-or-not.adoc} using your knowledge of the Commutative Property and the Associative Property. Try not to rely on computation! Be sure to explain your responses.
- Finally, examine the Circles of Evaluation to decide @printable-exercise{which-not-equivalent.adoc} Again, try to use properties rather than computation. Be sure to explain your thinking.
}
