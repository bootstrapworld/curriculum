...
@learning-objective{Recognize that dividing by @math{x} is the same as multiplying by @math{\frac{1}{x}}.}
@learning-objective{Acknowledge _flexibility_ in the Order of Operations.}
