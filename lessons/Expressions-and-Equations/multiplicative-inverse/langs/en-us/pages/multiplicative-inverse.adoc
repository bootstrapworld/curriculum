...
|===
| @math{1 = \frac{3}{\ifsoln{5}} \times \frac{5}{3}}
| @math{\frac{8}{9} \times \frac{9}{\ifsoln{8}} = 1}
| @math{1 = \frac{\ifsoln{10}}{3} \times \frac{3}{10}}

| @math{\frac{\ifsoln{4}}{7} \times \frac{7}{4} = 1}
| @math{10 \times \frac{\ifsoln{1}}{10} = 1}
| @math{1 = \frac{1}{\ifsoln{9}} \times 9}
...
| @fitb{5em}{@ifsoln{w}} @math{\times \frac{1}{w} = 1}
|===
...
| @show{(coe '(* (/ (?ANS <0x200b>) (?ANS <0x200b>) ) (/ (?ANS <0x200b>) (?ANS <0x200b>))))}  @math{= 1}
| @show{(coe '(* (/ (?ANS 1) (?ANS <0x200b>)) (?ANS <0x200b>)))}  @math{= 1}
|===