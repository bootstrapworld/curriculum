...
@lesson-instruction{
- On @printable-exercise{equivalent-or-not.adoc}, draw two Circles of Evaluation to represent each equation. Then, use your Circles of Evaluation to determine if the equation is true or false. The first one is done for you.
...
@QandA{
@Q{Was it more challenging to work with _algebraic_ exponent expressions (with variables) than it was to work with numeric exponent expressions? Why or why not?}
}
...
@lesson-instruction{
- Complete question 1 on @printable-exercise{programming-w-exponents-and-negatives.adoc}. We'll test these examples in @proglang soon!
...
- With your partner, answer questions 2 and 3 on @printable-exercise{programming-w-exponents-and-negatives.adoc}.
}
...
@lesson-instruction{
- Complete question 4 on @printable-exercise{programming-w-exponents-and-negatives.adoc}.
...
@QandA{
@Q{What did this programming exploration teach you about evaluating exponents with negatives?}
}