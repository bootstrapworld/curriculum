...
@learning-objective{Recognize how distribution results in equivalent expressions.}
@learning-objective{Apply the Distributive Property to expressions with numbers and variables.}
@learning-objective{Use distribution to efficiently complete mental computations.}
