...
The Distributive Property is often considered one of the most difficult properties for students to learn, but also one of the most fundamental properties, particularly when it comes to understanding multiplication. A deep understanding of the Distributive Property can provide a valuable framework for understanding multiplication number facts (e.g., when students relate known facts to known facts) (@citation{carpenter-et-al-2005}) rather than relying purely on memorization and rote methods. 

@citation{clerjuste-et-al-2004, "Clerjuste et al. (2004)"} argue that the Distributive Property, alongside the Associative Property and Commutative Property, facilitates equation manipulation, algebraic simplification, along with abstract mathematical thinking such as proportional reasoning.
}
