...
@lesson-instruction{
- Turn to @printable-exercise{equivalent-or-not.adoc}, where you will determine if equations represented by the Circles of Evaluation are true or false. Explain your response.
