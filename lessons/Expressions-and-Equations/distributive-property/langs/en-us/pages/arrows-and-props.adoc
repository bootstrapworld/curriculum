...
tr:nth-of-type(1) span.arrow:nth-of-type(1)::before { content: '×÷+-' }
...
tr:nth-of-type(2) span.arrow:nth-of-type(2)::before { content: '×÷+-' }
tr:nth-of-type(2) span.arrow:nth-of-type(3)::before { content: '×÷+-' }
tr:nth-of-type(2) span.arrow:nth-of-type(4)::before { content: 'AP' }


tr:nth-of-type(3) span.arrow:nth-of-type(1)::before { content: '×÷+-' }
