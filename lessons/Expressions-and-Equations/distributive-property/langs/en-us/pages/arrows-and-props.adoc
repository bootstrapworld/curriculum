...
Each arrow represents a transformation from an expression to an equivalent expression. Label each arrow with the type of transformation that you observe: Associative Property ("AP"), Commutative Property ("CP"), Identity Property ("IP"), Distributive Property ("DP"), or Computation ("×÷+-").
...
tr:nth-of-type(1) span.arrow:nth-of-type(1)::before { content: '× ÷ + -' ; width: 32px; font-size: smaller;}
...
tr:nth-of-type(2) span.arrow:nth-of-type(2)::before { content: '× ÷ + -' ; width: 32px; font-size: smaller;}
tr:nth-of-type(2) span.arrow:nth-of-type(3)::before { content: '× ÷ + -' ; width: 32px; font-size: smaller;}
tr:nth-of-type(2) span.arrow:nth-of-type(4)::before { content: 'AP' }


tr:nth-of-type(3) span.arrow:nth-of-type(1)::before { content: '× ÷ + -' ; width: 32px; font-size: smaller;}
