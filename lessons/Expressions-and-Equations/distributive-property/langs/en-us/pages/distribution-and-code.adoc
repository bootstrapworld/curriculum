...
<style>
  ...
  div#body .sect1 .example-table tr:first-child { height: 1in; }
  div#body .lesson-section-1 + .lesson-section-1 { margin: 0 !important; }
...
What image operations can be distributed? 
...
| @show{(coe  '(beside (scale 0.5 aqua-star) (scale 0.5 orange-dot)))}

| Sketch 
| @ifsoln{@image{../images/aqua-orange.png, 50}} 
| @ifsoln{@image{../images/aqua-orange.png, 50}}

3+| Did both expressions produce _identical_ images in @proglang? @fitb{5em}{@ifsoln{Yes}} @hspace{2em} Is `scale` distributive over `beside`? @fitb{}{@ifsoln{It is}}
|===
...
| Sketch
| @ifsoln{@image{../images/blue-yellow.png, 50}}
