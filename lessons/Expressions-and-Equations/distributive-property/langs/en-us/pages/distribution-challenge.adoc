...
Fill in the blanks for each pair of Circles of Evaluation below to make them equivalent. On the lines below each Circle of Evaluation, compute the answer and show your work.
