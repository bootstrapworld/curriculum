= From Expanded to Factored Form
...
Complete the Circles of Evaluation on the right to make them equivalent to the ones on the left. On the line beneath each Circle of Evaluation, compute the answer and show your work. The first one has been completed for you. 
...
|| @fitb{10em}{@ifsoln{@math{210 + 56 = 266}}} | | @fitb{10em}{@ifsoln{@math{7 \times 38 = 266}}}
...
@star For each pair of Circles, put a check by the one you think makes the computation simpler.