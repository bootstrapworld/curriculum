= From Factored to Expanded Form
++++
<style>
...
Complete the Circles of Evaluation on the right to make them equivalent to the ones on the left. On the lines below each Circle of Evaluation, compute the answer and show your work. The first one has has been done for you.
...
@star For each pair of Circles above, put a check next to the one you think makes the computation simpler.
