...
@learning-objective{Recognize that multiplying and dividing by one does not affect the value of an expression.}
@learning-objective{Recognize that adding or subtracting zero does not affect the value of an expression.}
@learning-objective{Demonstrate their understanding of the Identity Property with and without variables via Circles of Evaluation, numeric expressions, and words.}
