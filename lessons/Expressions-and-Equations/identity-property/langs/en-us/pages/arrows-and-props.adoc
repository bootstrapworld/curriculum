...
.circleevalsexp .expression { padding-top: 4px; }
...
tr:nth-of-type(2) span.arrow:nth-of-type(1)::before { content: '× ÷ + -' ; width: 32px; font-size: smaller;}
...
tr:nth-of-type(5) span.arrow:nth-of-type(3)::before { content: '× ÷ + -' ; width: 32px; font-size: smaller;}
</style>
++++
}
