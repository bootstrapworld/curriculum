...
| 
@preparation{
- Decide whether or not the last section of this lesson (a programming exploration of commutativity) is appropriate for your class. 
...
- With your partner, test the four additional functions for commutativity.
}
