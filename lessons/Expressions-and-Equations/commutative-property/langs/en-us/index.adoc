...
@scrub{FLANNERY use darker and lighter to the starter file. get rid of min and max}

@lesson-instruction{
- Turn to @printable-exercise{commutativity-and-code.adoc} and open the @starter-file{expressions-equations}.
- For each function, draw a second Circle of Evaluation that changes the order of the arguments. Translate the Circles of Evaluation to code, then take a minute to predict what image it will return. Finally, test your code in @proglang and sketch the results.
}
