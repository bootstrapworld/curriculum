...
<style>
  ...
  /* The first section on this page has no header, so it's a "preamble" */
...
== Is @show{(code 'string-contains)} Commutative?   Does the order of the arguments matter?
...
== Are @show{(code 'min)} and @show{(code 'max)} Commutative?   Does the order of the arguments matter?
...
== Is @show{(code 'blend-images)} Commutative?   Does the order of the arguments matter?
