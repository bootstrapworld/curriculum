...
For each function, draw a second Circle of Evaluation that changes the order of the arguments. Translate the Circles of Evaluation to code. Take a moment to predict what this code will return. Then test your code in Pyret and record the result. 
