...
All of the verbal expressions below are ambiguous. Complete the table:

- Rewrite each expression using clearer words to indicate that the desired operation comes first.
- Translate each of these into arithmetic (using parentheses to indicate which operation comes first) and compute.
...
| Decrease the product of 10 and 8 by 5
@math{(10 \times 8) - 5 = 75}
