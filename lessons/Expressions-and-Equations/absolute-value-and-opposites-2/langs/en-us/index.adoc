...
@lesson-instruction{
- Turn to @printable-exercise{equivalent-or-not.adoc}. Are the expressions on either side of the equal sign @vocab{equivalent}?
...
@lesson-instruction{
- Examine the Circles of Evaluation to determine @printable-exercise{wodb-abs-val-negate-2.adoc}. The page starts with numeric values and then integrates @vocab{variables}. Place a check mark by each Circle of Evaluation that meets the condition stated on the left.
...
@lesson-instruction{
On @printable-exercise{programming-w-abs-val-and-opposite.adoc}, complete the table at the top of the page. If you get stuck, translate the code into Circles of Evaluation. Discuss your predictions with your partner.
}
...
@lesson-instruction{
- With your partner, complete the second section of @printable-exercise{programming-w-abs-val-and-opposite.adoc} using @starter-file{negation}.
...
@lesson-instruction{
- Complete the final section of @printable-exercise{programming-w-abs-val-and-opposite.adoc}.
