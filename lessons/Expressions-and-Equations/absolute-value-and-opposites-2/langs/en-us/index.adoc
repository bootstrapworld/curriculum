...
@learning-objective{Students translate expressions with absolute value and opposite, using Circles of Evaluation, words and symbols.}
@learning-objective{Students examine equivalence in pairs of Circles of Evaluation with absolute value and equivalence.}
@learning-objective{Students compute the result of expressions with absolute value and opposite.}
