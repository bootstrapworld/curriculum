...
@learning-objective{Translate between words, mathematical expressions, and Circles of Evaluation.}
@learning-objective{Evaluate expressions involving exponents and one other operation.}
@learning-objective{Evaluate expressions involving exponents and negatives.}
