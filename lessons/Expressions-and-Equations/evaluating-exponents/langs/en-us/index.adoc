...
@lesson-point{Exponents are valuable because they act as a shorthand.}
...
@lesson-point{In an expression with no grouping symbols, we evaluate the exponent before the other operations.}
...
- In @printable-exercise{which-not-equivalent.adoc}, determine which Circles of Evaluation do not belong.
}
...
Ms. Brenneman asked her class to draw Circles of Evaluation to represent  @big{@math{4m^2}}. +
Four students produced four different Circles of Evaluation (below).
...
@QandA{
@Q{Which Circle of Evaluation do you think matches the expression @math{4m^2}? +
@hspace{1em}If you're not sure, are there any that you can rule out right away?}
...
@QandA{
@Q{Jayla says that she likes to imagine an "invisible parentheses" enclosing every base and exponent. What is she describing? Do you find this helpful?}

@Q{What was your strategy for evaluating expressions with variables and exponents?}
}
...
@lesson-instruction{
- Complete question 1 on @printable-exercise{programming-w-exponents.adoc}. We'll test these examples in @proglang soon!
...
- With your partner, answer questions 2 and 3 on @printable-exercise{programming-w-exponents.adoc}.
}
...
@lesson-instruction{
- Complete question 4 on @printable-exercise{programming-w-exponents.adoc}.
...
@QandA{
@Q{What did this programming exploration teach you about @proglang and examples?}
@Q{What did this programming exploration teach you about evaluating exponents?}
}
