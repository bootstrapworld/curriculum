...
| @ifsoln{@image{../images/hello-315.png, 40}}@ifnotsoln{@vspace{8ex}}
...
@fitb{}{@ifsoln{be sure to sureface that positive rotations are counter clockwise}} 
...
| @ifsoln{@image{../images/hello-180.png, 40}} @ifnotsoln{@vspace{8ex}}
...
| @ifsoln{@show{(coe '(rotate 180 hello))}} @ifnotsoln{@vspace{8ex}}
