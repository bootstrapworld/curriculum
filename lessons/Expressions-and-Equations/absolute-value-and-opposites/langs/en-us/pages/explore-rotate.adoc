...
[.FillVerticalSpace, cols="^.^1a,^.^1a,^.^1a,^.^1a,^.^1a,^.^1a,^.^1a,^.^1a", stripes="none"]
|===
...
[.FillVerticalSpace, cols="^.^2a,^.^3a,^.^2a,^.^2a,^.^2a", stripes="none"]
|===
...
| @ifsoln{@image{../images/hello-225.png, 40}} @vspace{8em}
|===

*@star For each Circle of Evaluation above, draw a _simpler, equivalent_ Circle of Evaluation below that will produce the same image.*

[.FillVerticalSpace, cols="^.^2a,^.^3a,^.^2a,^.^2a,^.^2a", stripes="none"]
|===
| @ifsoln{@show{(coe '(rotate 180 hello))}}
