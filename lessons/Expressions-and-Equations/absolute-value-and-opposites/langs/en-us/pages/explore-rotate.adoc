...
@n Draw the image that each Circle of Evaluation will produce. The first one has been done for you.

[cols="^.^1a,^.^1a,^.^1a,^.^1a,^.^1a,^.^1a,^.^1a,^.^1a", stripes="none"]
|===
...
| @ifsoln{@image{../images/hello-315.png, 40}}@ifnotsoln{@vspace{15ex}}
...
@n What did you discover? @fitb{}{@ifsoln{answers will vary}} +
@fitb{}{@ifsoln{be sure to surface that positive rotations are counter clockwise}} 
...
[cols="^.^2a,^.^3a,^.^2a,^.^2a,^.^2a", stripes="none"]
|===
| @show{(coe '(rotate (negate 180) hello))}
| @show{(coe '(rotate (negate (negate 90)) hello))}
| @show{(coe '(rotate (abs -45) hello))}
| @show{(coe '(rotate -45 (rotate 45 hello)))}
| @show{(coe '(rotate (abs 135) hello))}

| @ifsoln{@image{../images/hello-180.png, 40}} @ifnotsoln{@vspace{15ex}}
| @ifsoln{@image{../images/hello-90.png, 20}}
| @ifsoln{@image{../images/hello-45.png, 40}}
| @ifsoln{@image{../images/hello.png, 40}}
| @ifsoln{@image{../images/hello-225.png, 40}}

5+| *@star For each Circle of Evaluation above, draw a _simpler, equivalent_ Circle of Evaluation below that will produce the same image.*

| @ifsoln{@show{(coe '(rotate 180 hello))}} @ifnotsoln{@vspace{15ex}}
