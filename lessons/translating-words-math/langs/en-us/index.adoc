...
The second set of cards includes _Circles of Evaluation_. Students have almost definitely never encountered Circles of Evaluation before! Broadly, Circles of Evaluation will help students to visualize the structure of the mathematical expressions they encounter. For the time being, here’s what students need to know about Circles of Evaluation:
...
** _If students do not note that the absence of the Oxford comma suggests that the authors' gradnparents are quite the power couple, try reading the sentence with different inflections._

The purpose of this example is not to highlight comma usage - but to suggest that ambiguity exists when we express ideas in words.
