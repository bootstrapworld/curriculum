...
@objective{Add a score field to the gameState structure}
@objective{Modify their draw-state function to display the score on the screen}
@objective{Modify the next-state-tick function to increment or decrement the score}
