...
=== Investigate
@right{@centered-image{images/cowjump.gif, 200}}
...
@right{@centered-image{images/cycling.gif, 400}}
...
@right{@centered-image{images/pulsingstar.gif, 200}}
...
@right{@centered-image{images/dimmer.gif, 200}}
