...
Open the @starter-file{robot-emoji} file and click "Run". In this file, there are two versions of the same program written by different students.
...
@lesson-instruction{
Open the @starter-file{emoji-refactoring} file and click "Run".
}
