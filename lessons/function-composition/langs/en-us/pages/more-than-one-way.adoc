...
What image will each of the four expressions below evaluate to? If you're not sure, go to @starter-file{editor} and type them into the Interactions Area and see if you can figure out how the code constructs its image.
