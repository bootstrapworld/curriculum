...
Suppose I wrote the code: @show{(sexp->code '(scale 3 (circle 50 "solid" "red")))}.


What’s another line of code I could write that would produce the exact same image?
	@show{(sexp->code '(circle 150 "solid" "red"))}
--
