...
Our @ifproglang{wescheme}{@link{../../../algebra-wescheme/lessons/flags/index.shtml, Flags lesson}} @ifproglang{pyret}{@link{../../../algebra-pyret/lessons/flags/index.shtml, Flags lesson}} also dives deeper into image composition.
|===
...
Here's a page of images to challenge students to compose:
