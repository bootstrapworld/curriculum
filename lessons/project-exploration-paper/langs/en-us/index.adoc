...
@ifproglang{codap}{
@lesson-prereqs{ds-intro, codap-exploring, codap-bar-charts, data-cycle, codap-transformers-1, codap-transformers-2, method-chaining, random-samples, grouped-samples}
}
