...
- Have students open to @printable-exercise{pages/function-composition-green-star.adoc}.  
...
[.lesson-instruction]
Have students open to @printable-exercise{pages/function-composition-your-name.adoc}.

Students create a text @vocab{image} of their name and experiment with other functions.
...
== Composing more elegantly @duration{25 minutes}
...
=== Investigate
Students complete @printable-exercise{pages/which-code-is-more-elegant.adoc}.

=== Synthesize
How did you decide which code was more elegant?