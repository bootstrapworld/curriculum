...
Click run. And see how many different green triangles you can make now that `gt` is defined!
...
Have students turn to @printable-exercise{defining-functions.adoc}. As they complete each definition, they should type it into the `Definitions Area` of the @starter-file{gt} and take it for a test drive.
