...
[.lesson-instruction]
- There is something special happening in this code called commenting. The programmer who wrote this code included a series of messages for us, the humans, that will not be read by the computer.  Commenting can help me or you keep track of things we want to remember when we come back to look at our code another day.  Professional programmers use comments all the time because they work with teams who need to be able to follow each other's thinking in order to collaborate efficiently.
