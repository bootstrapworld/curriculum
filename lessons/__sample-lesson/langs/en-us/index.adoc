...
@printable-exercise{pages/page-in-workbook.adoc, "A link to a required page, usually in the workbook"}

@online-exercise{https://www.wescheme.org/view?publicId=EA6R0E97nV, "A link to a required online exercise (CPO, WeScheme, Desmos, etc"} 

@opt-printable-exercise{pages/page-in-workbook.adoc, "A link to an OPTIONAL page, usually not in the workbook"}

@opt-online-exercise{https://www.wescheme.org/view?publicId=EA6R0E97nV, "A link to an OPTIONAL online exercise (CPO, WeScheme, Desmos, etc"} 
...
- @opt-printable-exercise{pages/exerciseA1.adoc, "Sample design recipe, etc"}
