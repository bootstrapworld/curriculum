...
Look at @worksheet-link{pages/PiecewiseFunctions-EX1.html} for Exercise A2.

Look at @worksheet-link{lessonA/pages/exerciseA1.html} for Exercise A1.

Look at @worksheet-link{pages/exerciseA2.html} for Exercise A2.
...
@worksheet-link{pages/exerciseA1.adoc, "Sample design recipe, etc"}
