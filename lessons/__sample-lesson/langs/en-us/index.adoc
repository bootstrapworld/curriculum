...
Look at @workbook-link{pages/pageA1.adoc}.



//Look at @workbook-link{pointer-URL, external URL}.

Look at @workbook-link{pages/pageA2.html} for Exercise A2.

Look at @exercise-link{pages/pageA3.html} for Exercise A3.

Look at @workbook-link{pages/pageA4.pdf}.
