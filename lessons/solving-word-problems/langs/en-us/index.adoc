...
== DR Exercsises to find a home for
- @opt-printable-exercise{dr-direct-variation.adoc, Design Recipe: Direct Variation}
- @opt-printable-exercise{dr-exercise-1.adoc, Design Recipe Practice (1)}
...
- @opt-printable-exercise{dr-slope-intercept-1.adoc, Design Recipe: Linear Relationships (1)}
- @opt-printable-exercise{dr-neg-slope.adoc, Design Recipe: Linear Relationships (2)}
- @opt-printable-exercise{dr-geometry-rectangles.adoc, Design Recipe: Geometry - Rectangles}
- @opt-printable-exercise{dr-geometry-rect-prism.adoc, Design Recipe: Geometry - Rectangular Prisms}
- @opt-printable-exercise{dr-geometry-circles.adoc, Design Recipe: Geometry - Circles}
- @opt-printable-exercise{dr-geometry-cylinder.adoc, Design Recipe: Geometry - Cylinders}
