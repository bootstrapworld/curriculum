...
A good Sample Table should be _representative_ of the population, and _relevant_ to what’s being analyzed. A good Sample Table should have...
...
*This connects back to our lesson on @link{../ds-random-samples/index.shtml, statistical inference and random samples}: a good Sample Table should allow us to make inferences about the larger dataset when we run our analysis.*
