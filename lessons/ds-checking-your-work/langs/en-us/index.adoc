...
For the purpose of performing __inference__, we typically take a random sample of at least 20 individuals from a much larger population. For the purpose of testing code, we can extract just a few rows and columns from a larger Table in a strategic way so we can catch any obvious errors.
