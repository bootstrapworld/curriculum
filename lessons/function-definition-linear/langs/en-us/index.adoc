...
As discussed above, the relationship between the x-values and the y-values can be described using @math{y = mx + b}, where @math{m} stands for slope and @math{b} stands for the y-intercept.
...
_function definition:_ @math{f(x) = 3x - 12}
