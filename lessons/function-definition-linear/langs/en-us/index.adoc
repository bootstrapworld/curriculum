...
=== Launch
A *function definition* can be used to summarize an entire table or graph by putting the @vocab{slope} and @vocab{y-intercept} front-and-center!
...
*Let's start by idenitifying the slope and y-intercept from function definitions.*
