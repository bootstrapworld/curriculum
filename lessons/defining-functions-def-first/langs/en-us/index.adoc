...
- Then, match each table to the function that describes it.
...
Have students turn to @printable-exercise{pages/matching-contracts-examples.adoc}.
...
Have students open @online-exercise{https://code.pyret.org/editor#share=1wvO-su91pFXQJcsIAa5IUOVcUea06YuY&v=04918ef}
