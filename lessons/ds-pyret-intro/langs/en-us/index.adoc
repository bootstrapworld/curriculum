...
* link:{pathwayrootdir}/workbook/workbook.pdf[Student workbook], and something to write with* Decide how students will be grouped in pairs
...
=== Investigate
[.lesson-instruction]
In pairs, students complete @printable-exercise{pages/numbers-n-strings.adoc}.
...
- @online-exercise{https://teacher.desmos.com/activitybuilder/custom/5fc90a1937b6430d836b67e7, Matching Code to Images (Desmos Activity)}
- @online-exercise{https://teacher.desmos.com/activitybuilder/custom/5fc90f1289c78e0d2a5bccfc, Matching Code to Images using overlay & put-image (Desoms Activity) }
