...
=== Investigate
[.lesson-instruction]
@ifproglang{pyret}{Define the Compute functions on @printable-exercise{pages/design-recipe-1.adoc} and @printable-exercise{pages/design-recipe-2.adoc}.}

@ifproglang{codap}{Define the Transformers and formula expressions on @printable-exercise{pages/design-recipe-1.adoc} and @printable-exercise{pages/design-recipe-2.adoc}.}
