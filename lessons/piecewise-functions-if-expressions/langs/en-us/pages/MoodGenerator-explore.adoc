...
@n Open the @ifproglang{pyret}{@link{https://code.pyret.org/editor#share=1nTf5h4SJ3KCz2KxqH-0wsYU9cCbu5RkZ&v=1904b2c, "Mood Generator Starter File"}} @ifproglang{wescheme}{@link{https://www.wescheme.org/view?publicId=tMh8w524Bp}}, and read through the code you find there. This code contains new programming that you haven't seen yet! Take a moment to list everything you Notice, and then everything you Wonder...
