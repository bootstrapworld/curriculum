...
Decide whether you want students to explore both of these programs or want to focus in on one of them.
...
- Complete @printable-exercise{pages/RedShape-intro.adoc} in your student workbooks.
...
@ifproglang{wescheme}{
- Open the @link{https://www.wescheme.org/view?publicId=tMh8w524Bp, Mood Generator starter file}.
}
...
There are multiple ways to write piecewise functions in Pyret. For those who are curious and have time to engage students with multiple methods, check out the @link{https://code.pyret.org/editor#share=1YkCJ8k1zYqdhwk8R1BGUk0hWS0HXxc_e&v=1904b2c, ASK version of the Mood Generator starter file.}
|===
}
...
[.lesson-instruction]
* How does the Design Recipe help us to write piecewise functions?
...
_Now we circle and label everything that is change-able and figure out what changes._
