...
A relationship between two quantitative variables is strong if the scatter plot points are tightly clustered together. In, then knowing the x-value of a data point gives us a very good idea of what its y-value will be. If the relationship is linear and strong, the scatter plot points are clumped together in a thin cloud.
