...
=== Investigate
Have students turn to @workbook-link{pages/identifying-form.adoc} in their student workbooks. For each scatter plot, identify whether the relationship is positive or negative, and strong or weak, and combine those two to guess whether the @math{r}-value is closer to -1, -0.5, 0, +0.5, or +1.
...
- @exercise-link{pages/identifying-form-open-ended.adoc}