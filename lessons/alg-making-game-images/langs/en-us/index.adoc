...
* @link{https://code.pyret.org/editor#share=1bSyjgGUjArZZFP4mm6g0nXRvqBvxd9Iq, Blank Game Template}
}
...
@ifproglang{pyret}{ @link{https://code.pyret.org/editor#share=1bSyjgGUjArZZFP4mm6g0nXRvqBvxd9Iq, Blank Game Template }. }
