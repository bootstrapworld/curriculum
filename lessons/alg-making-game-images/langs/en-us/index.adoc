...
@ifproglang{wescheme}{
* @link{https://docs.google.com/presentation/d/17S4D9wAMTMaf6B-KKJlUmsy7DztcX38u1DHhElKFcfQ, Lesson Slides}
* @link{https://www.wescheme.org/openEditor?publicId=ysj93ZPFsu&, Blank Game Starter File}
* @link{pages/LinkingImagesGuide.pdf, Linking Images Guide - PDF}
}
@ifproglang{pyret}{
* @link{https://docs.google.com/presentation/d/1dRsVNTW8GSDVOHiGjAdBdj8ZCIC3fK0sjZBAeX97t7I/, Lesson slides}
* @link{https://code.pyret.org/editor#share=1bSyjgGUjArZZFP4mm6g0nXRvqBvxd9Iq, Blank Game Starter File}
}
...
@ifproglang{wescheme}{ @link{https://www.wescheme.org/openEditor?publicId=ysj93ZPFsu&, Blank Game Starter File }. }
@ifproglang{pyret}{ @link{https://code.pyret.org/editor#share=1bSyjgGUjArZZFP4mm6g0nXRvqBvxd9Iq, Blank Game Starter File }. }
...
* On a PC or Mac follow this, @exercise-link{pages/SavingImagesGuide.pdf, quick guide to saving images to drive}.
