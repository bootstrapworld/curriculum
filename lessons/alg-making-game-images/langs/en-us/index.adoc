...
@ifproglang{wescheme}{
* Lesson slides (@link{https://docs.google.com/presentation/d/17S4D9wAMTMaf6B-KKJlUmsy7DztcX38u1DHhElKFcfQ, Google Slides})
* Blank Game template (@link{https://www.wescheme.org/openEditor?publicId=ysj93ZPFsu&, WeScheme})
}
@ifproglang{pyret}{
* Lesson slides (@link{https://docs.google.com/presentation/d/1dRsVNTW8GSDVOHiGjAdBdj8ZCIC3fK0sjZBAeX97t7I/, Google Slides})
* Blank Game template (@link{https://code.pyret.org/editor#share=1bSyjgGUjArZZFP4mm6g0nXRvqBvxd9Iq, Pyret})
}
