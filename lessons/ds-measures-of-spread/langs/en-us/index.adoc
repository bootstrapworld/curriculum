...
=== Investigate
[.lesson-instruction]
* Turn to @workbook-link{measures-of-center/pages/summarizing-columns-in-animals.adoc}
...
[.lesson-instruction]
Turn to @workbook-link{pages/matching-boxplots-to-histograms.adoc} and see if you can identify which box-plot matches which histogram.
