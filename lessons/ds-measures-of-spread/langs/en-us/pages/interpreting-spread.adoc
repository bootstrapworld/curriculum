...
[.lesson-point]
The dataset we've been working with represents the annual income of ten people. All numbers represent __thousands of dollars__ (so `14` means "$14,000").
 
@vspace{3ex}
5) The following statements about the dataset are _correct_ ... but misleading. Write down the reason why.
