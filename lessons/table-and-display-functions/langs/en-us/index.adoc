...
There are other, dedicated lessons for displays not mentioned here, such as @lesson-link{scatter-plots}, @lesson-link{linear-regression}, etc.
...
- Did `bar-chart` consume a categorical or quantitative data?
** _categorical_
