...
Students should have their contracts page, a pencil, and a computer, with a WeScheme tab opened and logged into.

== Launch: (5 min)

Ask students to open the `rocket-height` program in WeScheme and play with this program for a few minutes while noticing and wondering.
