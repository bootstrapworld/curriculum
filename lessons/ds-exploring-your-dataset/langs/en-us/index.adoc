...
| Relevant Standards
|
@worksheet-include{ds-defining-table-functions/xtra/lang-prereq.adoc}
|===
...
[.lesson-instruction]
- Look at the spreadsheet for your data. What do you *notice*? What do you *wonder*? Complete @worksheet-link{workbook-pages/my-dataset.adoc}, making sure to have at least two Lookup Questions, two Compute Questions, and two Relate Questions.
