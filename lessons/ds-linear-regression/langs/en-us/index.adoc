...
[.lesson-instruction]
* Turn back to @workbook-link{ds-visualizing-relationships/pages/correlations-in-my-dataset.adoc}, where you listed possible correlations. 
...
- @workbook-link{pages/describing-relationships-1.pdf, Describing Relationships 1}
- @workbook-link{pages/describing-relationships-2.pdf, Describing Relationships 2}
