...
[.lesson-instruction]
* Turn to @workbook-link{pages/grading-predictors.adoc}.
...
- Project: @link{pages/olympics-project.adoc} - A mini-project in which students use linear regression to find correlations in the improvement of records in a sport of their choice.