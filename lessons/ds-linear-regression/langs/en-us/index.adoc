...
- @exercise-link{pages/olympics-project.adoc, Olympic Records} - A mini-project in which students use linear regression to find correlations in the improvement of records in a sport of their choice.