...
=== Investigate
[.lesson-instruction]
Complete @worksheet-link{pages/plot-practice.adoc}, @worksheet-link{pages/exploring-displays-1.adoc}, and @worksheet-link{pages/exploring-displays-2.adoc}.
...
There are no additional exercises available for this lesson.