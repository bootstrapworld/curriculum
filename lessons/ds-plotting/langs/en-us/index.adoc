...
=== Investigate
[.lesson-instruction]
Complete @worksheet-link{workbook-pages/plot-practice.adoc} and @worksheet-link{workbook-pages/exploring-displays-1.adoc}.
...
@worksheet-link{workbook-pages/exploring-displays-2.adoc}