...
* Slices in a pie chart can be shown in _any order_, without changing the meaning of the chart. However, slices are usually shown in some sensible order (slices might be shown in alphabetical order, or from the smallest to largest slice).