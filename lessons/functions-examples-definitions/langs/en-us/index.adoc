...
Thumbs up? Thumbs to the side? or Thumbs down? How confident do you feel that you could write the @vocab{contract}, @vocab{examples} and @vocab{function definition} on your own if you were given a word problem about another shape function?
--
...
- @printable-exercise{pages/contracts-examples-definitions-stars.adoc} and
