...
@lesson-description{Students play a simple video game, identifying the variables and how they change, and then discuss their favorite games and think about the work involved in making them.}
