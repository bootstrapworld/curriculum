...
@span{.right}{@image{images/left.png, "A hill-shaped histogram, with the left side sloping away farther than the right side", 300}}
...
@span{.right}{@image{images/right.png, "A hill-shaped histogram, with the right side sloping away farther than the left side", 300}}
