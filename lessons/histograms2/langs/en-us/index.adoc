...
=== Launch
@span{.right}{@centered-image{images/skew-right.png, skew right, 300, ""}}
...
@span{.right}{@image{images/symmetric.png, "A hill-shaped histogram, with both sides sloping away from the peak equally", 300}}
...
@span{.right}{@image{images/left.png, "A hill-shaped histogram, with a clump of taller bars on the right side, and smaller bars trailing off to the left side", 300}}
...
@span{.right}{@image{images/right.png, "A hill-shaped histogram, with a clump of taller bars on the left side, and smaller bars trailing off to the right side", 300}}
...
@span{.right}{@image{images/height-outlier.png, "Histogram with a low outlier", 300}}
...
@span{.right}{@image{images/stadium-outlier.png, "Histogram with a high outlier", 300}}
