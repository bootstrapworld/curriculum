...
We can _define_ linear relationships using *Function Definitions* (either in _function notation_ or Pyret code). Linear functions always include a term for the slope and another for the y-intercept.
