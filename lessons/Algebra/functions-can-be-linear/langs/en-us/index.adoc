...
@teacher{On this page, students will refer to the six graphs below to consider the question:
...
Three of the graphs above represent @vocab{linear relationships}, and three are not linear. As we can see, the linear graphs can go in lots of directions and there are other kinds of relationships that follow patterns that are not linear!
...
Three of the tables above are not linear. They might show patterns, but they aren't linear!
}
