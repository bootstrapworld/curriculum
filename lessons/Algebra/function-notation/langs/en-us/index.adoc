...
Even if we can't see the __definition__ of a function, we can reason about it just by looking at the graph!
...
What is the value of @math{f(0)} in the graph above? __3__
}
