...
@lesson-instruction{
- With your partner, open the @starter-file{ninja-cat}, and play for a minute using the arrows keys to move left, right, and jump.
- Complete @printable-exercise{ReverseEngineerGame.adoc}.
}
