...
<style>
  ...
  tr:nth-child(even) td { text-align: left !important; }
</style>
++++
...
| @showsoln{(coe e2)} @ifnotsoln{@vspace{12em}}
| @showsoln{(code e2)}
...
| @showsoln{(coe e3)} @ifnotsoln{@vspace{12em}}
| @showsoln{(code e3)}
...
| @showsoln{(coe e4)} @ifnotsoln{@vspace{12em}}
| @showsoln{(code e4)}
