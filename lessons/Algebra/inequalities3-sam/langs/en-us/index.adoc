...
@teacher{
@opt{If you're interested in another opportunity for students to read and write about code, you can print copies of @opt-printable-exercise{onscreen-discussion.adoc}.
}
}
