...
The Circles of Evaluation are a critical pedagogical tool in this course, placing the focus on the _structure_ of mathematical expressions.

@right{@image{images/pemdas.png, 200}} Students are often introduced to the Order of Operations by way of this pyramid model or mnemonics like PEMDAS, GEMDAS, etc. and internalize them as a playbook for sequencing computations. This is a brittle and limited (mis)understanding of the Order of Operations. 

The Circles of Evaluation encourage students to apply the same sequences they've already learned to **making the groupings in expressions visible _before doing any computations_**, thereby building deeper understanding and more flexible thinking. For some students, diagramming arithmetic sentences using Circles of Evaluation surfaces questions they have about the Order of Operations. For other students, revealing their thinking through the diagrams allows us to notice and address misconceptions. 

Circles of Evaluation are also a bridge representation, which naturally connects to function composition and converting arithmetic into code.
}
}
=== Launch
@slidebreak{Launch}
...
@A{It depends! While the Order of Operations tells us to start by making groupings of whatever is in parentheses (or other Grouping symbols), we can still work 
...
Let's start with @big{@math{8^2 \div 4 - 5 \times (3 + 9) + 8}}
