...
- Then turn to @printable-exercise{pages/complete-code-from-coe-parens.adoc} and add the missing parentheses using information from the Circles of Evaluation.
}
