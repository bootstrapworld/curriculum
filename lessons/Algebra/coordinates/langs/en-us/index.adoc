...
@ifslide{@right{@image{images/2dPosition.png}}}
The coordinate pair @math{(200, 50)}, for example, indicates that the x-coordinate is @math{200} and the y-coordinate is @math{50}.
...
@lesson-instruction{
Complete @printable-exercise{Estimation.adoc}.
}
...
@QandA{
@Q{Why people need to make estimates, instead of computing the exact answer?}
