...
[.FillVerticalSpace, cols="^.^1, 11, ^.^4, ^15", options="header", frame="none"]
|===
|
| Word problem
| Replacement?
...
| Yes  {nbsp}  *_No_*
| @math{\mbox{permute-no-replace}(7, 7)}
@math{ = \frac{7!}{(7-7)!} }
...
| @ifsoln{ @math{\mbox{permute-no-replace}(8, 8) = \frac{8!}{(8 - 8)!}} + @math{8! \div 1 = 40,320} }
...
| Yes  {nbsp}  @ifsoln{*_NO_*} @ifnotsoln{No}
| @ifsoln{ @math{\mbox{permute-no-replace}(6, 4) = \frac{6!}{(6 - 4)!}} + @math{\frac{6!}{2!} = 360} }
...
| Yes  {nbsp}  @ifsoln{*_NO_*} @ifnotsoln{No}
| @ifsoln{ @math{\mbox{permute-no-replace}(52, 6) = \frac{52!}{(52 - 6)!}} }
