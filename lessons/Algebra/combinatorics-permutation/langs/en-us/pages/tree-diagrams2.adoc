...
.ulist li { border: solid 1px green; height: 1.5em; position: relative;}
...
@media screen {
	.ulist p { min-height: 1.5em !important; }
}
</style>
++++
...
[.FillVerticalSpace, cols="^1a", frame="none", grid="none"]
|===
| @ifsoln{@image{../images/ice-cream-tree.png, 630}}
|===
