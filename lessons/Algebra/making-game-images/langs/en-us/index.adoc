...
When you're finished, you should be able to type `SCREENSHOT` in the Interactions Area (after clicking "Run") and see all four of their images appropriately sized and oriented.
