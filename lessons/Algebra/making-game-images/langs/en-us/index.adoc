...
- Students can make-use of the image manipulation functions `rotate`, `flip-horizontal`, and `flip-vertical`. @pathway-only{You'll find their contracts in the @pathway-link{resources/pages/contracts.pdf, Contracts pages}}.
