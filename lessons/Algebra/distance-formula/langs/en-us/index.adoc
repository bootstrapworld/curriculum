...
@lesson-roleplay{
This number line represents the x-axis in our game. I need two volunteers to represent our `DANGER` and `PLAYER` and come find a spot to stand along it. _Make sure students start far enough apart that they'll be able to take steps toward each other during the role play without touching._
...
Let's take a few minutes to play with these proofs without words.

@online-exercise{https://www.geogebra.org/m/jFFERBdd#material/MJWHp9en}

@online-exercise{https://www.geogebra.org/m/jFFERBdd#material/UgcNZWJ4}

@online-exercise{https://www.geogebra.org/m/jFFERBdd#material/HYcAVuvM}

@online-exercise{https://www.geogebra.org/m/jFFERBdd#material/ZuQYwGhT}

@optional In the next section of the lesson we will discuss
=== Investigate

As we saw in the geogebra activities, there is a special relationship between the area of the squares that can be drawn using each of the 3 legs of a right triangle: 

@optional If you want to give students a chance to write about the relationship before you show it, have them complete @opt-printable{proof-wo-words.adoc} now.

If we draw a square off each side of a right triangle, the areas of the two smaller squares will add up to the area of the larger square. 

If we label the two legs `a` and `b` and the hypotenuse `c`, this rule can be described using the following equation: @math{a^ + b^2 = c^2}

@lesson-instruction{
Take a minute to think about how to describe the relationship between the squares in this idthe patterns you observed in the Desmos activity connect to this diagram.
...
We know that we can use the Pythagorean Theorem to find the hypotenuse of a triangle from the lengths of its legs. And we know that there are hidden right triangles connecting the characters in our game. Now we have to 

@QandA{
@Q{If we had one player at (0,0) and another player at (4,3), we'd see a right triangle and the lengths of the legs would be 3 and 4. How would we use the Pythagorean Theorem to find the hypotenuse of the triangle?}
