...
@centered-image{images/graph00to43.jpeg, 200}
...
@optional For more practice writing code to generate the distance between two fixed points, complete @printable-exercise{pages/distance-from-game-coordinates.adoc} and  @opt-printable-exercise{pages/distance-from-game-coordinates-2.adoc}.
...
@centered-image{images/pxpy.png, 500}
...
@strategy{
@span{.title}{Extension: Finding the length of the leg of a triangle}
