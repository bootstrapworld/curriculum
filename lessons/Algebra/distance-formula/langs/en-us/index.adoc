...
@optional If you would like your students to do their summative reflection using paper-and-pencil, have them complete @printable-exercise{proof-wo-words.adoc} in lieu of the final slide in the Desmos activity.
...
@strategy{
@span{.title}{ Pythagorean Theorem to video games}
...
@lesson-instruction{
* Turn to @printable-exercise{distance-on-coordinate-plane.adoc} and look at how the `line-length` function is used in the code. See if you can figure out how to write the code for the second problem.
...
@strategy{
@span{.title}{Finding the length of the leg of a triangle}
