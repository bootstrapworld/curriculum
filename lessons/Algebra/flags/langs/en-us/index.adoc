...
Many teachers enjoy devoting a few days of class to making flags! If you choose to use this task as a summative project, check out the @handout{rubric-flags.adoc} as a tool to assess student learning.
