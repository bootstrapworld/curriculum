...
[.lesson-instruction]
Turn to @worksheet-link{pages/design-recipe-1.adoc} in your Student Workbook, and read the word problem at the top of the page.
...
=== Investigate
[.lesson-instruction]
Turn to @worksheet-link{pages/design-recipe-2.adoc}, and use the Design Recipe to write both of these functions.
