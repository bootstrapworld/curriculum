...
*Note:* the optional lesson @link{../ds-if-expressions, If Expressions} goes deeper into basic programming constructs, using `image-scatter-plot` to motivate more complex (and exciting!) plots.
