...
The two displays below both summarize this table. The display on the left is a *Bar Chart*, the one on the left is a *Histogram*. What is similar about them? What is different?
