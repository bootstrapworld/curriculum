...
@lesson-description{Students identify solutions and non-solutions of inequalities using an interactive starter file. This lesson also reviews the `Boolean` datatype.}
...
@ifproglang{pyret}{
Have students open the @online-exercise{https://code.pyret.org/editor#share=19IaMcM7rl8XXQcA3trz4K1YlPM4Txb4P, Simple Inequalities Starter File.}
}
