...
=== Investigate
@right{@image{images/1b1.gif, "A scatter plot showing a linear (straight-line) relationship", 250}} Some patterns are **linear**, and cluster around a straight line sloping up or down.
...
- OPTIONAL: complete the card sort on @opt-online-exercise{https://teacher.desmos.com/activitybuilder/custom/6018cc371c5b92526b6a96d7, Identifying Direction}.
