...
"Write a function @funname that takes in the days and number of miles driven and returns the cost of renting a truck. The truck is $45 per day and each driven mile is 15¢."
#:headless? #t
