...
If you have more time to devote to piecewise functions, we have two more starter files (as well as pages to support independent student exploration) in @link{#_additional_resources, Additional Resources}.

Optional: Not all piecewise functions are one-to-one! If you're ready to think about Onto Functions, have your students complete @opt-printable-exercise{decide-defend-onto.adoc}.
...
Students will enjoy getting more practice with piecewise functions while using emojis!

* @opt-starter-file{mood-generator}
* @opt-printable-exercise{pages/mood-generator-explore.adoc}
* **Note: Even though emojis look like images, they are actually characters in a string! They can be accessed from your keyboard, just like any other character.**
...
And we have one more program for your students to explore and scaffolded pages to support them through the process!
