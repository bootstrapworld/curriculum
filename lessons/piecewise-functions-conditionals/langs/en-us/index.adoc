...
Give directions to distinct groups of students so that every student ends up with an activity to perform. _If you feel tempted to find another context for your class, remember that it is important that the categories do not overlap! For example, someone could be wearing red and also wearing blue, so we wouldn't want to give imprecise directions based on outfit color._
