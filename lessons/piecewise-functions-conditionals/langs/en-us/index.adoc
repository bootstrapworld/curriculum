...
_If you have more time to devote to piecewise functions or students who are ready to dive deeper, have them work with the @opt-starter-file{mood-generator} using @opt-printable-exercise{pages/mood-generator-explore.adoc}. Students will enjoy getting to use emojis! **Note: Even though emojis look like images, they are actually characters in a string! They can be accessed from your keyboard, just like any other character.**_
