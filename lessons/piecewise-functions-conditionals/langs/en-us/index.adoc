...
Give directions to distinct groups of students so that every student ends up with an activity to perform. You can use one of the options below or write your own. _Remember that it is important that the categories do not overlap! Someone could be wearing red and also wearing blue for example, so we wouldn't want to give directions based on a single color._
...
* If you had eggs for breakfast, make an O with your arms.
* If you didn't eat eggs this morning, make an X with your arms/body.
--
...
_Example Questions: Ask a student waving their arms in the air why they aren't flapping their arms like a chicken.
Ask a student making an X or clasping their hands how they knew what to do._
