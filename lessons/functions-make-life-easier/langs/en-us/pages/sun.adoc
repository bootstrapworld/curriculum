...
@show{(code '(sun (?FITB 10em)))} &rarr; @show{(code '((?FITB 8em) (?FITB 35em)))}
...
@show{(code '(me (?FITB 10em)))} &rarr; @show{(code '((?FITB 8em) (?FITB 35em)))}
...
@show{(code '(gr (?FITB 10em)))} &rarr; @show{(code '((?FITB 8em) (?FITB 35em)))}
