...
What changes in these examples? Name your variable(s): @fitb{}{@ifsoln{_size, color_}}
...
What changes in these examples? Name your variable(s): @fitb{}{@ifsoln{_length, width_}}
