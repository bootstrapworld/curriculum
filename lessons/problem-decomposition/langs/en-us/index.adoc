...
- Every glass sold incurs *costs*... lemons? sugar? powdered drink mix? cups? water?
...
- The bike will cost more than $198 once we add in the tax.
...
@printable-exercise{pages/revenue-and-cost.adoc, revenue and cost}
...
Take a moment to think: What would your first step be if you were trying to figure out how long Jamal would be transit?
