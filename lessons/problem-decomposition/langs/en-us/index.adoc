...
* @link{https://www.wescheme.org/openEditor?publicId=vc8K8Xmlin, Sally's Lemonade Starter File}
}
@ifproglang{pyret}{
* @link{https://docs.google.com/presentation/d/1ftyTDcty0-DLfPwwqv33DYYoSnC0mvwNBWClhO2anzU/, Lesson Slides}
* @link{https://code.pyret.org/editor#share=1VmH2V3ByFOA_-Fwh-IR1dLC_9XIYGc6U&v=8c4da7d, Sally's Lemonade Starter File}
}
