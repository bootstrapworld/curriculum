...
- The total cost of the bike will be depend on the taxrate.
...
Have students work with their partners to develop functions for
@printable-exercise{pages/revenue-and-cost.adoc, revenue and cost}. __Note: The information they need to write the cost function is provided in the design recipe word problem!__
...
Have students complete @printable-exercise{pages/profit.adoc, profit}, using the Design Recipe.
...
////
[.lesson-instruction]
- Which of these four function definitions do you think is "best", and why?
- Did anyone have additional ideas for how to define a _profit_ function?
- If lemons gets more expensive, which way requires the least amount of change?
- Which is the most repurposable option, if, for example, a friend started a cookie stand?
