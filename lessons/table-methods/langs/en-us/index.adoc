...
1. The transformer’s name

2. The domain of the transformer - the type(s) of data we give it

3. The range of the transformer - the type of data the transformer produces
