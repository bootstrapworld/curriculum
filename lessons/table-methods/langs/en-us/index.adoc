...
=== Overview
Students review row definitions, are _introduced_ to Function Definitions in Pyret, and do some open-ended reading and interpreting of code.
...
Explain to the class that the Filter Method will walk from one student to the next, referring to the function (on the card) in order to determine if each student should stand or sit.
