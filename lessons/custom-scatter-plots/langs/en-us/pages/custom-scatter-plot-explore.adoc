...
@n What do you think `species-tag` does? (_Hint: look for its definition in the @starter-file{custom-scatter-plot}!_)
...
@n Think about the plot you expect `image-scatter-plot(animals-table, "pounds", "weeks", species-tag)` will produce. Then click "Run" and type the expression into the Interactions Area to test it out.  Describe the image you see.
