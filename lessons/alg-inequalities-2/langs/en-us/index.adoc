...
`and-intersection( gt5, lt15, [list: -5, -2.1, 0, 5, 10, @math{\frac{39}{5}}, 15, 20] )`

@span{.center}{@image{images/intersection1.png,"" ,""}}

`fun lte5(x): @math{x \le 15} end`

`fun gt15(x): x > 15 end`

`and-intersection(lt5,gt15, [list: -5, -2.1, 0, 5, 10, @math{\frac{39}{5}}, 15, 20] )`
...
`or-union(lt5, gt15, [list: -5, -2.1, 0, 5, 10, 12, 15, 20] )`
...
`or-union(gt5, lt15, [list: -5, -2.1, 0, 5, 10, 12, 15, 20] )`
