...
*Note:* the optional lesson @link{../if-expressions/index.html, If Expressions} goes deeper into basic programming constructs, using `image-scatter-plot` to motivate more complex (and exciting!) plots.
