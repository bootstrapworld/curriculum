...
| _★ When a team has completed these three Design Recipes, they can use @lesson-link{method-chaining/, Method Chaining} to complete the more sophisticated @printable-exercise{data-cycle-1.adoc}._

| _★ When a team has completed these three Design Recipes, they can use @lesson-link{method-chaining/, Method Chaining} to complete the more sophisticated @printable-exercise{data-cycle-2.adoc}._
