...
@lesson-prereqs{method-chaining, advanced-displays, functions-dr}
...
| _★ When a team has completed these three Design Recipes, they can use @lesson-link{method-chaining/}._
