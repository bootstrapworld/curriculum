...
* Function Composition Exploration (@workbook-link{pages/FunctionComposition-WB1.pdf, PDF}, @link{https://docs.google.com/document/d/1eqV4ZlZ4Kaz4v916vCMxq36wtIc-NrkJ3jBCVJopx-c/edit?usp=sharing, Google Doc})

* Function Composition Practice (@workbook-link{pages/FunctionComposition-WB2.pdf, PDF}, @link{https://docs.google.com/document/d/1BRI6mFzdFCzsg-jwLuEfIoyRj_wk_gDFlWG2l8jfu-Q/edit?usp=sharing, Google Doc})
endif::[]
...
* Function Composition Exploration (@workbook-link{pages/FunctionComposition-WB1.pdf, PDF}, @link{https://docs.google.com/document/d/1w5JW1jRRGqGhoZDfBkeKLGogpKRZ6bZXkmNhbjS-Ni8/edit?usp=sharing, Google Doc})
...
Have students open to @workbook-link{pages/FunctionComposition-WB1.pdf, Function Composition - Explore}.  Students create a text @vocab{image} of their name and experiment with their choice of these new functions.
...
== Practice: (10 mins)
Students complete @workbook-link{pages/FunctionComposition-WB2.pdf, Function Composition - Practice}, practicing drawing Circles of Evaluation and writing code with their partner using different functions.
