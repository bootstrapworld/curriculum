...
@printable-exercise{pages/zample-page1.adoc, revenue}, @opt-printable-exercise{pages/zample-page2.adoc, cost}, and @opt-printable-exercise{pages/zample-page3.adoc, profit}, using the Design Recipe.
