...
@printable-exercise{pages/zample1.adoc, revenue}, @printable-exercise{pages/zample2.adoc, cost}, and @printable-exercise{pages/zample3.adoc, profit}, using the Design Recipe.
