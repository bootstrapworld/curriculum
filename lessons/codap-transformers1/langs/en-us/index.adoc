...
There are lots of occasions where we might want to filter out some of the rows of a dataset. In our animals dataset, for example, we might want to filter the table to show only the rows for dogs.
