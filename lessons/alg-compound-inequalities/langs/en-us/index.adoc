...
@ifproglang{wescheme}{
* @link{https://docs.google.com/presentation/d/1YNvlB78yZIghuHqJ41J-GxgLgx8-LqtbsgHKEOQJE5Q/, Lesson Slides}
}
@ifproglang{pyret}{Lesson slides template (@link{https://docs.google.com/presentation/d/1ueHsKhIuoe-L_IoMTTP_SMcVi5jyaN_NXxSh-icq368/, Lesson Slides}
}
...
|
* @online-exercise{https://quizizz.com/admin/quiz/5d9919516dbee7001e08a4a0, Booleans Review - Quizizz}
...
Have students complete @printable-exercise{pages/and-or.adoc}.
...
- @opt-printable-exercise{pages/is-sunny.adoc}
- @opt-printable-exercise{pages/is-beach-day.adoc}
