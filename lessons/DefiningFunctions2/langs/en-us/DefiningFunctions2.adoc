...
* @link{https://code.pyret.org/editor#share=13zlxZnvvQdW-UJVy8FlGOCwpjkiWGT56&v=f1d3c87, Rocket-height} starter file
* Notice & Wonder (@worksheet-link{workbook-pages/NoticeAndWonder.pdf, PDF}, @link{https://docs.google.com/document/d/1hNMUXcMRWgKllc7SOzzqaTR48RiWbXg8RvG9rtl3SuU/edit?usp=sharing, Google Doc})
* Design Recipe (@worksheet-link{workbook-pages/DesignRecipe1.pdf, PDF}, @link{https://docs.google.com/document/d/1GQw-EJAw54BK04SMp_4jPtGGt4IojsUA7oXfz9TRm8Y/view, Google Doc})
* Purpose Statement(3 Reads/Stronger & Clearer) (@worksheet-link{workbook-pages/PurposeStatement3ReadsStrongerClearer.pdf, PDF}, @link{https://docs.google.com/document/d/16xiKkaB6GYUv95ug7-o3QubnmX7oZnm03J1AJTtH_2k/view, Google Doc})
endif::[]
...
* @link{https://teacher.desmos.com/activitybuilder/custom/5d991b421172d473178c981b, Bootstrap Algebra: Design Recipe} (Desmos Activity)
* @link{https://teacher.desmos.com/activitybuilder/custom/5d991b939b9b292020c1810d, Bootstrap Algebra: Design Recipe Practice (Blank Template)} (Desmos Activity)
endif::[]
...
_Number, we can tell by looking at the contract for the function._
...
****
*MLR 6: Three Reads* + 
Students will access the problem statement three times, looking and listening for different relevant information for the function.  Students will document their work in the @worksheet-link{workbook-pages/PurposeStatement3ReadsStrongerClearer.pdf, Three Reads + Stronger and Clearer} worksheet.
...
Using the @worksheet-link{workbook-pages/PurposeStatement3ReadsStrongerClearer.pdf, Three Reads + Stronger & Clearer} worksheet, students will switch partners three times.  The purpose of this exercise is for students to read, listen and comprehend while also improving their own language in their purpose statement.
...
== Practice: (15 min)
Use a @worksheet-link{workbook-pages/DefiningFunctions2-EX2.adoc, Design Recipe} worksheet to write each of the following functions. Make sure to include:
