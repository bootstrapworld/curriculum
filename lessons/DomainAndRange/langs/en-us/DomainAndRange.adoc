...
ifeval::["{proglang}" == "wescheme"]
* @link{https://quizizz.com/admin/quiz/5d9919776c6f17001a9dc6a0, Bootstrap:Algebra - Contracts, Domain/Range, Data Types, & Functions} (Quizizz)
endif::[]
ifeval::["{proglang}" == "pyret"]
...
ifeval::["{proglang}" == "wescheme"]
* @link{https://teacher.desmos.com/activitybuilder/custom/5d991ae71172d473178c9816, Bootstrap:Algebra - Domain and Range Review} (Desmos Activity)
endif::[]
