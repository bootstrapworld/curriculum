...
- For paper-and-pencil practice, complete @opt-printable-exercise{definitions-from-graphs.adoc}
--
...
- For more paper-and-pencil practice, complete  @opt-printable-exercise{defininitions-from-tables.adoc}
--
