...
@ifproglang{pyret}{
* @online-exercise{https://docs.google.com/presentation/d/1NzFh6I3b352ZZKq1YBKNOoiiLEq7lCVPeXwdKBBEgZM/edit?usp=sharing, Lesson Slides}
}
...
- Additional practice with Booleans can be found at @link{../ds-pyret-intro/pages/booleans.html, Booleans}
