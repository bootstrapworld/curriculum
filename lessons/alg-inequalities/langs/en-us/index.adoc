...
This starter file allows students to plot inequalities.  They will generate a list of 8 points for each inequality they want to plot. The goal is to select 4 values that are solutions and 4 values that aren't solutions.  Encourgage students to use negatives, positives fractions and decimals.

The starter file includes an example.  
