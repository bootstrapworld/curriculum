...
Have students log in to the @link{https://code.pyret.org/editor#share=1qoAI2cFSeM7HIrR5L6LzOAX9DlXu9Le1&v=8c4da7d, Boolean Starter File} and open to @exercise-link{boolean-functions.adoc, Boolean Functions.} 
}
