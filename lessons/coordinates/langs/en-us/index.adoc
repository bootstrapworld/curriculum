...
=== Launch
@span{.right}{@image{images/1dPosition.png, "A number line with two circles on it, illustrating the distance between two characters in one dimention"}}
...
@span{.right}{@image{images/2dPosition.png, "A coordinate plane with two axes, and two circles on it, illustrating the distance between two characters in two dimentions"}}
