...
Below is a *640x480 rectangle*, representing your game screen. Label the bottom-left corner as the coordinate (0,0). Then label the other four corners. Then, in the rectangle, sketch a picture of your game!
