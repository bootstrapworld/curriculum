...
* One copy of @worksheet-link{workbook-pages/function-cards.adoc, Function Cards} printed and cut.
...
* Type `name(animalB)` into the Interactions Area. What did you get?
* Type `is-old(animalA)` into the Interactions Area. What did you get?
* Type `is-dog(animalB)` into the Interactions Area. What did you get?
