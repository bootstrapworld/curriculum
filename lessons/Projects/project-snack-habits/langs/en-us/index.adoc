...
- As you work, save any displays of interest to part 3 of your slide deck. It's okay to save more than you will be able to use.
- When you're done:
  * Choose one display to add to slide 6 of your project slide deck to capture your first impressions.
  * Put your @handout{data-cycle-categorical.adoc} somewhere safe because you'll need it to complete our slide deck later on.
}
...
- Look for graphs and statistics...
  * that come from credible sources
  * relate to the kinds of data we're collecting about our snack habits (e.g., time of day, snack flavor, nutrition information, reason for the snack).
}
...
- Did your students have brilliant suggestions for how we could improve the form for future classes? Please share your ideas with us at @link{contact@bootstrapworld.org}!
}
