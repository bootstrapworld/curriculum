...
@lesson-instruction{
- On slides 2 @link{https://docs.google.com/presentation/d/1nnPpgCQDYknyxTzc_dvs34R2szxS3izz2Ya5gpAKDtE/copy, this slide template}, reflect on what you've learned by tracking your snack consumption.
- On slides 3 and 4, reflect on what you Notice and Wonder about the class dataset.
}
...
- Similarly, save any displays that you might use in your project slide deck. It's okay to save more than you will be able to use.
}
