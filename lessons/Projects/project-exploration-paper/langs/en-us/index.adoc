...
@ifproglang{codap}{
@lesson-prereqs{ds-intro, codap-exploring, codap-dot-plots-bar-charts, data-cycle, codap-transformers-1, codap-transformers-2, composing-table-operations, probability-inference, grouped-samples}
}
