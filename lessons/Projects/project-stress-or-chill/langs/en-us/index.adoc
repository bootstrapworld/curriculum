...
@ifproglang{pyret}{
- If you get your students started with the data collection phase of this project and then teach @lesson-link{advanced-displays} while they're building the dataset, they will have a lot more tools for analyzing the data.
}
