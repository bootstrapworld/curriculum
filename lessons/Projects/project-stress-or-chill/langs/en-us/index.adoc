...
In order to generate a collective dataset about our stress levels and possible factors, students will complete a Google form about their stress levels at randomly assinged times of their waking day twice a day for 5 days.
...
@lesson-instruction{
- Use Pyret to do numerical analysis (means, medians, etc.) and to produce data visualizations that will help you to answer your questions.
  * Create filter functions similar to `is-cat` to create subsets.
  * Use if/else programming to create an image-scatter-plot.  Make sure to follow the Design Recipe.
...
- Research teens and stress.
  * Find two interesting facts in the research that relate to our class data and record the sources.
