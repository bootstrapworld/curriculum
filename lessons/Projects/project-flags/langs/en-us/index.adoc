...
went through worked together to create some different flags together. For this project, you will build a flag of your own - one that is important to you - and you'll use what you know about value definitions and function compositions to build it.
