...
* Note that for this project, students must submit: (1) Decomposing Flags, (2) Decomposing My Flag, and (3) a link to my Pyret file. It is up to you whether you collect student work all at once (at the end of the project) or intermittently, after each worksheet has been completed.
