...
@strategy{Two Methods for Building Flags}{

During this project, students often discover a second method of producing flags - a method slightly different than the one that we teach during @lesson-link{transform-compose-images}. Rather than composing functions, some students prefer to define the _layers_ of their flag before arriving at a final outcome.

If you work with students in the earlier grades and / or you are _not_ concerned with teaching @vocab{function composition}, then there is nothing wrong with defining layers! In fact, you might want to model what this process looks like if you think your students will be more successful with it. You know what is best for your students!

Access the starter files below to see these two approaches to building the Puerto Rican flag:

- @starter-file{method-1}
- @starter-file{method-2}
}
...
- @opt-online-exercise{https://teacher.desmos.com/activitybuilder/custom/5fc90f1289c78e0d2a5bccfc, Matching Code to Images using overlay and translate}
}
...
- @opt-online-exercise{https://teacher.desmos.com/activitybuilder/custom/5ff46882e3b4660c751f707e?collections=5fbecc2b40d7aa0d844956f0, Matching Code to Images using overlay and translate}
}}
