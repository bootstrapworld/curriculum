...
@description{Students choose a real world dataset that is interesting to them and are supported in exploring it by creating and interpreting a range of displays. _This project spans up to eight of our Data Science lessons, each of which includes an optional section with project-specific directions. We have built a @lesson-link{choosing-your-dataset/pages/datasets-and-starter-files.adoc, Library of Datasets} to support this project._ }
...
- Students copy, save, and explore the @starter-file{exploration-project}. _Invite them to peruse the slide deck and familiarize themselves it; they'll be revisiting and adding to it often._
