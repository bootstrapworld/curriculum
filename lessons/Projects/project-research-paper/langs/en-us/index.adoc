...
We recommend a full-class walk-through of the slide deck template with interwoven discussion the relevant rubric rows. Teachers are welcome and encouraged to edit and adapt the rubric for their unique classroom context.
}
