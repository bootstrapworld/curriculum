...
- In small groups, share and discuss the questions that you find most interesting. Let your peers share their gut reactions to your questions, then discuss the advantages and disadvantages of pursuing each question.
...
If you are requiring your students to submit a written report, offer guidance on how they might use their slide deck to structure their writing. You can also share with students @starter-file{research-paper, "this template"}.
