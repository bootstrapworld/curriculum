...
@n Choose specific @link{https://pyret.org/docs/latest/color.html, " colors"} for your logo! If something is "tomato" or "chocolate", draw an area to the appropriate region and label it with the color's name.
