...
@lesson-instruction{
- On @handout{design-your-logo.adoc} (or on a separate sheet of paper) sketch your logo. Choose @ifproglang{pyret}{@link{https://pyret.org/docs/latest/color.html, "appropriate colors"}} for each region of your logo.
