...
- Draw 2 additional (different) Circles of Evaluation for @math{2 + 3 + 6}. You may change the order or groupings of the numbers, the Circle must evaluate to the same result.
}
