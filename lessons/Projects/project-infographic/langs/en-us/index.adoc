...
@teacher{
There are a number of options for the data that might be the basis of your students' infographics. Make sure you've read the options provided in the Preparation section and have a plan.
...
@lesson-instruction{
Before we get to work designing our infographics, let's think through one example together. *(Fictional)Ratio Statement: 40% of pilots surveyed wear glasses.* 
}
...
@lesson-instruction{
- A tricky thing about making infographics with images of people is that not all images accurately represent the diversity of the communities described by the statistics. For example, 
  * We wouldn't want to make an infographic about pilots just using pictures of white men. There are lots of pilots who aren't white men and we don't want to imply otherwise!
  * It would also be problematic to represent this ratio using two images of men wearing glasses and three images of women not wearing glasses. People might think that we were trying to communicate that female pilots have better vision than male pilots!
- A good strategy for avoiding these pitfalls in infographics is to use silhouettes. 
  ...
  * Not all silhouettes feel like they are generically of people, but if you look, you'll find images that read braodly.
}

It's time to get to work designing an infographic.
