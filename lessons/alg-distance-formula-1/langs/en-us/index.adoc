...
//* Frayer Model (@workbook-link{pages/FrayerModel.pdf, PDF}, @link{https://docs.google.com/drawings/d/1mCJygY5elVQzy64zLLRyFVZ9-CkTnVYTBM3URnIfzEc/view, Google Doc})

* Design Recipe: distance (@workbook-link{pages/DistanceFormula1-WB1.adoc, original})

ifeval::["{proglang}" == "wescheme"]
* Design Recipe: collide? (@workbook-link{pages/DistanceFormula1-WB2.adoc, original})
endif::[]
ifeval::["{proglang}" == "pyret"]
* Design Recipe: is-collision (@workbook-link{pages/DistanceFormula1-WB2.adoc, original})
endif::[]
...
//Optional: Have students use this @workbook-link{pages/FrayerModel.pdf, Frayer Model} to model the distance formula with the Circles of Evaluation and translate it to code. +
{empty} +
