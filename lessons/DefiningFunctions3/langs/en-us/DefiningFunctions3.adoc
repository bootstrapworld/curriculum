...
* Design Recipe worksheet (@workbook-link{pages/DesignRecipe1.pdf, PDF}, @link{https://docs.google.com/document/d/1GQw-EJAw54BK04SMp_4jPtGGt4IojsUA7oXfz9TRm8Y/view, Google Doc})
...
Students will use the @workbook-link{pages/PurposeStatement3ReadsStrongerClearer.pdf, Purpose Statement organizer} and the @workbook-link{pages/DesignRecipe1.pdf, Design Recipe} worksheets to work through different problems from @workbook-link{pages/DefiningFunctions3-WordProblems.pdf, Solving Word Problems}.
