...
* Fast Functions worksheet (@worksheet-link{pages/FastFunctions1.pdf, PDF}, @link{https://docs.google.com/document/d/1zxq7TYX76y6DFwdF2DCuN1nnLAmbD33Sua1QhhmOYH8/edit?usp=sharing, Google Doc})
* Circles of Evaluation Mapping worksheet (@worksheet-link{pages/MappingExamplesWithCoE1.pdf, PDF}, @link{https://docs.google.com/document/d/1EDLbNC9C62Z-kf9jGZzbaRRRj8Ni_Gbz2f14kp30COU/edit?usp=sharing, Google Doc})
...
* Have students complete the @worksheet-link{pages/MappingExamplesWithCoE1.pdf, Circle of Evaluation mapping} worksheet.
...
* Complete the @worksheet-link{pages/FastFunctions1.pdf, Fast Functions} worksheet for the `gold-star` example.
