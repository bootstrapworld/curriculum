...
[.lesson-instruction]
Take a look at the two examples on @printable-exercise{pages/distance-comparing-code.adoc}. There's a subtle difference between the two examples! What is it? Once you see what's going on, try writing code of your own by completing .
