...
@ifproglang{wescheme}{
* @link{https://docs.google.com/presentation/d/1CY3W9J2DCATJZy8yBl15RpZBEaCOqXHrczeCA4qDocw/, Lesson Slides}
}

@ifproglang{pyret}{
* @link{https://docs.google.com/presentation/d/17J2hWLZzttQEzEXDy0FJZoJWFvOyw8v3G6kpeTHmDWA/, Lesson slides} 
}
@material-links
...
For more practice with the Pythagorean theorem, have students work with @opt-printable-exercise{pages/distance-in-games.adoc}. Students are given screenshots of games with the _distance triangles_ revealed and have to write code to find a missing side. _Note: For some of these problems students are not finding the hypotenuse of the triangle!_ 

For more practice writing code to find the distance between two coordinates, have students work with @opt-printable-exercise{pages/distance-from-game-coordinates.adoc}.
