...
For each of the graphs and tables below, circle whether it is linear, non-linear, or has no pattern at all. Don't forget: __some tables may have their rows out of order!__
