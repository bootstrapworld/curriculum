...
@span{.right}{@image{images/hopper.jpg, "Grace Hopper", 200}} In the 1940s, computers weren't made from tiny microprocessors. They were made from large wires, vacuum tubes, gears and dials. In 1946, the legendary programmer Grace Hopper (shown here) had a problem. She was certain that her code was right, but for some reason it wasn't running correctly.
@span{.clear}{}@span{.right}{@image{images/bug.jpg, "First Computer Bug", 200}} She traced the wires and relays, and eventually found that a _moth_ that had gotten stuck and electrocuted! By disrupting the parts of the computer, it was causing the program to run incorrectly, and produce unexpected results! She wrote her findings into her notes, and even included the body of the moth. *This moth is the origin of the term "bug" in programming.*

Knowing how find and fix bugs is a valuable skill for any programmer, and the kind of logical thinking you gain by fixing errors can help you find mistakes _outside_ of a prgram as well!
...
- Open @starter-file{bug-hunting}, and see if you can fix all of the syntax errors in the file!
...
[.lesson-point]
Syntax Errors prevent the computer from _running_ code
...
[.lesson-instruction]
In pairs or small groups, complete @printable-exercise{pages/logic-errors.adoc},  @printable-exercise{pages/logic-errors-2.adoc}, and @printable-exercise{pages/logic-errors-2.adoc}.
