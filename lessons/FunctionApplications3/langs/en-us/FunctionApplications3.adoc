...
function models for
@workbook-link{pages/FunctionApplications3-WB1.adoc,
revenue},
@workbook-link{pages/FunctionApplications3-WB2.adoc,
cost}, and
@workbook-link{pages/FunctionApplications3-WB3.adoc,
