...
* Design Recipe: revenue (@worksheet-link{workbook-pages/FunctionsApplications3-WB1.adoc, PDF})
* Design Recipe: cost (@worksheet-link{workbook-pages/FunctionsApplications3-WB2.adoc, PDF})
* Design Recipe: profit (@worksheet-link{workbook-pages/FunctionsApplications3-WB3.adoc, PDF})
