...
Complete both of the Data Cycles shown here, which have starter questions already defined.
...
@hspace{1em} +a.+ What question do you have? @fitb{20em}{What is the mean age for cats at the shelter?}
...
|
// wrap this in +...+ so that asciidoctor doesn't try to manage lists for us
@hspace{1em} +a.+ What question do you have? @fitb{20em}{How long does a typical animal take to be adopted?}
