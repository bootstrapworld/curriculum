...
- 
@exercise-link{pages/purple-star.adoc, Define a function `purple-star`, that takes in the size of the star and produces an outlined, purple star of the given size.}

- 
@exercise-link{pages/spot.adoc, Define a function `spot`, that takes in a color and produces a solid circle of radius 50, filled in with that color.}

- 
@exercise-link{pages/average.adoc, Define a function `average`, which takes in two numbers and produces their average.}

-  
@exercise-link{pages/examples-same-contracts1.adoc, Do Examples Have the Same Contracts?} 

- 
(@exercise-link{pages/examples-same-contracts2.adoc, Do Examples Have the Same Contracts? (2)} 

- 
(@exercise-link{pages/match-contracts-examples1.adoc, Matching Contracts and Examples} 

- 
(@exercise-link{pages/match-contracts-examples2.html, Matching Contracts and Examples (2)} 
