...
_★ There is a large collection of math problems that would work well with the Design Recipe in our @lesson-link{lessons/functions-dr, Solving Word Problems Using the Design Recipe} lesson._
