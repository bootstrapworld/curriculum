...
"Ava loves purple rectangles that are 5 times as long as they are tall. Help her out by writing a function that takes in a width and generates a solid rectangle that Ava would love."
#:headless? #t
#:domain-list '(Number)
#:range "Image"
