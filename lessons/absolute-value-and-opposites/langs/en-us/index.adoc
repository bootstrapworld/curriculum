// CREATE ANOTHER LESSON FOR THIS LESSON:
// ABS AND OPPOSITES, PART 2:
// (1) TRANSLATING EXPRESSIONS WITH ABS VALUE AND OPPOSITE -- use stuff from the translating lesson!
