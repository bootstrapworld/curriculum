...
- Have students complete @printable-exercise{pages/match-tables-graphs.adoc} and/or @online-exercise{https://teacher.desmos.com/activitybuilder/custom/5fc25d458dcfcf0b92021b13, "Matching Tables to Graphs"}. We recommend challenging them to match tables and graphs with shuffled rows on @opt-printable-exercise{pages/match-tables-graphs2.adoc}.
...
* Who can remember how to tell whether or not a graph represents a function? _It has to pass the vertical line test!_
--

Have students complete @printable-exercise{linear-nonlinear-bust.adoc} and perhaps also @opt-printable-exercise{linear-nonlinear-bust-graphs.adoc}.
...
Fortunately, a *function definition* can be used to summarize an entire table or graph by putting the @vocab{slope} and @vocab{y-intercept} front-and-center!

Let's take a look at how function definitions compare using function notation and code.
...
The *slope-intercept form of the line* includes the slope as the coefficient of x and the y-intercept as the number being added (or subtracted).  It is often desribed as @math{y = mx + b}, where @math{m} stands for slope and @math{b} stands for the y-intercept.

@ifproglang{pyret}{
@image{images/slope-and-y.png, slope and y}}

Sometimes, when the slope and/or y-interecept equal zero, one of these two terms will not be included in the definition, but both terms are always implied.

When the slope is zero (and the line is horizontal)... we may choose whether or not write the slope term.
...
When the y-intercept @math{0} (and the line crosses the y-axis at the origin)... we may choose whether or not to write the slope term.
...
- Have students complete @printable-exercise{slope-and-y-def.adoc}

*Let's get some practice connecting Definitions to Graphs*

- Have students complete @printable-exercise{match-definitions-graphs.adoc}
& @printable-exercise{definitions-from-graphs.adoc}
and/or @online-exercise{https://teacher.desmos.com/activitybuilder/custom/5fbe72167f5cee0d57130b96, "Matching Graphs and Definitions of Linear Functions"} & @online-exercise{https://teacher.desmos.com/activitybuilder/custom/5fbe7b4cf278460cdbd34bc8, "Matching Graphs and Definitions of Linear Functions 2"}
...
- Have students complete @printable-exercise{match-definitions-tables.adoc}, @printable-exercise{definitions-from-tables.adoc} and/or @online-exercise{https://teacher.desmos.com/activitybuilder/custom/5fc24d7d7768970b95efa813, "Matching Tables and Definitions"}
...
- Have students complete @online-exercise{https://teacher.desmos.com/activitybuilder/custom/5fbe74ac877d890d3e1a49cc?collections=5fbe7484d81cab0ca7a8bcfb, "Matching Function Definitions, Tables and Graphs"} and possibly also @online-exercise{https://teacher.desmos.com/activitybuilder/custom/5fbe782a6dcb980d4c87b78d?collections=5fbecc2b40d7aa0d844956f0, "Matching Linear Functions, Tables and Graphs 2"}
