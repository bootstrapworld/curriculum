...
Have students turn to Part 1 of @printable-exercise{notice-wonder-linearity.adoc} and notice and wonder about this table and graph.
...
Have students turn to Part 2 of @printable-exercise{notice-wonder-linearity.adoc} and consider the questions about these two data tables.
...
[.lesson-instruction]
- Let's get some practice connecting tables and graphs on @printable-exercise{pages/match-tables-graphs.adoc} _and/or with @online-exercise{https://teacher.desmos.com/activitybuilder/custom/5fc25d458dcfcf0b92021b13, "Matching Tables to Graphs"}._
...
[.lesson-instruction]
--
* Try extending the second table and filling in the missing points to find the slope and y-intercept.
[.sideways-pyret-table]
|===
...
But, we have to take the first x-coordinate from the same point we take the first y-coordinate from or we'll end up with the opposite and wrong slope, in this case @math{\frac{56 - 5}{3 - 20} = \frac{51}{-17} = -3}.
...
_We'll talk about how to find the y-intercept in the Defining Linear Functions lesson._
...
* Which represenation do you feel more confident finding the y-intercept from? Why?
...
* "As the number of people visiting the amusement park goes up, the time we spend waiting in line goes up."
* "The more we drive, the more gas we use."
* "The more Carlo babysits, the more money he earns."
* "As the number of lizards in the house goes up, the number of cockroaches in the house goes down."
