...
@ifproglang{wescheme}{
Open the @link{https://www.wescheme.org/view?publicId=0elP8WrmfM, “Sam the Butterfly”} starter file and click “Run”. __(Hi, Sam!)__
}

@ifproglang{pyret}{
Open the @link{https://code.pyret.org/editor#share=1YSPPa4BLhOG7_qhWdqQ-cG1u3yUUi-zZ, “Sam the Butterfly”} starter file and click “Run”. __(Hi, Sam!)__
}
