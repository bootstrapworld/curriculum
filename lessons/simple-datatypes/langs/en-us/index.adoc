...
@lesson-description{Students begin to program in @ifproglang{pyret}{Pyret} @ifproglang{wescheme}{WeScheme}, explorings how Numbers, Strings, Booleans and operations on those data types work in this programming language.}
