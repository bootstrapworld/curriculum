...
@ifproglang{wescheme}{
* @link{https://www.wescheme.org/openEditor?publicId=jvWT8h7pLc, Boolean Starter File} 
* Lesson Slides
}
...
- Turn to @excercise-link{pages/booleans-first-intro.adoc} and use the starter file to complete the questions.
