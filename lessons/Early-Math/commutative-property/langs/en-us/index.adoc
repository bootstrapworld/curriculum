...
@teacher{There is a good chance your students will want to play with and explore @show{(code 'blend-images)}. Please not that color blending in @proglang does not behave exactly as it would in the real world!}
