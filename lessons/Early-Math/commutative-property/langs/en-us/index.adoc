...
@lesson-instruction{
- Turn to @printable-exercise{commutativity-and-code-images.adoc}.
...
In the last activity, we discovered that _none_ of the functions on the page were commutative! Do you think there are any functions in @proglang that are commutative? Let's answer that question.

@lesson-instruction{
- Turn to @printable-exercise{commutativity-and-code-num-string.adoc}, where we will test four additional functions for commutativity.
- With your partner, make a prediction about whether each function is commutative.
- Complete the Circles of Evaluation and code, then test the code in @proglang.
}
