...
For each Circle of Evaluation, apply the Commutative Property as many times as you can.

[.FillVerticalSpace,cols=".^1a,^.^6a,^.^6a,^.^6a,^.^6a", stripes="none", options="header"]
|===
|	 | Begin with this Circle of Evaluation. | Apply the Commutative Property. | Apply it another way. | Apply it another way?
