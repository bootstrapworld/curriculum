...
* Use the structure of expressions to determine whether they are equivalent.
...
After students have shared their observations and wonderings, begin a conversation about
...
- Finally, examine the Circles to decide @printable-exercise{which-one-doesnt-belong.adoc} Be sure to explain your thinking.
...
- Examine each of the Circles to decide @printable-exercise{which-one-doesnt-belong-variables.adoc}. Be sure to explain your thinking.
