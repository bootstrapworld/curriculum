...
- On @printable-exercise{variables-and-code.adoc}, record what you Notice and what you Wonder about the starter file.
...
@lesson-instruction{
- Return to your @starter-file{} and click on the "Run".
- Respond to Q? to Q? on @printable-exercise{variables-and-code.adoc}.
