...
@n Are there any sets of values for `a` and `b` that will cause example 3 to fail, but not example 4? If so, list them here: @fitb{}{}


@n Are there any sets of values for `a` and `b` that will cause example 1 or example 2 to fail? If so, list them here: @fitb{}{}
