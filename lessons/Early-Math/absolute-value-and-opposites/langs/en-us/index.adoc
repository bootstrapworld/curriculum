...
@vocab{Functions} are very similar to operators... except that functions can have _any number_ of inputs - and all kinds of inputs!  If you've completed any of the programming explorations so far, then you are familiar with a wide variety of functions: `scale`, `rotate`, `beside`, etc.
