...
=== Overview
Students match Circles of Evaluation to @vocab{mathematical expressions}, and then they consider how mathematical expressions in words map onto Circles of Evaluation.
...
** _Note: In Part 1, the same nested Circle is used in multiple expressions. In Part 2, the structure of the Circles of Evaluation shift from expression to expression._
