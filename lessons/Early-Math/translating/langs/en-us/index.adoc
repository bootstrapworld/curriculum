...
This second set of cards includes @vocab{_Circles of Evaluation_}. Broadly, Circles of Evaluation will help students to visualize the structure of the mathematical expressions they encounter. For the time being, here’s what students need to know about Circles of Evaluation:
...
- *Order of terms*. Although 15 + 3 and 3 + 15 both evaluate to 18, each of these are unique expressions.
