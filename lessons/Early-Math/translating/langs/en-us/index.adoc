...
[.lesson-instruction]
Reinforce what you’ve learned so far by completing @printable-exercise{practice-translating.adoc} and @printable-exercise{words-to-circles-matching.adoc}.
...
[.lesson-instruction]
- Complete @printable-exercise{words-to-circles-two-operators.adoc}.
- Then, translate in the __other__ direction on @printable-exercise{circles-to-words-two-operators.adoc}.
...
- Optional: Try @opt-printable-exercise{math-to-words-matching.adoc}, where you will match mathematical expressions with their corresponding expressions in words without the Circles included to help you. (If you get stuck, feel free to draw your own!)
