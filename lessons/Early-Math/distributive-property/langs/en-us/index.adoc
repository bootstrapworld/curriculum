...
Elise thinks that the Circles are equivalent. She says, "I see 9, 40, and 6 in both Circles. The Circles include the same values, and even the same operations, so they must be equivalent."
