...
[.lesson-instruction]
<<<<<<< HEAD
- Turn to @printable-exercise{discover-assoc.adoc}. Look at the first problem. What do you Notice about the two Circles of Evaluation? How about the two @vocab{expressions} that accompany them? What do you Wonder?
