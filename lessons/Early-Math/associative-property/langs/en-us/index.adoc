...
A note: We view the Associative Property as _the Commutative Property 2.0_! With the Associative Property, students can not only change the order of the values in an expression with addition or multiplication... they can change the _groupings_! _Finding the best groupings, students will discover, sometimes requires changing the order as well._
