...
[cols="^.^5,^.^1,^.^5", stripes="none"]
|===
|@show{(coe  '(+ 24 -21))}      | @math{=}| @show{(coe '(- 24 1))}
|@math{+}    |@math{=}| @ifsoln{@math{-}}
|===

@n What will the first Circle evaluate to? @fitb{5em}{@ifsoln{@math{21}}} @hspace{12em} The second Circle? @fitb{5em}{@ifsoln{@math{3}}}
