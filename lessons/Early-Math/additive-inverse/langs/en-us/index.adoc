...
- Can you think of a way to visually represent that a number and its opposite produce one?
- How would you explain the concept of the additive inverse to another student?
