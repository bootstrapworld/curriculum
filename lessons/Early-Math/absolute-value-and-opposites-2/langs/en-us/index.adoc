...
@teacher{This activity is a card sort, during which students will work with three separate sets of cards: @handout{translating-card-sort.adoc, "Circles of Evaluation"}, @handout{translating-card-sort-2.adoc, "Verbal Expressions"}, and @handout{translating-card-sort-3.adoc, "Arithmetic Expressions"}. Each card sort page includes three sets of card. Make as many copies as needed of each page.}
