...
@lesson-prereqs{associative-property, commutative-property, additive-inverse}
...
In other words, when students see multiplication or division by a @vocab{unit fraction}, there is likely a path forward using mental computation only.
