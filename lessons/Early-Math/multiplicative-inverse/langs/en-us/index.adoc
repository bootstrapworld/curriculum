...
But first, let's play a game. I will draw a two-column table on the board.I will label the left-hand side "Starting Value," and I will label the right-hand side "?"
...
@QandA{
@Q{The first number is @math{\frac{1}{2}}. What do I need to multiply @math{\frac{1}{2}} to get 1?}
@Q{The next number is @math{\frac{1}{3}}. What do I need to multiply @math{\frac{1}{3}} to get 1?}
@Q{How about @math{\frac{1}{100}}?}
@Q{How about @math{10}?}
@Q{Can someone offer me another pair of numbers - a fraction and a whole number - that multiply together to produce 1?}
}
...
@QandA{What did you observe about the multiplicative inverse and its value when doing mental computation?}
...
In other words, when you see multiplication or division by a unit fraction (a fraction with a numerator of @math{1}), there is likely a path forward using *mental computation only*.
...
...but did anyone use a different method?}
...
@lesson-instruction{
- Let's predict! Complete question 1 on @printable-exercise{examples-multiplicative.adoc}. (We'll test these examples in @proglang soon!)
- Let's share out which examples we predicted would fail. What was your rationale?
}
...
@lesson-instruction{
- Let's see if our predictions were correct. Open the @starter-file{multiplicative-inverse} and click "Run".
- With your partner, respond to questions 2 through 3 on @printable-exercise{examples-multiplicative.adoc}.
}
...
@lesson-instruction{
- Complete question 4 on @printable-exercise{examples-multiplicative.adoc}, where you will predict which of five examples will pass in @proglang.
