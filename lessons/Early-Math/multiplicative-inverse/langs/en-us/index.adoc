...
@lesson-instruction{
- Open the @starter-file{multiplicative-inverse}, but *do not click "Run" yet!*
- Let's predict! Complete questions q on @printable-exercise{examples-multiplicative.adoc}.
