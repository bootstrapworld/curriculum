...
=== Overview
Students learn how to apply functions in @proglang, reinforcing concepts from standard Algebra, and practice reading error messages to diagnose errors in code.
