...
=== Overview
Students analyze @vocab{equivalent} @vocab{expressions} with variables, this time integrating their knowledge of the Identity Property.
...
- Now try @printable-exercise{true-or-false-variables-challenge.adoc}. Here, you will again decide if the equation represented by the Circles of Evaluation is true or false - but you will need to apply your knowledge of the Associative Property and the Commutative Property as well!
