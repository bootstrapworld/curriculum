...
@teacher{
Build on prior knowledge by reminding students of the category names that the class created in the @lesson-link{equivalence/#_computation_and_equivalence_duration20_minutes, Equivalence lesson}, and then draw students’ attention to any category names that allude to or suggest some familiarity with the Identity Property. (Any mention of “multiplying by one” or "adding zero" is a strong hint that students’ have clued into the @vocab{Identity Property}!)
}
...
That was a great rehearsal. You're ready for the stage! Now it's the class' turn to give you cues! Who's got an in put for our one of our actors?
...
@Q{What is something we can do to this dog (below) that will _transform_ it... but still result in the *exact same image*?}
}

@right{@image{images/dog.png, 150}}
