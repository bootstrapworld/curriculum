...
- Angela says the Circles are equivalent because of the @vocab{Commutative Property}. Do you agree with Angela?
...
- Evaluate each Circle using @math{m = 5}. Do any of them produce the same outcome? Why or why not?
