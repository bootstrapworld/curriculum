...
@lesson-description{Students describe linear functions in both symbolic form and as a graph, identifying slope and y-intercept in both representations}
...
=== Launch
Take a look at the following linear function, shown as symbols on the left (shown as Pyret code and regular algebra) and a graph on the right:
