...
* Fast Functions worksheet (@printable-exercise{pages/FastFunctions1.pdf, PDF}, @link{https://docs.google.com/document/d/1zxq7TYX76y6DFwdF2DCuN1nnLAmbD33Sua1QhhmOYH8/edit?usp=sharing, Google Doc})
* Circles of Evaluation Mapping worksheet (@printable-exercise{pages/MappingExamplesWithCoE1.pdf, PDF}, @link{https://docs.google.com/document/d/1EDLbNC9C62Z-kf9jGZzbaRRRj8Ni_Gbz2f14kp30COU/edit?usp=sharing, Google Doc})

*Bootstrap Formative Assessments*

* @online-exercise{https://teacher.desmos.com/activitybuilder/custom/5cdcaea0b4b8576069fdca4f, Bootstrap Algebra: Define Values & Fast Functions}

*Connecting Activities*

* @online-exercise{https://teacher.desmos.com/expressions, Expression Bundle} (Desmos Activities)
//* <at-sign> online-exercise{https://teacher.desmos.com/modeling, Mathematical Modeling Bundle} (Desmos Activities)
* @online-exercise{https://quizizz.com/admin/quiz/576d1e5f91cb32ef5fc67529/variables-and-expressions, Variables and Expressions} (Quizizz)
* @online-exercise{https://teacher.desmos.com/functions, Functions Bundle} (Desmos Activities)
Functions & Relations} (Desmos Polygraph Activity)
* @online-exercise{https://quizizz.com/admin/quiz/582b7390e8e0c0c201647d9d/functions, Functions} (Quizizz)
* @online-exercise{https://quizizz.com/admin/quiz/582f0e34b805cc5c6608d326/function-notation, Function Notation} (Quizizz)
...
* Have students complete the @printable-exercise{pages/MappingExamplesWithCoE1.pdf, Circle of Evaluation mapping} worksheet.
...
* Complete the @printable-exercise{pages/FastFunctions1.pdf, Fast Functions} worksheet for the `gold-star` example.
