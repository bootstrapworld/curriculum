...
Students use the options on CODAP's _Measure_ menu to produce displays and plots of the Animals Dataset.
...
Bar charts look a lot like another kind of chart - called a "histogram" - which are actually quite different because they display _quantitative_ data, not categorical. This lesson focuses entirely on bar charts.
