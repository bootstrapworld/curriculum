...
=== Launch
Students open @link{https://code.pyret.org/editor#share=1PTPxKGyUfsMpy4GzFtYS_JGntiHOL0Yu, Animals Starter File -- Unit 2}, save a copy, and click “Run”. This is the same program they've seen before, but with one extra line of code. Ask them which line is new, and what they think it does.
