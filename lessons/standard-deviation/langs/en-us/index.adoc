...
- Turn to @printable-exercise{std-dev-cat-age.adoc}, and complete numbers 1-3.
...
[.lesson-instruction]
--
Complete numbers 4 to 6 of @printable-exercise{std-dev-cat-age.adoc}. Now we need to stretch our visual imagination a bit!
