...
Choose a column from the Animals Dataset, and use the Data Cycle to describe the spread of that column. Once you have your answer, write your findings on the lines below.
...
Write about your findings below:
