...
* @activity-link{https://www.desmos.com/calculator/pbm9nxr2rd, Ninja Cat Desmos graph}
...
=== Launch
In pairs, have students explore the @activity-link{https://www.desmos.com/calculator/pbm9nxr2rd, Ninja Cat Desmos graph}.
