...
- Explain, Understand, Define, describe how "works together", should explicitly include the enduring understanding we expect students to articulate.
...
=== in slide and  self-guide
@slidebreak{Synthesize}

in slide and in self guide

=== only in slide not in self-guide
@slideonlybreak{Synthesize}

only in slide not in self guide

=== only in selfguide not in slide
@selfguidedbreak{Synthesize}

only in self guide not in slide
...
Want to check student mastery of the content you've just taught? Administer @assessment{sample-quiz}.
