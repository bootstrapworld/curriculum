...
@scrub{
@htmlverb{<input type="button" value="Click here" onclick='addToEditor(\` sample-logo-1 \`)' />} to add `sample-logo-1` to the editor.

@htmlverb{<input type="button" value="Click here" onclick='addToEditor(\` sample-logo-2 \`)' />} to add `sample-logo-2` to the editor.

@htmlverb{<input type="button" value="Click here" onclick='addToEditor(\` sample-logo-3 \`)' />} to add `sample-logo-3` to the editor.
}
}
