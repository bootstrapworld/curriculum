...
| Preparation
|
* If a gallery walk works for your students, print a set of @link{pages/computing-pioneers.html, Pioneers in Computing and Mathematics Posters}. If this isn't feasible for your class, figure out what structure you will use to engage students with these pioneers.
