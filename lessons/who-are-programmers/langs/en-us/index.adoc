...
=== Investigate
_Assuming that you have printed and hung posters of @online-exercise{bootstrapworld.org/materials/latests/en-us/who-are-programmers/pages/computing-pioneers.html, Pioneers in Computing and Mathematics} for a gallery walk..._
