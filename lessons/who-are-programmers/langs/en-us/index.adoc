...
| Preparation
|
* If a gallery walk works for your students, print a set of Pioneers in Computing and Mathematics Posters. If this isn't feasible for your class, figure out what structure you will use to engage students with  @link{pages/pioneers.html, these pioneers}.
...
=== Investigate
_Assuming that you have printed and hung posters of @online-exercise{computing-pioneers.adoc, Pioneers in Computing and Mathematics} for a gallery walk..._
