...
@right{@image{images/AnalyzeData.png, "Analyze Data icon", 150}} Now that you're comfortable making pie and bar charts in Pyret, let's talk about how to use those categorical visualizations in our Data Cycle.
...
- Do you expect those steps to match all of the time? Why or why not?
