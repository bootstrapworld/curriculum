...
What does it mean for data to be clean? What does it mean for data to be dirty? Humans make mistakes, and that can happen when we are collecting data or entering data. Either way, the result is dirty data...and there is a _lot_ of dirty data out there that Data Scientists have to deal with!
