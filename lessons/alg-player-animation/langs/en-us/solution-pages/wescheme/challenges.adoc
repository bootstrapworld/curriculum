...
`(EXAMPLE (update-player`@fitb{40ex}{_128  "t"_}`)` 	@fitb{20ex}{_375_} `)`

@vspace{1ex}

`(EXAMPLE (update-player`@fitb{40ex}{_128  "b"_}`)` 	@fitb{20ex}{_125_} `)`
...
`(EXAMPLE (update-player`@fitb{40ex}{_480 "up"_}`)` 	@fitb{20ex}{_480_} `)`

@vspace{1ex}

`(EXAMPLE (update-player`@fitb{40ex}{_0 "down"_}`)` 	@fitb{20ex}{_0_} `)`
...
`(EXAMPLE (update-player`@fitb{40ex}{_490 "up"_}`)`		@fitb{20ex}{_0_} `)`
...
`(EXAMPLE (update-player`@fitb{40ex}{_-391 "h"_}`)` 	@fitb{20ex}{_(* -391 -1)_} `)`
