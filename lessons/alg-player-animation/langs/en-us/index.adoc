...
* Design Recipe: update-player (@workbook-link{pages/update-player.adoc})
...
Have students complete at least one of the @workbook-link{pages/challenges.adoc, update-player challenges} before turning to their computers.
