...
If time permits, have students practice solving other algebra word problems using the Fast Functions sections on @link{pages/fast-funs.adoc, Fast Functions} in their workbook.