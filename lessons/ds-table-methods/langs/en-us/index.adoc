...
* All students should log into @link{https://code.pyret.org, CPO} and open the @link{https://code.pyret.org/editor#share=1KNye47iX_SCRXpMdRiCGdvOQuRFabFHn, Table Methods Starter File}
...
=== Launch
Let's see how much you remember about function definitions! Load the @link{https://code.pyret.org/editor#share=1KNye47iX_SCRXpMdRiCGdvOQuRFabFHn, Table Methods Starter File}, go to the File menu, and click "Save a Copy". 

=== Investigate
[.lesson-instruction]
* Students load the @link{https://code.pyret.org/editor#share=1KNye47iX_SCRXpMdRiCGdvOQuRFabFHn, Table Methods Starter File}, save a copy, and click "Run". 
