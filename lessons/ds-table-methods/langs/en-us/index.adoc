...
* All students should log into @link{https://code.pyret.org, CPO} and open the @link{https://pyret-horizon.herokuapp.com/editor#share=1KNye47iX_SCRXpMdRiCGdvOQuRFabFHn, Table Methods Starter File}
* One copy of @workbook-link{pages/function-cards.adoc, Function Cards} printed and cut.
...
=== Launch
Let's see how much you remember about function definitions! Load the @link{https://pyret-horizon.herokuapp.com/editor#share=1KNye47iX_SCRXpMdRiCGdvOQuRFabFHn, Table Methods Starter File}, go to the File menu, and click "Save a Copy". 
...
@link{pages/what-table-do-we-get.adoc, What table do we get?}
