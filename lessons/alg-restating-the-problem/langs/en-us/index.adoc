...
- @workbook-link{dr-neg-slope-1.adoc, Design Recipe: Linear Relationships (2)}
- @workbook-link{dr-neg-slope-2.adoc, Design Recipe: Linear Relationships (3)}
- @workbook-link{dr-geometry-rectangles.adoc, Design Recipe: Geometry - Rectangles}
- @workbook-link{dr-geometry-rectprism.adoc, Design Recipe: Geometry - Rectangular Prisms}
...
* @exercise-link{pages/dr-slope-intercept-2.adoc, Design Recipe: Linear Relationships (2)} 

* @exercise-link{pages/dr-slope-intercept-3.adoc, Design Recipe: Linear Relationships (3)} 
