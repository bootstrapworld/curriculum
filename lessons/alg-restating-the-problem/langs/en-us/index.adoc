...
* @exercise-link{pages/dr-cylinder.adoc, Design Recipe Practice: Cylinders} 

* @exercise-link{pages/dr-nonlinear.adoc, Design Recipe Practice: Surface Area of Prisms +} 

* @exercise-link{pages/dr-neg-slope.adoc, Design Recipe Practice: Negative Slope} 

* @exercise-link{pages/dr-neg-slope-2.adoc, Design Recipe Practice: Negative Slope (2)} 

* @exercise-link{pages/design-recipe-7.adoc, Design Recipe Practice (7)} 

* @exercise-link{pages/design-recipe-8.adoc, Design Recipe Practice (8)} 

* @exercise-link{pages/design-recipe-9.adoc, Design Recipe Practice (9)}
