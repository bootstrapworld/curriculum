...
* Word Problem Prompts (@exercise-link{pages/minimum-wage.adoc, HTML})
* Word Problem Prompts (@exercise-link{pages/marquee.adoc, HTML})
* Word Problem Prompts (@exercise-link{pages/moving.adoc, HTML})
* Word Problem Prompts (@exercise-link{pages/num-cube.adoc, HTML})
* Word Problem Prompts (@exercise-link{pages/rideshare.adoc, HTML})
* Word Problem Prompts (@exercise-link{pages/split-tab.adoc, HTML})
* Word Problem Prompts (@exercise-link{pages/circle-area.adoc, HTML})
* Word Problem Prompts (@exercise-link{pages/tip-calculator.adoc, HTML})
