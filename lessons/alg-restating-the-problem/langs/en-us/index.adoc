...
* @printable-exercise{pages/dr-slope-intercept-2.adoc, Design Recipe: Linear Relationships (3)} 

* @printable-exercise{pages/dr-slope-intercept-3.adoc, Design Recipe: Linear Relationships (4)} 