...
@ifproglang{wescheme}{
* @link{https://docs.google.com/presentation/d/19EBCxhhcbrT5GISLamjAHDwJmeGHznbFGH3RdocFZpM/edit?usp=sharing, Lesson Slides}
}
@ifproglang{pyret}{
* @link{https://docs.google.com/presentation/d/1IfRqUq_mfnmBdT55wen4gNBD0jyCqMpGl11VLZV76-s/edit?usp=sharing, Lesson Slides}
}
