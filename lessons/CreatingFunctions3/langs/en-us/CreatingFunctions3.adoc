...
Students should have their workbook and contracts page, a pencil, and their computers with a @link{https://www.weschem.org, WeScheme} tab that they're logged into.
