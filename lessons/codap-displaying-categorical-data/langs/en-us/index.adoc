...
- When did the `measure` menu appear? _This menu appears when there is an opportunity to change what is shown along with the points - for instance, connecting lines, a regression line, or a count_
...
In this section, students will develop a methodical approach to creating displays. First, demonstrate how to create a bar chart showing the `sex` breakdown of the animals. To do this, model asking yourself the following questions:

- Which attributes on which axes?
- What type of data?
- What configuration?

We encourage you to narrate your thinking as you guide students through completing this @printable-exercise{pages/plot-practice.adoc} worksheet.

[.lesson-instruction]
Now, complete @printable-exercise{pages/plot-practice-2.adoc}. For an extension, try @printable-exercise{pages/plot-practice-3.adoc}.
