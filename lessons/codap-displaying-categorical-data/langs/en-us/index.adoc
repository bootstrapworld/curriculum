...
[@lesson-intro-table]
|===
@lesson-prereqs{codap-simple-data-types}
| Lesson Goals
...
We encourage you to narrate your thinking as you guide students through completing this @printable-exercise{pages/plot-practice.adoc} worksheet, to support students in learning how to pose productive questions when looking at data.
