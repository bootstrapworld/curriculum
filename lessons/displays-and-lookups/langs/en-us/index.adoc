...
=== Launch
Have students open their saved Animals Starter File (or make a @link{https://code.pyret.org/editor#share=1lGjndLCWSEoIrV3ErZMXSn_-xakqGvrK, new copy}), and click “Run”.
