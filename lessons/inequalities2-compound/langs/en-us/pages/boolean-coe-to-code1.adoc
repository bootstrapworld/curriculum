...
For each Circle of Evaluation on the left-hand side, write the Code for the Circle on the right-hand side. @ifsoln{Solutions with additional (correct) parentheses are acceptable, also.}
