...
*code:* @fitb{102ex}{`histogram(random-rows(animals-table, 20), "weeks", 2)`}
...
*code:* @fitb{102ex}{`scatter-plot(random-rows(animals-table, 15), "species", "age", "weeks")`}
...
*code:* @fitb{102ex}{Student answers will vary}
