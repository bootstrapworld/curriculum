...
@hspace{1em} +a.+ What question do you have? @fitb{20em}{How many of each species *are fixed* at the shelter?}
...
|
// wrap this in +...+ so that asciidoctor doesn't try to manage lists for us
@hspace{1em} +a.+ What question do you have? @fitb{20em}{Are there more female cats than male cats at the shelter?}
