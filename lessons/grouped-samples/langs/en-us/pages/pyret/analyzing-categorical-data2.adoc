...
|
@fitbruby{100%}{How many of each species are fixed at the shelter?}{What question do you have?}
...
| @image{../images/AskQuestions.png, "Ask Questions icon"}
|
@fitbruby{100%}{Are there more female cats than male cats at the shelter?}{What question do you have?}
