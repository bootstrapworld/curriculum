...
[.lesson-instruction]
- Turn to @worksheet-link{pages/design-recipe.adoc}, and write the functions you see there. When you’re ready, type the contracts, purpose statements, examples and definitions into the Definitions Area.
...
[.lesson-instruction]
Have students complete @worksheet-link{pages/summarizing-columns.adoc}.

The display on the left side of @worksheet-link{pages/summarizing-columns.adoc} is a @vocab{Bar chart}. 
...
[.lesson-instruction]
Turn to @worksheet-link{pages/making-histograms.adoc}, and try drawing a histogram from a dataset.
