...
_If all linear relationships can be shown as points on a graph, does that mean all graphs are linear?_
...
_If all linear relationships can be shown as tables, does that mean all tables are linear?_
