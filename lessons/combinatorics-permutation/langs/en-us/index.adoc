...
@span{.center}{@image{images/6-1-course-permute-w-replacement.png, 6 1 course permute with replacement}}
...
@span{.center}{@image{images/6-2-course-permute-w-replacement.png, 6 2 course permute with replacement}}
...
@span{.center}{@image{images/4-1-course-permute-wo-replacement.png, 4 1 course permute without replacement}}
...
@span{.center}{@image{images/4-2-course-permute-wo-replacement.png, 4 2 course permute without replacement}}
...
@span{.center}{@image{images/4-4-course-permute-wo-replacement.png, 4 4 course permute without replacement}}
