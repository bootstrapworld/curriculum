...
2) How many different permutations are there for these ice cream cones? @fitb{10ex}{@math{permute\mbox{-}w\mbox{-}replace(4, 2) \times 3 = 4^2 \ times 3 = 48}}
...
4) How many different permutations are there for these ice cream cones? @fitb{10ex}{@math{permute\mbox{-}wo\mbox{-}replace(4, 2) \times 3 = \frac{4!}{(4 - 2)!} \ times 3 = 48}}
