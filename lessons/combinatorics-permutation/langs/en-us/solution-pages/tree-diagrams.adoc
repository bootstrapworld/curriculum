...
2) How many different permutations (with replacement) are there for these mugs? @fitb{10ex}{@math{permute\mbox{-}w\mbox{-}replace(5, 2) = 5^2 = 25}}
...
4) How many different permutations (without replacement) are there for these mugs? @fitb{10ex}{@math{permute\mbox{-}no\mbox{-}replace(5, 2) = \frac{5!}{(5 - 2)!} = 20}
