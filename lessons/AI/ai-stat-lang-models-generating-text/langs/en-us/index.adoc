...
Using computers to process languages, often by consuming a corpus and constructing a model, is referred to as @vocab{Natural Language Processing}. In this lesson, we will explore in greater detail what exactly @vocab{Natural Language Procsesing} entails.
