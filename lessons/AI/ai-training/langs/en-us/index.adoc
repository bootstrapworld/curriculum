...
@Q{How is the `bow-similarity` plagiarism detector different from our primitive `simple-similarity` plagiarism detector?}
@A{The `bow-similarity` plagiarism detector compares two bag-of-words summaries, rather than simply comparing two texts.}


@Q{How is the `bow-similarity` plagiarism detector similar to our primitive `simple-similarity` plagiarism detector?}
