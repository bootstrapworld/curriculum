...
@n Use `string-to-bag` to build one bag of words for the `wiki-article`, and another for the `student-essay`. Do the bags of words appear to be identical to you, or not? @fitb{}{@ifsoln{They are close but not identical. In the `wiki-article`, "is" appears twice but in the `student-essay`,}}

@fitb{}{@ifsoln{it appears three times.}}
