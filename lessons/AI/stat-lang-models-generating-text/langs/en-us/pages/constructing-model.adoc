...
Use @printable-exercise{old-lady-lyrics.adoc, the corpus} to answer the questions below. Remember: *the title of the song is a part of the corpus!*

@vspace{1ex}

The example below shows the probability that "was" will come after "there".
...
@n The lady was *most* likely trying to catch the @fitb{8em}{@ifsoln{fly (3/6)}}.  It is the *least* likely that she was trying to catch the @fitb{}{@ifsoln{bird (1/6)}}
...
@ifsoln{@math{\frac{3}{12}}}
@math{=} @fitbruby{5em}{@ifsoln{0.25}}{decimal}
@math{=} @fitbruby{5em}{@ifsoln{25%}}{percent}

| @n @math{p(spider \| the) =}
@ifnotsoln{@math{\frac{\qquad}{\qquad}}}
@ifsoln{@math{\frac{5}{12}}}
@math{=} @fitbruby{5em}{@ifsoln{0.42}}{decimal}
@math{=} @fitbruby{5em}{@ifsoln{42%}}{percent}
...
| @n @math{p(cat 	 \| the) =}
@ifnotsoln{@math{\frac{\qquad}{\qquad}}}
@ifsoln{@math{\frac{1}{12}}}
@math{=} @fitbruby{5em}{@ifsoln{0.08}}{decimal}
@math{=} @fitbruby{5em}{@ifsoln{8%}}{percent}
|===
