...
@lesson-prereqs{natural-language}
...
- A messaging app also includes a @vocab{model} of _the words that the owner user_, to personalize suggestions to the way the user writes. The app can also account for previously-accepted word suggestions.
