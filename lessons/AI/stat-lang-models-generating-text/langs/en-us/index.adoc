...
In the example you just worked through, you computed the _conditional probability_ that "was" appears after the unigram "there"...

@indented{by dividing the number of times *`"there"` is followed by `"was"`* (5) by the number of times we see *`"there"` followed by anything* (5)}
