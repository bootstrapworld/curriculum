...
@slidebreak{Launch}
@lesson-point{Is it _thinking_, or is it just _following steps_?}
...
[cols="^1a,^1a,^1a"]
|===
| @image{images/classifier-bot.png}
| @image{images/recommendation-bot.png}
...
@right{@image{images/classifier-bot.png}}
@lesson-instruction{
...
@slidebreak{InvestigateR}
@right{@image{images/recommendation-bot.png}}
@lesson-instruction{
...
@slidebreak{InvestigateR}
@right{@image{images/chat-bot.png}}
@lesson-instruction{
