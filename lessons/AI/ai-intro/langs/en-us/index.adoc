...
@QandA{
@Q{What do you think of when you hear the word "similar"?}
}

=== Investigate

What does it mean to measure similarity?

To begin to answer this question, let's look at some mountain landscapes! 
