...
Pinning down exactly *what* AI is can be difficult. Why? As different technological innovations become more familiar and more accessible... we stop thinking about them as AI.
