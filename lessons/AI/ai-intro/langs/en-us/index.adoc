...
@lesson-instruction{
- The first comparison (to Photo 1):
...
- The second comparison (to Photo 4):
...
@Q{Summarize the first way that you quantified similarity. You may want to refer back to the *second* section of @prinable-exercise{measuring-similarity.adoc}, "Sorting the Photos".}
