= Angle Difference (with Protractor)

Fill in the blank table cells, then use them to determine the ordered pairs. Plot and label point A and point B on the coordinate plane. Draw a ray from the origin to each of the points. Measure and record the size of the angle (in degrees) formed by the rays.
...
@ifsoln{
@center{@image{../images/soln3.webp, 150}}}
