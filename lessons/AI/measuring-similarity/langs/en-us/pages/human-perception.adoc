...
@n Evaluate `mountains` in the *Interactions Area*. What about them makes them all _similar_ to one another?
...
@n What about the nine photos makes them all _different_ from one another? @fitb{}{} +
@blanklines{4}{
...
@n Choose three mountain images you like the best, and change the values for those images in the `LIKED` from `false` to `true`.
