...
- As you ask questions, I will record them on the board.
}
...
Unlike in our game, where you got to choose the questions, @vocab{decision trees} are built from training data sets that contain the answers from a collection of predetermined questions.
