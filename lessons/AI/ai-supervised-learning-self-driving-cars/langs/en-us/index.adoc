...
- The human driver in this context - the context of @vocab{supervised learning} - is often referred to as the _supervisor_. 
...
- In @vocab{supervised learning}, the abstraction of the function - what does the function actually look like? - takes place after demonstration.
...
- Function abstraction - when the machine finds a function that generalizes well to new, unseen data
- Use the function!

As you explore other examples of @vocab{supervised learning} in this curriculum, you will notice that - regardless of the unique specifics - all three phases occur in the same order. 
