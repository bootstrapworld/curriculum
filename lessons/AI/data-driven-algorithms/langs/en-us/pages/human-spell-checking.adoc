...
++++
<style>
div#body .big { font-size: 16px; font-weight: bold; }
</style>
++++
...
@n What is the *first word that is spelled incorrectly* in the quote at the top? @fitb{7em}{@ifsoln{wello}} What was the _intended_ word? @fitb{}{@ifsoln{hello}}

@n How did you know that that word was misspelled? Explain in as much detail as you can. @fitb{}{}
...
@n What is the *second word that is spelled incorrectly* in the quote at the top? @fitb{}{@ifsoln{thay}}

@n What was the _intended_ word? @fitb{6em}{@ifsoln{they}} +
...
@n You probably didn't need a dictionary for these two words. When _would_ you need a dictionary for spell-checking? Explain. @fitb{}{}
