...
@link-instructions{
Make sure you have a Pyret editor open and click "Run". @ifnotsoln{Experiment with each of the functions listed below in the Interactions Area. Can you figure out the Domain for each function? Record the contract and example code for each function you are able to use! (HINT: read the error messages!)
}
@ifsoln{
