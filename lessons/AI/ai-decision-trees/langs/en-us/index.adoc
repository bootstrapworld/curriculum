...
@center{@image{images/age-stump.png, 180}}
...
- The other leaf nodes similarly summarize the puchasing habits of the individuals in their age groups.
...
@lesson-instruction{
- Complete the first section of @printable-exercise{part-1.adoc}.
- Add checkmarks to indicate when our rule was successful for customers in their twenties and thirties.
- Calculate how effectively our rule predicted outcomes for each age group and the dataset as a whole.
}
...
@lesson-instruction{
Complete @printable-exercise{build-and-test.adoc}.
}
