...
@QandA{
@Q{Referring to the @handout{old-lady-lyrics.adoc, "lyrics"}, *including the title*: how many times does the word "there" appear in the song?}
@A{5}
...
In the example you just worked through, you computed the probability that "was" appears after the unigram "there" by dividing 5 (how many times we see "was" follow "there") by 5 (how many times we see "there" followed by anything). +
