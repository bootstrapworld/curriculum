...
Students should open the @starter-file{animals} in CODAP. Then, invite them to play in CODAP, guided by the worksheet below.

[.lesson-instruction]
--
- Complete @printable-exercise{codap-experimentation.adoc}.
