...
@ifproglang{pyret}{ @printable-exercise{pages/is-collision.adoc}, }
...
=== Synthesize
- You started by writing the `distance` function first, and then @ifproglang{wescheme}{`collide?`} @ifproglang{pyret}{`is-collision`} Is this *Top-Down* or *Bottom-Up* decomposition?
