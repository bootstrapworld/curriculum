...
=== Overview
Students revisit the problem decomposition concept from @link{../alg-problem-decomposition, earlier} @link{../alg-inequalities2-compound, lessons}.
...
Problem Decomposition is the focus of @link{../alg-problem-decomposition, an entire Bootstrap lesson}, is used to solve @link{../alg-inequalities3-sam, `onscreen?`}, and build up the 2-dimensional @link{../alg-distance-formula/, distance function}.
