...
- Connect this back to `profit`, `revenue`, `cost` and `onscreen` from @lesson-link{lessons/problem-decomposition, previous lessons}. Problem Decomposition is powerful!
-->
