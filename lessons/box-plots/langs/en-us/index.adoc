...
@right{@image{images/box-n-whisker-plot.png, "A sample box-and-whisker plot", 250}}Suppose we lined up all animals' weights from smallest to largest, and then split them into two equal groups by taking the @vocab{median}. We can learn something about the @vocab{spread} of the dataset by taking things further:

- The middle of the lighter half of animals is called the first @vocab{quartile} - or "Q1"
- The middle of the heavier half of animals is the third quartile (also called "Q3").
...
@right{@image{images/5-plot.png, 5 plot, 400}}
...
- OPTIONAL: Complete@opt-printable-exercise{pages/matching-boxplots-to-histograms-2.adoc} and/or @opt-online-exercise{https://teacher.desmos.com/activitybuilder/custom/601974faad8cb40d1c603324, Matching Boxplots to Histograms}
