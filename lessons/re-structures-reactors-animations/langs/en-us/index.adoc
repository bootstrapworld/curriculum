...
=== Investigate
@span{.right}{@centered-image{images/cowjump.gif, Cow jump, 200}}
...
@span{.right}{@centered-image{images/cycling.gif, Cycling, 400}}
...
@span{.right}{@centered-image{images/pulsingstar.gif, Pulsing star, 200}}
...
@span{.right}{@centered-image{images/dimmer.gif, Dimmer, 200}}
