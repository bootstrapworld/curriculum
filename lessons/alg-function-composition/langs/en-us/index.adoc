...
@ifproglang{pyret}{
Additional practice with connecting code and images is available through this matching activity: @activity-link{https://teacher.desmos.com/activitybuilder/custom/5fc946c8d135d036ef1edd01, Function Composition (Desmos Activity)}
}
