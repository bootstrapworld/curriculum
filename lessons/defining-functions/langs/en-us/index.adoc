...
|@centered-image{images/table-to-prettify.png, 400, align="center"}
| ➞
|@centered-image{images/math-fun-wescheme-2.png, 400, align="center"}
|===
}
...
Have students open
@ifproglang{pyret{
@online-exercise{https://code.pyret.org/editor#share=1wvO-su91pFXQJcsIAa5IUOVcUea06YuY&v=04918ef, the gt starter file}}
@ifproglang{wescheme}{https://www.wescheme.org/openEditor?publicId=2eMcXop5hZ, the gt starter file
}.
