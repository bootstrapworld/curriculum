...
function models for
@worksheet-link{FunctionComposition3/pages/FunctionComposition3-WB1.adoc,
revenue},
@worksheet-link{FunctionComposition3/pages/FunctionComposition3-WB2.adoc,
cost}, and
@worksheet-link{FunctionComposition3/pages/FunctionComposition3-WB3.adoc,
