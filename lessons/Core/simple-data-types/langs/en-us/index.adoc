...
@learning-objective{Identify examples of the following data types: Numbers, Strings, and Booleans}
@learning-objective{Write Numbers, Strings, and Booleans in the Interactions Area}
@learning-objective{Write expressions that produce values of those types}
