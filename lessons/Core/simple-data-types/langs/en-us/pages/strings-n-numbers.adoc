...
@n Try typing `.5`. Then try typing `0.5`. Then try clicking on the answer. Experiment with other decimals. +
...
@n Type in the following expressions, *one at a time*: @hspace{1em} `4 + 2 * 6` @hspace{3em} `(4 + 2) * 6`@hspace{3em} `4 + (2 * 6)` @hspace{1em} What do you notice? +
