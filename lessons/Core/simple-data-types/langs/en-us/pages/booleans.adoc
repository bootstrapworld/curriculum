...
@fitb{}{@ifsoln{Checks whether a) the first number is smaller than the second number or b) the first string comes before the second alphabetically; returns true if yes and false if not}}

@vspace{1ex}

@n In your own words, describe what `>=` does.

@fitb{}{@ifsoln{Checks whether a) the first number is greater than or equal to the second number or b) the first string is the same as the second or follows the second string alphabetically; returns true if yes and false if not}}

@vspace{1ex}

@n In your own words, describe what `<>` does.

@fitb{}{@ifsoln{checks whether the two Numbers or the two Stringsare unequal; returns true if they're unequal and false if they're equal}}
