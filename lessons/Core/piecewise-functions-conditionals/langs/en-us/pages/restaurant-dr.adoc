...
"Alice's Restaurant has hired you as a programmer. They offer the following menu items: hamburger ($6.00), onion rings ($3.50), fried tofu ($5.25) and pie ($2.25). Write a function called @funname which takes in the name of a menu item and outputs the price of that item. When you're done, test your code in the @opt-starter-file{alices-restaurant}."
  #:domain-list '(String)
  #:range "Number"
