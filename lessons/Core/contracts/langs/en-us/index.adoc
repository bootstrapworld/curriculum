...
* @pathway-only{If you're using a printed workbook with your class, you could choose to use the contracts pages at the back of the book @pathway-link{resources/pages/contracts.pdf, (link)} instead of the @opt-printable-exercise{image-contracts.adoc, image contracts}.}
