...
@learning-objective{Explain the three core elements of a _Contract_ (a set-based representation of function machines): Name, Domain, and Range}
@learning-objective{Use Contracts to apply functions that produce Numbers, Strings, and Images}
@learning-objective{Demonstrate understanding of @vocab{Domain} and @vocab{Range} and how they relate to @vocab{Functions}}
