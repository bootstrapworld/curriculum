...
@lesson-point{
A Contract is an agreement between us and a function: if we give it what it needs, we get back what we want.
}
...
Students to **not** need to find all of the contracts on this page in order to complete the lesson or the following pages.
}
