...
* Decide whether you'd like to provide your students with copies of the @opt-printable-exercise{image-contracts.adoc, image contracts} or all @ifpathway{algebra-wescheme}{4} @ifpathway{algebra-pyret}{4} @ifpathway{data-science}{6} of the contracts pages for the course today. For those working with printed workbooks, the complete set of contracts pages can be found in the back of the workbook. 
