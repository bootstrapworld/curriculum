...
* Students should have access to the @link{../../Contracts.shtml, Contracts Page}. @pathway-only{These contracts are printed at the back of the student book, if you're using printed books.}
