...
@ifpathway{
* Decide whether you'd like to provide your students with copies of the @opt-printable-exercise{image-contracts.adoc, image contracts} or the @pathway-link{resources/pages/contracts.pdf, complete set of contracts for the course.} You can also point them to the contracts pages from the back of the course book.}
