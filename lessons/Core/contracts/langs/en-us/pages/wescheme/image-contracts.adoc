...
@ifsoln{*Teachers:* Students will see the contract and example for `triangle` and a list of function names. They are asked to experiment to get expressions building and record contracts and example code for each function.}
