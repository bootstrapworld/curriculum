...
@ifproglang{pyret}{
You can find blank Design Recipes at the back of the book, or @dist-link{blanks/2-blank-pyret-recipes.adoc, print additional ones of your own}.
}

@ifproglang{wescheme}{
You can find blank Design Recipes at the back of the book, or @dist-link{blanks/2-blank-wescheme-recipes.adoc, print additional ones of your own}.
}
