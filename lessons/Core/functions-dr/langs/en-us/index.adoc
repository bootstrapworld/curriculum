...
@Q{What happens when you press the spacebar?}
...
- __Challenger__ (pointing at the `seconds` variable in the Definition): Where'd you get that?
- __Defender__ (pointing at label in the Examples): Well, I circled the parts of the Examples that change, and labeled them as "seconds".
- __Challenger__(pointing at the label): OK, but where did you get that label?
- __Defender__ (pointing at Purpose Statement): I used "seconds" in the Purpose Statement.
- __Challenger__ (pointing at Purpose Statement): Where'd you get that term?
- __Defender__ (pointing to Word Problem): I got it from reading the Word Problem.
}


@opt{__For teachers who cover quadratic and exponential functions, or have students who need more of a challenge__, checkout the @opt-printable-exercise{rocket-challenges.adoc}:
