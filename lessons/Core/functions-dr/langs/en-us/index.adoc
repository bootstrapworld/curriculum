...
@learning-objective{Understand how to use the Design Recipe to break down word problems.}
@learning-objective{Create a strong purpose statement that details in their own words what the function should do.}
