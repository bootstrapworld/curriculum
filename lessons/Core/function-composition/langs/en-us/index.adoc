...
>>>>>>> a9ea06dd00240cc91a88729cd7ca4457355f36b3
@QandA{
@Q{Which representation (below) corresponds with Option 1? How do you know?}
...
[cols=".^7a,^.<3a",  stripes="none"]
|===
| @hspace{10em} *Three Steps*
| *Three Circles*
...
Remember that we can think of this activity as a list of steps where the result is saved each time, _or_ as a nested series of function applications. Which do you like best? Why?
