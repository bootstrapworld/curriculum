...
@objectives
@objective{Use functions as building-blocks, composing them to achieve a desired affect}
@objective{Diagram function composition using the Circles of Evaluation}
@objective{Compose functions when programming}
