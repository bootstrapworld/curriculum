...
#content table { grid-template-rows: 2fr 3fr !important; }
#content .topTable { height: 2in; }
...
| @n A solid, green star, that's 3x the size of the original (use `scale`)
...
| @n A solid, green star, that's 1/2 the size of the original (use `scale`)
...
| @n A solid, green star that's 3x the size of the original *and* has been rotated 45 degrees
