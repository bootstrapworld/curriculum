...
Complete the sentences below with the behavior you observed for each Boolean.

@hspace{3em} a. `true` sorts the table... @fitbruby{}{@ifsoln{in *ascending order* _(from least to greatest)_}}{ @hspace{8em}in *ascending order* _(from least to greatest)_   /   in *descending order* _(from largest to smallest)_}

@hspace{3em} b. `false` sorts the table... @fitbruby{}{@ifsoln{@hspace{8em}in *descending order* _(from largest to smallest)_}}{ @hspace{7em}in *ascending order* _(from least to greatest)_   /   in *descending order* _(from largest to smallest)_}
