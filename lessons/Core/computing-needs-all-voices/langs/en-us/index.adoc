...
- @lesson-link{computing-needs-all-voices/pages/computing-pioneers.html, Pioneers in Computing and Mathematics}
...
@ifnotslide{
Assuming that you have printed and hung posters of @lesson-link{computing-needs-all-voices/pages/computing-pioneers.html, Pioneers in Computing and Mathematics} for a gallery walk:
...
We are going to take some time to explore these @lesson-link{computing-needs-all-voices/pages/computing-pioneers.html, Pioneers in Computing and Mathematics Posters}.
}
