...
@learning-objective{There are programmers of wide-ranging racial, ethnic, gender and sexual identities.}
@learning-objective{Programming is creative and collaborative.}
@learning-objective{Programming is useful in a wide range of fields.}
@learning-objective{People who wrote the sophisticated programs we use every day started out writing simple programs.}
@learning-objective{There are lots of programming jobs, but not enough programmers to fill them.}
@learning-objective{Teams benefit from diversity.}
