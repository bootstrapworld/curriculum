...
@blanklines{9}{
@ifsoln{*Answers and reasoning will vary:* +
`cy(x)` splits the data points so there are four to the right of the model and four to the left of the model. +
`jo(x)` is closer to the outlier}
}
