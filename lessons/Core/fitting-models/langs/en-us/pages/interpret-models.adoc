...
@teacher{The information for this section is most easily gathered by looking at the table and using our `dot-plot` and `box-plot` functions.}

@n These models were built using data about 
@fitbruby{6em}{@ifsoln{10}}{how many?}
...
@ifsoln{@math{\frac{4.08}{5.58} = .73  &#8192; &rarr; &#8192;  73 \%}}
}
