...
@Q{What new values did you decide to define? When might they be useful?}
}
...
- Then turn to @printable-exercise{pages/coe-why-define-values.adoc} and take a look at the first row of the table.
}
@QandA{
...
@lesson-instruction{
- Complete @printable-exercise{pages/coe-why-define-values.adoc}.
