...
- When you're done, turn to @printable-exercise{pages/writing-code-using-defined-values.adoc} and follow the directions to work with a new function you'll define called `PRIZE-STAR`.
}
