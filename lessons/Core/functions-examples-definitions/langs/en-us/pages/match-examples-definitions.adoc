...
@show{
(code '(EXAMPLE
       (gt 20) (triangle 20 "solid" "green")
       (gt 50) (triangle 50 "solid" "green")
      ))
   }
...
|===
| Examples    |                   ||       | Definition
| @show{e2}   |*1*@ifsoln-match{D}||*A*    | @show{f3}
| @show{e5}   |*2*@ifsoln-match{B}||*B*    | @show{f5}
| @show{e1}   |*3*@ifsoln-match{E}||*C*    | @show{f4}
| @show{e4}   |*4*@ifsoln-match{C}||*D*    | @show{f2}
| @show{e3}   |*5*@ifsoln-match{A}||*E*    | @show{f1}
|===
