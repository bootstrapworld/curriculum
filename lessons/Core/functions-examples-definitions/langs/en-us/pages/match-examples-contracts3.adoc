...
|===
| Contract     |                    ||       | Examples
| @show{e9b}   |*1*@ifsoln-match{A} ||       |
| @show{e5b}   |*2*@ifsoln-match{B} ||       |
| @show{e9a}   |*3*@ifsoln-match{A} ||*A*    | @show{c9}
| @show{e6a}   |*4*@ifsoln-match{E} ||*B*    | @show{c5}
| @show{e6b}   |*5*@ifsoln-match{E} ||*C*    | @show{c8}
| @show{e7a}   |*6*@ifsoln-match{D} ||*D*    | @show{c7}
| @show{e5a}   |*7*@ifsoln-match{B} ||*E*    | @show{c6}
| @show{e8a}   |*8*@ifsoln-match{C} ||       |
|===
