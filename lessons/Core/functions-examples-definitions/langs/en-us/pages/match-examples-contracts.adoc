...
#content .circleevalsexp, .editbox, .cm-s-scheme {font-size: .75rem;}
...
|===
|  Examples|               ||      |Contract
| @show{e5}| *1*@ifsoln-match{A} || *A*  | @show{c5}
| @show{e2}| *2*@ifsoln-match{C} || *B*  | @show{c3}
| @show{e1}| *3*@ifsoln-match{E} || *C*  | @show{c2}
| @show{e3}| *4*@ifsoln-match{B} || *D*  | @show{c4}
| @show{e4}| *5*@ifsoln-match{D} || *E*  | @show{c1}
|===
