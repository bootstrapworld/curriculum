...
|===
| Contract     |                    ||       | Examples
| @show{e4b}   |*1*@ifsoln-match{C} ||*A*    | @show{c3}
| @show{e2a}   |*2*@ifsoln-match{B} ||       |
| @show{e4a}   |*3*@ifsoln-match{C} ||*B*    | @show{c2}
| @show{e1a}   |*4*@ifsoln-match{D} ||       |
| @show{e2b}   |*5*@ifsoln-match{B} ||       |
| @show{e1b}   |*6*@ifsoln-match{D} ||*C*    | @show{c4}
| @show{e3a}   |*7*@ifsoln-match{A} ||       |
| @show{e1c}   |*8*@ifsoln-match{D} ||*D*    | @show{c1}
|===