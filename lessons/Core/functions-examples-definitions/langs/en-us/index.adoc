...
@learning-objective{identify patterns where a function would be useful}
@learning-objective{define their own function}
@learning-objective{match examples, contracts, and definitions for the same function}
