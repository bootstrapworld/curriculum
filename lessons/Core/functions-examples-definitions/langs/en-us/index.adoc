...
@lesson-instruction{
- If we use the correct syntax, including all three of these function representations in our @proglang files will let @proglang check our work!
- Click "Run" and let's take a look at what happens.
}
...
- When you're done, type the Contract, Examples and Definition into the Definitions Area of the @starter-file{bc}, click “Run”, and make sure all of the examples pass!
}
