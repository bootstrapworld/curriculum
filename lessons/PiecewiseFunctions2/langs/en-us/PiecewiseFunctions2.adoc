...
* Design Recipe: update-player (@worksheet-link{pages/PiecewiseFunctions2-EX1.adoc, PDF})
|===
...
Students complete @worksheet-link{pages/PiecewiseFunctions2-EX1.adoc, Design Recipe: update-player} with a partner, then type their code into their *Game Project file* and test.  
