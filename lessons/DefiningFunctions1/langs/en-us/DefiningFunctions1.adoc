...
* Fast Functions worksheet (@worksheet-link{workbook-pages/FastFunctions1.pdf, PDF}, @link{https://docs.google.com/document/d/19zlI9LU1u3xOfC7CQ2OHznaiJJNwbWJD9mm-7QtEXVQ/edit?usp=sharing, Google Doc})
endif::[]
...
_Because that's the domain of `triangle`.  `gt` only needs one Number input._
