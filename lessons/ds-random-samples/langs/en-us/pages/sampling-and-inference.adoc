...
7) Make a `pie-chart` for the animals in each sample, showing percentages of males and females. Note that the percentage of males in the entire population is ~50%.
