...
=== Investigate
Students complete @workbook-link{pages/function-composition-practice.adoc, Function Composition Practice}, practicing drawing Circles of Evaluation and writing code with their partner using different functions.
