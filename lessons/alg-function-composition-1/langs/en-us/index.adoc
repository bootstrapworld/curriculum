...
=== Investigate
Students complete @workbook-link{pages/making-stars.adoc, Function Composition Practice}, practicing drawing Circles of Evaluation and writing code with their partner using different functions.
