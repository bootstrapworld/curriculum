...
=== Investigate
Students complete @workbook-link{pages/making-stars.adoc, Making Stars (Page 18)}, practicing drawing Circles of Evaluation and writing code with their partner using different functions.
