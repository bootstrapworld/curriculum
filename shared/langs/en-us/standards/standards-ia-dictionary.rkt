...
(define *iowa-standards-list*
  '(
    ...
    ; Iowa Core Standards for Mathematics 5-12

    ("IA.5.OA.A"
     "Write and interpret numerical expressions."
     "https://iowacore.gov/standards/iowa-core-standards"
     )
    ("IA.5.OA.A.1"
                 ...
                 ("IA.5.NF.B.7.C"
                  ...
                  ("IA.5.MD.B.2"
                   ...
                   ("IA.5.MD.C"
                    ...
                    ("IA.HSN.Q.B.3"
                     "Understand, analyze, apply, and evaluate some common voting and analysis methods in
                     addition to majority and plurality, such as runoff, approval, the so-called instant-runoff
                     voting (IRV) method, the Borda method and the Condorcet method."
                     "https://iowacore.gov/standards/iowa-core-standards"
                     )
                     ("IA.HSN.Q.C.4"
                      "Describe the role of mathematics in information processing, particularly with respect to
                      the Internet.:
                      "https://iowacore.gov/standards/iowa-core-standards"
                      )
                      ("IA.HSN.Q.C.5"
                       "Understand and apply elementary set theory and logic as used in simple Internet
                       searches."
                       "https://iowacore.gov/standards/iowa-core-standards"
                       )
                       ("IA.HSN.Q.C.6"
                        "Understand and apply basic number theory, including modular arithmetic, for example,
                        as used in keeping information secure through public-key cryptography."
                        "https://iowacore.gov/standards/iowa-core-standards"
                        )
                        ("IA.HSN.CN.A"
                        ...
                        ("IA.HSG.GPE.B.4"
                         ...
                         ("IA.HSG.MG.B.8"
                          "Understand, analyze, evaluate, and apply vertex-edge graphs to model and solve
                          problems related to paths, circuits, networks, and relationships among a finite number
                          of elements, in real-world and abstract settings."
                          "https://iowacore.gov/standards/iowa-core-standards"
                          )
                          ("IA.HSG.MG.B.9"
                           "Model and solve problems using at least two of the following fundamental graph topics
                           ...
                           ("IA.HSG.MG.B.10"
                            "Compare and contrast vertex-edge graph topics and models in terms of properties, algorithms, optimization, and types of problems that can be solved."
                            "https://iowacore.gov/standards/iowa-core-standards"
                            )
                           ("IA.HSS.ID.A"
