...
(define *standards-list*
  (list
    ...
    (list "NewHampshire" "New Hampshire"   *nh-standards-list* "")
    (list "Nevada"      "Nevada"            *nv-standards-list* "")
    (list "NewJersey"  "New Jersey"        *nj-standards-list* "")
    (list "NewMexico"  "New Mexico"        *nm-standards-list* "")
    (list "NorthCarolina" "North Carolina" *nc-standards-list* "")
    (list "NorthDakota" "North Dakota"     *nd-standards-list* "")
    (list "NewYork"    "New York"          *ny-standards-list* "http://www.nysed.gov/curriculum-instruction/new-york-state-next-generation-mathematics-learning-standards")
    ...
    (list "RhodeIsland" "Rhode Island"     *ri-standards-list* "")
    (list "SouthDakota" "South Dakota"     *sd-standards-list* "")
    ...
    (list "WestVirginia" "West Virginia"   *wv-standards-list* "")
