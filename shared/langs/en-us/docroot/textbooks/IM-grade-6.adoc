...
| @span{.right}{@image{images/making{transform-compose-images.png, 130}}

@lesson-link{transform-compose-images/}

-{transform-compose-images are an authentic application for ratios and scaling!
...
- This activity has a low threshold and a high ceiling. Students of all kinds of minds love building{transform-compose-images - some will make many! And they take great pride in seeing their{transform-compose-images and code hanging on classroom walls, a rare opportunity to connect to and share pride in their identity in math class.
