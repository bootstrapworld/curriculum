...
if (fs.existsSync(jsDir)) {
  ...
  for (let i = 0; i < ff.length; i++) {
    ...
    allLearningObjectives = { ...allLearningObjectives, ...j };
  }
  let jsonString = JSON.stringify(allLearningObjectives);
  fs.writeFileSync(finalJsFile, 'var allLearningObjectives = ' +
    jsonString + ';\n');
}
