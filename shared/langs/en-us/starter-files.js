...
const Editors = { 
  "editor": {
    ...
    "wescheme": {
      "url": "https://www.wescheme.org/openEditor",
      "title": "WeScheme"
    },
    "codap": {
  ...
  "program-list": {
    ...
    "wescheme": {
      "url": "https://www.wescheme.org/console",
      "title": "WeScheme"
    },
    "codap": {
      "url": "https://codap.concord.org/app/static/dg/en/cert/index.html",
...
const Core = {
  "bc": {
    ...
    "pyret": {
      "url": "https://code.pyret.org/editor#share=1_FBRxM-CzjOaCEj7XCe7J9zk27fd11l0"
    },
    "wescheme": {
      "url": "https://www.wescheme.org/openEditor?publicId=2eMcXop5hZ"
    }
  },
  "gt": {
    "title": "gt Starter File",
    "pyret": {
      "url": "https://code.pyret.org/editor#share=1wvO-su91pFXQJcsIAa5IUOVcUea06YuY"
    },
    "wescheme": {
      "url": "https://www.wescheme.org/openEditor?publicId=KCEKxaxJ4l"
    }
  },
  "bug-hunting": {
    "title": "Bug Hunting Starter File",
    "pyret": {
      "url": "https://code.pyret.org/editor#share=1JEeZjzctaJ9fD77rWXqrorqCwlZrDx9H"
    },
    "wescheme": {
...
const Piecewise = {
  "alices-restaurant": {
    ...
    "pyret": {
      "url": "https://code.pyret.org/editor#share=16268WLNRFaqkr5qs-equFhgpsfwteFyK"
    },
    "wescheme": {
  ...
  "red-shape": {
    "title": "Red Shape Starter File",
    "pyret": {
      "url": "https://code.pyret.org/editor#share=1SHT98yCEr-R9RYKbjkKebQsdfe6KF2W6"
    },
    "wescheme": {
      "url": "https://www.wescheme.org/openEditor?publicId=WX7Yu6bhnv"
    }
  }
}
...
const MoreDS = {
  ...
  "text-stats": {
    ...
    "pyret": {
      "url": "https://code.pyret.org/editor#share=1yF_v4g708v5FLnidZ8n7nQo_MJGrFoIP"
    }
  },
  "word-length": {
...
const MoreAlg = {
  ...
  "sallys-lemonade": {
    ...
    "pyret": {
      "url": "https://code.pyret.org/editor#share=1VmH2V3ByFOA_-Fwh-IR1dLC_9XIYGc6U"
    },
    "wescheme": {
...
const EarlyMath = {
  ...
  "identity-prop":{
    ...
    "pyret": {
      "url": "https://code.pyret.org/editor#share=1qK5QSd2fylZGbr_oHUfxsgip2XEtkA2h"
    },
    "wescheme": {
...
const Reactive = {
  "package-delivery": {
    ...
    "pyret": {
      "url": "https://code.pyret.org/editor#share=1RKJNrC2eRxO8apsA0UKbLZAMGD73Xk5D"
    }
  },
  "cake-bakery": {
    "title": "Bakery Starter File",
    "pyret": {
      "url": "https://code.pyret.org/editor#share=1lSittPaSqyeDXAmYmLX8epCIDU4FCFlH"
    }
  },
  "sunset": {
    "title": "Sunset Starter File",
    "pyret": {
      "url": "https://code.pyret.org/editor#share=13RRDcl13HkfNp0Ue7jQUhBNZIumSNxfP"
    }
  },
  "dimmer-switch": {
    "title": "Light Switch Starter File",
    "pyret": {
      "url": "https://code.pyret.org/editor#share=1TJVPlYOKEPBDPTp25YMMVGhz5YlctYnj"
    }
  },
  "cow-jump-moon": {
    "title": "Cow Jumping Over the Moon Starter File",
    "pyret": {
      "url": "https://code.pyret.org/editor#share=1E-V-o_ukmvOTQ8czRCHixAU7Q_5dhuP_"
    }
  },
  "pulsing-star": {
    "title": "Pulsing Star",
    "pyret": {
      "url": "https://code.pyret.org/editor#share=1NVVlQpCKWmLJqz87iRb6IXssIB_68jVM"
    }
  },
  "what-to-wear": {
    "title": "What to Wear Starter File",
    "pyret": {
      "url": "https://code.pyret.org/editor#share=15fUR1QAF-O5HIDq95QnctdsdVNfF1Tde"
    }
  },
  "moving-character": {
    "title": "Moving Character Starter File",
    "pyret": {
      "url": "https://code.pyret.org/editor#share=1pmuumO3gEC44--2zxp5fjK6k20lCYt-t"
    }
  },
  "virtual-pet": {
    "title": "Virtual Pet Starter File",
    "pyret": {
      "url": "https://code.pyret.org/editor#share=15WcPmjNM-qAZGs9BakA7prvOVMqbBkxU"
    }
  },
  "single-number": {
    "title": "Single-Number State Starter File",
    "pyret": {
      "url": "https://code.pyret.org/editor#share=1p4oviyUQ-EGuo12Y3wHeAdG8xJjOKtkE"
    }
  },
  "two-number": {
    "title": "Two-Number State Starter File",
    "pyret": {
      "url": "https://code.pyret.org/editor#share=1Az8Xd4ZcMwqezo8vAldQOrfQkRvi2H8N"
    }
  },
  "1-paddle-pong": {
    "title": "1-Paddle Pong",
  ...
  "ninja-cat-collisions": {
    "title": "Ninja Cat Starter File",
    "pyret": {
      "url": "https://code.pyret.org/editor#share=1TGw11fcBMAS0j2CCRWZm5_6GuBWVMBPq"
    }
  },
  "watermelon-smash": {
    "title": "Watermelon Smash Starter File",
    "pyret": {
      "url": "https://code.pyret.org/editor#share=1-gNiFJeQenO3e_9LVbPw6ucl4lZrTA6R"
    }
  },
  "pinwheels1": {
    "title": "Pinwheels 1 Starter File",
    "pyret": {
      "url": "https://code.pyret.org/editor#share=1zGu7HlIizCZZ923UDKVj-ahUEHU9d_2_"
    }
  },
  "pinwheels2": {
    "title": "Pinwheels 1 Starter File",
...
const Assessments = {
  ...
  "box-plots-check2-desmos": {
    ...
    "pyret": {
      "url": "https://teacher.desmos.com/activitybuilder/custom/66d883e2196a5c79bf67a164?collections=66d8678a5c04bcca1cb0544c"
    }, 
    "codap": {
      "url": "https://teacher.desmos.com/activitybuilder/custom/66d883e2196a5c79bf67a164?collections=66d8678a5c04bcca1cb0544c"
    } 
  ...
  "box-plots-check4-desmos": {
    ...
    "pyret": {
      "url": "https://teacher.desmos.com/activitybuilder/custom/66d88560aca2199ec460d1db?collections=66d8678a5c04bcca1cb0544c"
    }, 
    "codap": {
      "url": "https://teacher.desmos.com/activitybuilder/custom/66d88560aca2199ec460d1db?collections=66d8678a5c04bcca1cb0544c"
    } 
