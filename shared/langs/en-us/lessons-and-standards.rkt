...
(define *lessons-and-standards*
  '(
    ...
    ;data science
    ("ds-intro"  "6.SP.A.1" "6.SP.B.5.A" "7.SP.A.1")
    ("ds-pyret-intro" "")
    ("ds-applying-functions" "")
    ("ds-displays-and-lookups" "6.SP.B.4" "8.SP.A.1")
    ("ds-defining-functions" "8.SP.A.1")
    ("ds-table-methods" "")
    ("ds-defining-table-functions" "")
    ("ds-grouped-samples" "6.SP.B.4" "8.SP.A.1")
    ("ds-histograms"  "HSS.ID.A.3" "HSS.ID.A.1" "6.SP.A.2" "6.SP.B.4" "6.SP.B.5.A" "6.SP.B.5.B" "6.SP.B.5.C")
    ("ds-histograms2" "HSS.ID.B.6.A" "HSS.ID.A.3" "HSS.ID.A.1" "6.SP.A.2" "6.SP.B.4" "6.SP.B.5.C")
    ("ds-if-expressions" "")
    ("ds-measures-of-center"  "6.SP.A.2" "6.SP.A.3" “6.SP.B.4” "6.SP.B.5.C")
    ("ds-measures-of-spread" "HSS.ID.A.1" "6.SP.A.2" "6.SP.B.4" "6.SP.B.5.C")
    ("ds-choosing-your-dataset" "6.SP.A.1")
    ("ds-method-chaining" "")
    ("ds-checking-your-work" "7.SP.A.1")
    ("ds-random-samples" "7.SP.A.1" "7.SP.A.2")
    ("ds-scatter-plots" "8.SP.A.1" “8.SP.A.2” "HSS.ID.B.6" "HSS.ID.C.8")
    ("ds-correlations" "HSS.ID.C.9" "HSS.ID.C.8" "8.SP.A.1" "8.SP.A.2")
    ("ds-linear-regression" "HSS.ID.C.7" “HSS.ID.C.9” "HSS.ID.B.6.C" “8.SP.A.1” "8.SP.A.2" "8.SP.A.3")
