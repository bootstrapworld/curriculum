...
(define *glossary-list*
  '(("accessor functions" "functions to extract values from a data structure")
    ...
    (("interquartile range" "IQR") "(IQR) is one possible measure of spread, based on dividing a data set into four quartiles. The values that divide each part are called the first quartile (Q1), the median, and third quartiles (Q3). IQR is calculated as Q3 minus Q1")
