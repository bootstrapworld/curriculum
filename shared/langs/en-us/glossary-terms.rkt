...
(define *glossary-list*
  '(("accessor functions" "functions to extract values from a data structure")
    ...
    (("skewed left" "left skew" "left skew") "A distribution is skewed left if there are a few values that are fairly low compared to the bulk of data values. A display of the data will show a longer tail to the left.")
    (("skewed right" "right skew" "right skew") "A distribution is skewed right if there are a few values that are fairly high compared to the bulk of data values. A display of the data will show a longer tail to the right.")
