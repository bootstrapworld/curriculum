...
(define *glossary-list*
  '(("accessor functions" "functions to extract values from a data structure")
    ...
    ("function definition" "code that names a function, lists its variables, and states the expression to compute when the function is used")(("frequency" "frequencies") "how often a particular value appears in a dataset")
    ...
    (("mean" "average") "a representation of the center, or 'typical' value in a set of numbers, calculated as the sum of those numbers divided by the number of values.")
