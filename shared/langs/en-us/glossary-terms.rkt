...
(define *glossary-list*
  '(("accessor functions" "functions to extract values from a data structure")
    ...
    (("scatter plot" "scatter plots") "a number that reports the direction, form, and strength of the linear relationship between two quantitative columns in a data set")
