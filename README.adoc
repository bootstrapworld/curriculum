...
directory `shared/langs/en-us/standards/'. In it, the file
`standards-and-lessons.rkt` contains an association of educational
standards with the lessons that comply with them. Dictionaries for the
