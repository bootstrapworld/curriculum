...
- @`fitb{3em}{salmon}` - displays a blank line 3em wide, with the word "hello!" inside
- @`fitbruby{6em}{salmon}{fish species}` - displays a blank line 3em wide, with the word "hello!" inside, and the ruby "fish species" underneath
