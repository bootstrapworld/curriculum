...
* Quit and relaunch Sublime Text. You can now switch the Syntax mode from Asciidoctor to Asciidoctor+ when viewing an .adoc file, and Sublime will remember your preference for all future adoc files.
