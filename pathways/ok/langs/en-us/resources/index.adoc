...
- *Snowman Puzzle* [@link{https://pyret.bootstrapworld.org/editor#share=1Lgax_uAdFxUJzyGKPbx2BESj9BNkTK3i&v=1904b2c, link}] -- This Pyret Starterfile has all the pieces your students will need to make a snowman by changing the coordinates in the code.
