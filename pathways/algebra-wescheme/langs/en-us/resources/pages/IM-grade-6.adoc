...
@link{../../../../lessons/function-composition-wescheme/,*Making Shapes from Code*}
...
@link{../../../../lessons/surface-area-rect-prism-wescheme/,*Surface Area of a Rectangular Prism*}
...
@link{../../../../lessons/flags-wescheme/,*Making Flags*}
...
@link{../../../../lessons/order-of-operations-wescheme/,*Order of Operations*}
...
@link{../../../../lessons/coordinates-wescheme/,*Coordinates and Game Design*}
...
@link{../../../../lessons/inequalities1-simple-wescheme/, *Simple Inequalities*}
...
- An extension of this lesson (which does involve _compound_ inequalities) is our @link{../../../../lessons/inequalities3-sam-wescheme/, *Sam the Butterfly*} lesson, where students use inequalities to define the boundaries that will keep a video game character on screen.

| @link{https://curriculum.illustrativemathematics.org/MS/teachers/1/8/index.html,*Datasets and Distributions*}
|

@link{../../../../lessons/measures-of-center,*Measures of Center*}
