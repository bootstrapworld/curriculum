...
@lesson-link{functions-can-be-linear/, *Functions Can Be Linear*}
...
@lesson-link{function-definition-linear/, *Defining Linear Relationships*}
...
@lesson-link{inequalities1-simple/, *Simple Inequalities*} and @lesson-link{inequalities2-compound/,*Compound Inequalities*}
...
@lesson-link{functions-dr/,*Solving Word Problems wih the Design Recipe*}
...
@lesson-link{piecewise-functions-conditionals/,*Piecewise Functions and Conditionals*}
...
@lesson-link{scatter-plots/,*Scatter Plots*}
