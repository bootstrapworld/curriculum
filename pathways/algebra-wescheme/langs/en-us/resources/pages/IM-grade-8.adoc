...
@lesson-link{lessons/function-definition-linear/, *Defining Linear Functions*}
...
| @lesson-link{lessons/functions-dr/,*Solving Word Problems with the Design Recipes*}
...
@lesson-link{lessons/scatter-plots/.shtml, *Scatter Plots*}
