...
@link{../../../../lessons/function-definition-linear-wescheme/, *Defining Linear Functions*}
...
| @link{../../../../lessons/functions-dr-wescheme/,*Solving Word Problems with the Design Recipes*}
