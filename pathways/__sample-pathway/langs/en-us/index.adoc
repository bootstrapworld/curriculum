...
Look at
@worksheet-link{lessonA/fragments/PiecewiseFunctions-EX1.adoc} for
exercise B2.

Look at @worksheet-link{lessonB/fragments/exerciseB2.adoc} for
exercise B2.
...
Worksheet page @worksheet-link{lessonB/pages/pageB2.pdf}.
