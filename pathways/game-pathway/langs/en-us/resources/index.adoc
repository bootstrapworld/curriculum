...
@span{.links}{(@exercise-link{Supplemental/fragments/complete-coe-from-arith1.adoc,
original} |
...
@span{.links}{(@exercise-link{Supplemental/fragments/complete-coe-from-arith2.adoc,
original} |
...
* Converting Circles of Evaluation to Code (1)
@span{.links}{(@exercise-link{Supplemental/fragments/many-types-coe-to-code1.adoc,
original} |
@exercise-link{Supplemental/exercises-sols/many-types-coe-to-code1.adoc,
answers})}

* Converting Circles of Evaluation to Code (2)
@span{.links}{(@exercise-link{Supplemental/fragments/many-types-coe-to-code2.adoc,
original} |
@exercise-link{Supplemental/exercises-sols/many-types-coe-to-code2.adoc,
answers})}

* Identifying Parts of Expressions (1)
@span{.links}{(@exercise-link{Supplemental/fragments/id-expr-pieces1.adoc,
original} |
@exercise-link{Supplemental/exercises-sols/id-expr-pieces1.adoc,
answers})}

* Identifying Parts of Expressions (2)
@span{.links}{(@exercise-link{Supplemental/fragments/id-expr-pieces2.adoc,
original} |
@exercise-link{Supplemental/exercises-sols/id-expr-pieces2.adoc,
answers})}

* Matching Expressions & Contracts
@span{.links}{(@exercise-link{Supplemental/fragments/match-contracts-exprs1.adoc,
original} |
...
@span{.links}{(@exercise-link{Supplemental/fragments/match-examples-functions1.adoc,
original} |
@exercise-link{Supplemental/exercises-sols/match-examples-functions1.adoc,
answers})}

* Creating Contracts from Examples (1)
@span{.links}{(@exercise-link{Supplemental/fragments/create-contracts-examples1.adoc,
original} |
@exercise-link{Supplemental/exercises-sols/create-contracts-examples1.adoc,
answers})}

* Creating Contracts from Examples (2)
@span{.links}{(@exercise-link{Supplemental/fragments/create-contracts-examples2.adoc,
original} |
...
@span{.links}{(@exercise-link{Supplemental/fragments/boolean-coe-to-code1.html,
original} |
@exercise-link{Supplemental/exercises-sols/boolean-coe-to-code1.adoc,
answers})}

* Converting Circles of Evaluation with Booleans to Code
@span{.links}{(@exercise-link{Supplemental/fragments/boolean-coe-to-code2.html,
original} |
