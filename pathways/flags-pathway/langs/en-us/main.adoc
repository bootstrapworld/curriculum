...
@link{lessons/fl-flags-of-the-world/pages/flags-of-the-world-wbp.adoc}

They can also refer to exercises:
@link{lessons/fl-flags-of-the-world/fragments/update-player.adoc}

Also, entire lesson plans:
@link{lessons/fl-flags-of-the-world/index.html}.
