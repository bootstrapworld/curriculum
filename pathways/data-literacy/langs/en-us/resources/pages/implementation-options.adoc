...
A module with programming aimed specifically at transforming tables and data visualization, designed for:
...
@lesson-link{filtering-and-building/pages/stress-project.adoc}.
