...
* *Support Forums* [@link{https://discourse.bootstrapworld.org, Discourse}] - Want to be kept up-to-date about Bootstrap events, workshops, and curricular changes? Want to ask a question or pose a lesson idea for other Bootstrap teachers? These forums are the place to do it.
////
* *Lesson Videos*
...
[@link{../../../buggy-recipes-{proglang}/en-us/resources/protected/workbook-sols.pdf,
PDF}] [
@link{../../../buggy-recipes-{proglang}/en-us/lessons/BuggyRecipes/workbook-sols-pages/answer-key.pdf, Answer key}] - Real examples of common student mistakes. Get some practice grading them, or practice getting students over common misconceptions.
...
@link{https://docs.google.com/document/d/1GQw-EJAw54BK04SMp_4jPtGGt4IojsUA7oXfz9TRm8Y/view, Google Doc})}
...
* Design Recipe template @span{.links}{(@worksheet-link{DefiningFunctions2/workbook-pages/DesignRecipe1.pdf, PDF}, @link{https://docs.google.com/document/d/1GQw-EJAw54BK04SMp_4jPtGGt4IojsUA7oXfz9TRm8Y/view, Google Doc})}
...
* Word Problems practice @span{.links}{(@worksheet-link{DefiningFunctions3/workbook-pages/WordProblems.pdf, PDF}, @link{https://docs.google.com/document/d/1KpmYVJ9LdPyYeg839jEYotvMIbXx3urgIr8ZvRR3flw/view, Google Doc})}
