...
[@link{../../../buggy-recipes-wescheme/en-us/resources/protected/workbook-sols.pdf,
PDF}] [
@link{../../../buggy-recipes-wescheme/en-us/lessons/BuggyRecipes/workbook-sols-pages/answer-key.pdf, Answer key}] - Real examples of common student mistakes. Get some practice grading them, or practice getting students over common misconceptions.
