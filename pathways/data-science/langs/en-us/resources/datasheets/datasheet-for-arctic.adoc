...
[.answer]
--
This dataset combines data from several other data sets. Some of these sources are updated monthly, but the data contained in this data set will not change. There are no restrictions on any of the datasets used. 
