...
- *Exploration Paper* - Students begin by exploring their dataset, generating charts and coming up with possible research questions. The end product is the @starter-file{exploration-paper}. You can find the description of this project (and the grading rubric!) at @lesson-link{project-exploration-paper/}.

- *Research Paper* - Once students have come up with a research question, they can continue on to the complete @starter-file{research-paper}. You can find the description of this project (and the grading rubric!) at @lesson-link{project-research-paper}.
...
_We have compiled some @lesson-link{choosing-your-dataset/about-datasets/for-teachers-about-datasets.adoc}, to help you decide which might be most useful in your classroom._
...
- *Hour of Data* [@lesson-link{hoc-data/}] - A self-guided Desmos activity for exploring a real dataset, and using it to make sense of a real-world problem.
