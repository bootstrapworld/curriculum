...
* *Data Fallacies to Avoid* [@lesson-link{threats-to-validity/pages/Geckoboard-Data-Fallacies-Poster.pdf, link}] from @link{geckoboard.com/best-practice/statistical-fallacies/, geckobooard.com}
...
- *Exploration Project* - Students begin by exploring their dataset, generating charts and coming up with possible research questions. The end product is the @starter-file{exploration-project}. You can find the description of this project (and the grading rubric!) at @lesson-link{project-data-exploration/, the Exploration Project page}.
...
Students can import their own data into a @link{https://code.pyret.org/editor#share=1hsALf5oOrWqrolayPIgIlYXrqk3i-vD5, Blank Starter File} following instruction in @link{https://www.youtube.com/watch?v=K4n9hTSqcyw, this tutorial video} or choose from one of the many provided datasets below:
