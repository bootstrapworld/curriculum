...
- *Research Paper* - Once students have come up with a research question, they can continue on to the complete @starter-file{research-paper}. You can find the description of this project (and the grading rubric!) at @lesson-link{project-research-paper, the Research Project Page}.
...
* @lesson-link{computing-needs-all-voices/pages/computing-pioneers.adoc, Pioneers in Computing and Mathematics Posters}
