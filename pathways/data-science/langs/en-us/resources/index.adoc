...
We have also compiled some @link{pages/for-teachers-about-datasets.adoc, notes on these datasets}, which we recommend for all teachers before having their students choose a dataset.
