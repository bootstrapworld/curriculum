...
- @link{../../../lessons/displaying-categorical-data/pages/infographic.adoc, Making Infographics} & @link{../../../lessons/displaying-categorical-data/pages/infographic-rubric.adoc, Rubric} - Students develop a ratio statement from a dataset of their choice, and then illustrate it via a compelling infographic.
