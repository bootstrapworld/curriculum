...
- *Assessment* - Many of our lessons have "Show What You Know" assessments built into them. You can @dist-link{pages/how-to-use-assessments.adoc, learn more how to use them now}, and get automated reports on how your students did the next day. Delete that email by mistake? You can always @dist-link{QuizReports.shtml, request prior class results later}.
...
- @lesson-link{project-snack-habits, "Snack Habits"} -- Students track their snacking habits, contributing to a collective data set for the class to analyze and compare to research on U.S. snacking habits.
...
- *Contracts* [@link{pages/Contracts.pdf, link}] -- A PDF of the contracts pages from the back of the student workbook.
