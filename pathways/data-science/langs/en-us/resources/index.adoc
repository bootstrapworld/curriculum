...
- @link{../../../lessons/displaying-categorical-data/pages/infographics.html, Making Infographics}
- @link{../../../lessons/displaying-categorical-data/pages/infographic-rubric.html, Making Infographics Rubric}
...
Every student (or, ideally, every __pair__ of students) will need to save a copy of the @link{https://docs.google.com/document/d/1_ZEIgM4zvxI7JizViVFZojnpd3Yr2rYe8puPk8pjOcs/copy, Blank Research Paper}. A @link{pages/final-paper-rubric.html, Grading Rubric} is also available for the research paper.
