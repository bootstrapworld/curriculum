...
- *Exploration Paper* - Students begin by exploring their dataset, generating charts and coming up with possible research questions. The end product is the @starter-file{exploration-paper}. You can find the description of this project (and the grading rubric!) at @lesson-link{lessons/project-exploration-paper/, the Exploration Project Page}.

- *Research Paper* - Once students have come up with a research question, they can continue on to the complete @starter-file{research-paper}. You can find the description of this project (and the grading rubric!) at @lesson-link{lessons/project-research-paper, the Research Project Page}.
...
_We have compiled some @lesson-link{lessons/choosing-your-dataset/about-datasets/for-teachers-about-datasets.adoc, *Notes on our provided datasets*}, to help you decide which might be most useful in your classroom._
...
* @lesson-link{lessons/computing-needs-all-voices/pages/computing-pioneers.adoc, Pioneers in Computing and Mathematics Posters}
...
- *Hour of Data* [@lesson-link{lessons/hoc-data/, link}] - A self-guided Desmos activity for exploring a real dataset, and using it to make sense of a real-world problem.
