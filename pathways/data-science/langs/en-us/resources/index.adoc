...
- @link{../../../lessons/displaying-categorical-data/pages/infographic.adoc, Making Infographics}
...
Here is a @link{about-datasets/for-teachers-about-datasets.html, brief overview of our datasets}.
