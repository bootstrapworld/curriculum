...
- *Datasets to Choose From* - Students can import their own data into a @link{https://code.pyret.org/editor#share=1QHraJArnEZJCwyfGKakcn8N6NvJ0f9ua, Blank Starter File} following instruction in @link{https://www.youtube.com/watch?v=K4n9hTSqcyw, this tutorial video} or choose from one of the many provided datasets below:
