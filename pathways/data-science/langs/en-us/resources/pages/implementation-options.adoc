...
== Teach a Full DS Class @duration{1 semester to Full Year}
...
[.Projects]
* @lesson-link{functions-dr/pages/dr-telephone}
...
== Integrate DS into your class @duration{4 weeks, up to 1 semester}
...
== Just a taste of DS @duration{1 to 4 weeks}
