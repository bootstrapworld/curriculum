...
**Which Math and Statistics learning goals do you have?** The answer to this question will determine which lessons and projects from our library are relvant to you. A middle-school teacher might focus on lessons dealing pie and bar charts, histograms, etc, while an Algebra teacher would might focus on lessons about defining and composing functions. Meanwhile CS teacher would spend time on If-Expressions and conditionals.
