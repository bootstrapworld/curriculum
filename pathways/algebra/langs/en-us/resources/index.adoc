...
[@link{pages/buggy-recipes.adoc, Recipes}, @link{solution-pages/answer-key.adoc, Answer key}] - Real examples of common student mistakes. Get some practice grading them, or practice getting students over common misconceptions.
