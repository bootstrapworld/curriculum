...
- @link{https://bootstrapworld.org/materials/fall2023/en-us/lessons/coordinates/index.shtml?pathway=algebra-pyret?pathway=algebra-pyret,Video Games and Coordinate Planes}
