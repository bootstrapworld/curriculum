...
@link{https://www.bootstrapworld.org/materials/latest/en-us/lessons/function-composition/index.shtml, *Composing Image Functions*}
...
@link{https://www.bootstrapworld.org/materials/latest/en-us/lessons/distance-formula/index.shtml, *The Distance Formula*}
