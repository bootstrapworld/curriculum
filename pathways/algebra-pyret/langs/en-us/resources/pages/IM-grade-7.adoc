...
@link{../../../../lessons/inequalities3-sam/index.shtml,*Sam the Butterfly - Applying Inequalities*}
...
@link{../../../../lessons/random-samples/index.shtml,*Probability, Inference and Sample Size*}
