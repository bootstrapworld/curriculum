...
@span{.right}{@image{../../images/function-star.png, function star, 80}}
...
| @span{.right}{@image{../../images/comparing-samples.png, comparing samples, 140}}

@link{https://www.bootstrapworld.org/materials/latest/en-us/lessons/random-samples/index.shtml,*Probability, Inference and Sample Size*}
