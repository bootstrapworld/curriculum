= Materials for Teachers using IM Grade 8 Math™
...
@link{https://www.bootstrapworld.org/materials/latest/en-us/lessons/function-definition-linear/index.shtml, *Defining Linear Functions*}
...
| @link{https://www.bootstrapworld.org/materials/latest/en-us/lessons/functions-dr/index.shtml,*Solving Word Problems with the Design Recipes*}
