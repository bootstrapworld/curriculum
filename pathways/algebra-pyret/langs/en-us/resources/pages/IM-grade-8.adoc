...
@lesson-link{function-definition-linear/index.shtml, *Defining Linear Functions*}
...
| @lesson-link{functions-dr/index.shtml,*Solving Word Problems with the Design Recipes*}
