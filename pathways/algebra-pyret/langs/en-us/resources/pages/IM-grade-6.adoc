...
@link{../../../../lessons/function-composition/index.shtml,*Making Shapes from Code*}
...
@link{../../../../lessons/surface-area-rect-prism/index.shtml,*Surface Area of a Rectangular Prism*}
...
@link{../../../../lessons/flags/index.shtml,*Making Flags*}
...
@link{../../../../lessons/order-of-operations/index.shtml,*Order of Operations*}
...
@link{../../../../lessons/coordinates/index.shtml,*Coordinates and Game Design*}
...
@link{../../../../lessons/inequalities1-simple/index.shtml, *Simple Inequalities*}
...
- An extension of this lesson (which does involve _compound_ inequalities) is our @link{../../../../lessons/inequalities3-sam/index.shtml, *Sam the Butterfly*} lesson, where students use inequalities to define the boundaries that will keep a video game character on screen.

| @link{https://curriculum.illustrativemathematics.org/MS/teachers/1/8/index.html,*Datasets and Distributions*}
|

@link{../../../../lessons/measures-of-center/index.shtml,*Measures of Center*}
...
@link{../../../../lessons/box-plots/index.shtml,*Box Plots*}
