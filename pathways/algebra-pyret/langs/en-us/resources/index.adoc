...
- *Blank Design Recipe Worksheet* - [@ifproglang{pyret}{
@dist-link{blanks/2-blank-pyret-recipes.pdf, PDF}}@ifproglang{wescheme}{
@dist-link{blanks/2-blank-wescheme-recipes.adoc, PDF}}]
] - Use alongside story problems for a function development template.
